    ...
    },
{
        ...
        options:[
            ...
            { text: "集団の輪には入らず、少し離れたところから「あの人は今無理して笑ってるな」「あの二人は何かあったな」と、勝手に個人の裏側の感情や物語を想像（観察）して楽しむ。", scores: { socio: { Fi: 4, Ne: 3 }, mbti: { Fi: 3, Ne: 2, I: 1 }, ennea: { 4: 4, 5: 1 } } }
        ]
    },
{
...
// q_inf_j_eii_rescue (悩んでる人を助ける) Fi-Se（ISFP/ESI）の行動を追加！
    {
        ...
        options:[
            ...
            { text: "悩みの原因を論理的に分解して、『これが構造的な問題ならこう解決』と提案したくなる。", scores: { socio: { Ti: 3, Ni: 1 }, mbti: { Ti: 2, Ni: 2 }, ennea: { 5: 3 } } },
