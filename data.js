    ...
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Ni: 3, Te: 2, Fe: -2 }, mbti: { Te: 2, I: 2 }, ennea: { 5: 2, 4: 1 } } // 典型的なILIのシニカルな諦観
            },
            { 
                text: "「スタバに700円払うなら、家でアイスと牛乳をミキサーにかけた方がコスパ良くね？」と、別の『安く済む代替案』を考える。", 
                scores: { socio: { Ti: 2, Ne: 2 }, mbti: { Ti: 2, N: 1 }, ennea: { 5: 3, 7: 1 } } // みつきのLII的代替案（家で作るｗ）
            },
            { 
                text: "なんだかんだで、自分なりの役目（ポスターを描く等）や、一人でひっそり楽しむ方法を見つけてやり過ごす。", 
                scores: { socio: { Si: 2, Ti: 1 }, mbti: { I: 2, P: 1 }, ennea: { 9: 2, 5: 1 } } // SLI/LIIのマイペース防衛
            },
            { 
                text: "素直にイベントに乗っかって、みんなでワイワイ楽しむのが好き！", 
                scores: { socio: { Fe: 3, Se: 1 }, mbti: { E: 3, F: 2 }, ennea: { 2: 2, 7: 2 } } // Fe主導
            }
        ]
    },
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ni: 2, Ti: 1 }, mbti: { Ni: 2 }, ennea: { 5: 2 } },
                // ★みつきの「楽しいことだけやる代替案」を見抜く究極のトラップ！！
                followUp: {
                    id: "q_hobby_followup",
                    type: "radio",
                    text: "[System: 思考の深掘り] 「取り組み方を変える」とは、具体的にどういうこと？",
                    options:[
                        { text: "リターンが見込めないなら、完全に熱を失うか、コスト（時間や労力）を割くのをやめる。", scores: { socio: { Te: 3, Ni: 1 }, mbti: { Te: 2 }, ennea: { 5: 2, 3: 1 } } },
                        { text: "パース等の『苦痛な基礎練』は捨てて、自分の『楽しい部分だけをやる』という遊びのシステムにルート変更する。", scores: { socio: { Ti: 2, Ne: 3 }, mbti: { P: 2, N: 2 }, ennea: { 7: 2, 5: 1 } } }
                    ]
                }
            },
            { 
                text: "「上には上がいる」からこそ、劣っている部分を分析し、上手い人の技術を研究してさらにストイックに努力する。", 
                scores: { socio: { Ti: 2, Te: 2, Se: 2 }, mbti: { Te: 2, J: 2 }, ennea: { 1: 3, 3: 1 } } // LSIや一部のTe型のストイックさ
            },
            { 
                text: "他人と比べること自体が無意味。自分自身の「内なる世界観」が表現できればそれでいい。", 
                scores: { socio: { Fi: 3, Ni: 1 }, mbti: { Fi: 3 }, ennea: { 4: 3 } } // INFP/EII等のFi防衛
            },
            { 
                text: "ただその行為自体が心地よいから、レベルとか関係なく淡々と続ける。", 
                scores: { socio: { Si: 3 }, mbti: { Si: 3 }, ennea: { 9: 3 } } // Siの純粋な享受
            }
        ]
    },
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 3, Se: 1 }, mbti: { Ti: 2, J: 1 }, ennea: { 1: 2, 5: 1 } } // 理系LSIのバキバキTi
            },
            { 
                text: "生物学的に『命を繋ぐ』という一般論はあるが、必ずしもそれだけではない。人によって意味は異なり、様々な解釈（分岐）がある。", 
                scores: { socio: { Ti: 2, Ne: 2 }, mbti: { Ni: 2, P: 1 }, ennea: { 5: 3, 9: 1 } } // みつきのTi-Ne代替案思考！
            },
            { 
                text: "客観的な意味なんて存在しない。どうせ最後は無に帰るのだから、意味を探すこと自体が非効率だ。", 
                scores: { socio: { Ni: 3, Te: 2 }, mbti: { Ni: 3, Te: 1 }, ennea: { 5: 2, 4: 1 } } // ILIの虚無主義
            },
            { 
                text: "意味は自分一人で決めるものではなく、誰かと関わり、後世に何かを残す（影響を与える）ことで生まれる。", 
                scores: { socio: { Fe: 2, Fi: 2 }, mbti: { F: 3 }, ennea: { 2: 2, 4: 1 } } 
            }
        ]
    },
    {
