    ...
    },
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 3, Ne: 2 }, mbti: { Ti: 3, Ne: 1 }, ennea: { 5: 2, 1: 2 } } // LIIの致命傷ｗｗ
            },
            { 
...
// q_meta_creator_anxiety (作者の気持ちメタ) Fe系の選択肢を追加！
    {
        ...
        options:[
            ...
            // ★ Fe系の「誰かの不快感」を追加！
            { text: "「自分の作ったシステムのせいで、誰かが不快な思いをしたり、悲しんだりしないか」という倫理的な配慮。", scores: { socio: { Fe: 4, Fi: 2 }, mbti: { Fe: 4, Fi: 2 }, ennea: { 2: 3, 9: 1 } } }
        ]
    },
{
        ...
        options:[
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "既存のフォーマットの「バグや改善点」を見つけて、システムを自分の手で最適化・アップデート（魔改造）したいから。", scores: { socio: { Ti: 4, Ne: 3 }, mbti: { Ti: 4, Ne: 2 }, ennea: { 5: 3, 1: 1 } } }, // LII/INTP
                        { text: "「これってなんでこうなってるんだろう？」と既存のルールを疑い、全く違う角度から物事の構造を再定義したいから。", scores: { socio: { Ni: 3, Ti: 2 }, mbti: { Ni: 3, Ti: 2 }, ennea: { 5: 3, 4: 1 } } } // ILI/INTJ
                    ]
                }
            },
    ...
    },
{
    ...
    // q_logical_words (小難しい論理語) に「論理語に興味ない」選択肢を追加！
    {
        ...
        options:[
            ...
            { text: "便利だし、手っ取り早く情報が伝わる（または相手を説得できる）からツールとして積極的に使う。", scores: { socio: { Te: 3 }, mbti: { Te: 3 }, ennea: { 3: 2, 8: 1 } } },
...
// q_extrovert_fe_ni の選択肢
            { 
                text: "誰が一番権力を持っているか、どうすれば自分がこの場を支配して効率よく回せるかの力学。", 
                scores: { socio: { Se: 2, Te: 2 }, mbti: { Te: 3, Se: 1 }, ennea: { 8: 3, 3: 1 } },
                // ★ 権力を観察する理由を深掘り！！
                followUp: {
                    ...
                    options:[
                        { text: "組織の構造を把握し、自分が一番有利なポジションに立って実権を握り、物事を効率的に動かしたいから。", scores: { socio: { Te: 4, Se: 3 }, mbti: { Te: 4, Ni: 1 }, ennea: { 3: 3, 8: 2 } } }, // ガチTe/Se（ENTJ等）
                        { text: "「誰が危険人物（地雷）か」を事前に察知し、自分のテリトリーや平穏が脅かされないように安全圏を確保しておきたいから。", scores: { socio: { Si: 3, Fi: 2, Ne: -2 }, mbti: { Si: 3, Fe: 2 }, ennea: { 9: 3, 6: 3 } } } // ★ SEI/ISFPの「安全確保（9w8防衛）」！！
                    ]
                }
            },
        ...
        options:[
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "論理的な計算、システムの構築、次に自分がやるべきタスクなどの『客観的なデータや思考』。", scores: { socio: { Ti: 4, Ni: 2 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 3, 9: 1 } } }, 
        ...
        options:[
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "ルールという『システム（前提）』が一部のバグ（違反者）のせいで正常に機能しなくなることが、論理的に不快だから。", scores: { socio: { Ti: 4, Te: 2, Ne: -2 }, mbti: { Ti: 3, Te: 3 }, ennea: { 1: 3, 5: 2 } } }, // ★ INTJ/LSIなどのT型！！
        ...
        options:[
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "「個人の評価など単なる変数に過ぎない」と完全に感情を切り離して、ただのシステム情報として事実認定しているだけ。", scores: { socio: { Ti: 3, Ni: 3, Fe: -2 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 3 } } }, // ★ Niにバフ！
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "「何千年前の品種とDNAが違うから別物だ」というような、客観的で現実的な事実（データ）に基づいて白黒つけようとする。", scores: { socio: { Ti: 3, Se: 2, Si: 2 }, mbti: { Te: 3, Si: 3 }, ennea: { 1: 3, 6: 2 } } } // LSI/ISTJ
                    ]
                }
            },
        ...
        options:[
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "公式のファクト（データ）に反する解釈を『真実』のように語る論理的破綻が気持ち悪いから。", scores: { socio: { Ti: 4, Te: 3 }, mbti: { Ti: 3, Te: 2 }, ennea: { 5: 3, 1: 2 } } }, // ガチT型
    ...
    },
{
        ...
        options:[
            { text: "「これをこう直せばスムーズになる」「道具を最適化して効率UP」現実の動き・流れを体感的に調整。", scores: { socio: { Si: 4, Ti: 2, Se: 1 }, mbti: { Si: 3, Ti: 2 } } },
            { text: "「この法則が正しいか？」「全体の構造を論理で組み立て直す」抽象・概念の整合性を検証。", scores: { socio: { Ti: 3, Ne: 2, Si: -1 }, mbti: { Ti: 3, Ne: 2 } } },
            { text: "「誰かが傷つかないか？」「この関係の調和を優先」感情・人間関係のバランス。", scores: { socio: { Fi: 3, Fe: 1, Ti: -1 }, mbti: { Fi: 3 } } },
            // ★ 新規追加！ Niの長期計画と、ESIの倫理！
            { text: "「これが将来どういう結果（トラブル）をもたらすか？」という長期的な因果関係とリスクの排除。", scores: { socio: { Ni: 4, Te: 2 }, mbti: { Ni: 3, Te: 2 }, ennea: { 5: 3, 1: 1 } } },
            { text: "「この問題の原因は誰の怠慢（不誠実さ）にあるのか？」という、ルールの遵守や倫理的な責任の所在。", scores: { socio: { Fi: 3, Se: 2, Ti: 1 }, mbti: { Si: 2, Te: 2 }, ennea: { 1: 3, 6: 2 } } }
        ]
    },
    {
        id: "q_f_values",  // Fi爆上げ
        ...
        options:[
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "そもそも『みんなの感情』という見えないデータを処理する機能が脳になく、要求されると処理落ちするから。", scores: { socio: { Fe: -4, Ti: 3 }, mbti: { Fe: -3, Ti: 2 }, ennea: { 5: 3 } } }, // 真のT型
    ...
    // ★ 追加：T型のF擬態を暴くマイナスチェックボックス！
{
        ...
        options:[
            ...
            { text: "空気を読んでいるつもりだが、時々「今の発言、なんかズレてたかも…」と後から猛烈に反省（再検証）する。", scores: { socio: { Fe: -4, Ti: 3 }, mbti: { Fe: -3, Ti: 2 }, ennea: { 5: 1, 1: 1 } } }
        ]
    },
    // ★ 追加：純粋なマイナス質問（機能完全停止）
{
        ...
        options:[
            { text: "『変化のない永遠のルーティン』。毎日同じ景色、同じ作業、同じ人間関係という閉鎖された安定。", scores: { socio: { Si: -1 }, mbti: { Si: -1 }, ennea: { 7: 1 } },
                followUp: {
                    id: "w_rejection_routine_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] なぜ「永遠のルーティン」が絶望的に嫌なの？",
                    options:[
                        { text: "新しい刺激や出会い、ワクワクするような予測不能の『可能性』が完全に絶たれるのは、死んでいるのと同じだから。", scores: { socio: { Ne: 4, Ni: -2 }, mbti: { Ne: 4, P: 2 }, ennea: { 7: 4, 4: 1 } } }, 
                        { text: "知識のアップデートも自己成長（システムの最適化）も止まり、ただの『歯車（無意味な存在）』として腐っていく未来が確定しているから。", scores: { socio: { Ni: 4, Ti: 3, Se: -2 }, mbti: { Ni: 4, Ti: 2 }, ennea: { 5: 4, 1: 1 } } } 
                    ]
                }
            },
            { text: "『一切のルールや秩序がないカオス』。誰が何をするかわからない、予測不能で危険な自由。", scores: { socio: { Ne: -4, Si: 2 }, mbti: { Ne: -3, Si: 2 }, ennea: { 1: 3, 6: 2 } } },
            { text: "『情も思いやりも完全に排除された実力主義』。生産性と結果だけが評価され、人間がただの数字として扱われること。", scores: { socio: { Te: -4, Fi: 2 }, mbti: { Te: -3, Fi: 2 }, ennea: { 4: 3, 9: 2 } } },
            { 
                text: "『無意味な感情の押し付け合い』。理屈の通らない感情論で、自分の思考やシステムが邪魔されること。", 
                scores: { socio: { Fe: -2, Fi: -2 }, mbti: { Fe: -2, Fi: -2 }, ennea: { 5: 1 } },
                // ★ T型の論理防衛と、SEIの「平和とHP防衛」を分離！
                followUp: {
                    id: "w_rejection_emotion_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 感情論を拒絶する本当の理由は？",
                    options:[
                        { text: "論理や事実が無視され、非効率で無駄なノイズに自分の脳内リソースや時間を奪われるのが苦痛だから。", scores: { socio: { Ti: 4, Te: 3, Fe: -3 }, mbti: { Ti: 3, Te: 3 }, ennea: { 5: 3, 8: 1 } } }, // ガチT
                        { text: "他人のドロドロした感情や争いに巻き込まれると、自分の『心の平穏（HP）』がゴリゴリ削られて疲弊するから。穏やかに過ごしたい。", scores: { socio: { Si: 4, Fe: 2, Fi: 2 }, mbti: { Si: 1, P: 2 }, ennea: { 9: 4, 6: 1 } } } // ★ SEI/SLI/ISFJの「平和主義（Si-Fe）防衛」！！
                    ]
                }
            }
        ]
...
// ==========================================
    ...
    },
    {
        ...
        options:[
            { text: " 他人の「個人的な感情や繊細な好き嫌い」を常に察知し、その場にいる全員が笑顔になるように、自分の本音を偽って空気を調整し続けること。", scores: { mbti: { Fe: -4 }, socio: { Fi: -4 }, ennea: { 2: -2, 9: -1 } } },
            { text: "「結果を出さない奴はゴミだ」と他人に圧力をかけ、手段を選ばずに相手を物理的・精神的にねじ伏せて主導権を奪い取ること。", scores: { mbti: { Te: -4 }, socio: { Se: -4 }, ennea: { 8: -2 } } },
            { text: " 自分が「絶対にこれは間違っている」と信じている道徳や価値観を曲げてまで、社会的な同調圧力に屈して愛想笑いをすること。", scores: { mbti: { Fi: -4 }, socio: { Fe: -4 }, ennea: { 2: -3 } } },
            { text: " 物事の深い構造や「本当の真理」を探求する時間を奪われ、ただ表面的な実用性や「どれだけ利益が出るか」だけを証明させられること。", scores: { mbti: { Ti: -4 }, socio: { Te: -4 }, ennea: { 3: -2 } } }
        ]
    },
    // ==========================================
    // ★ 新ギミック！ Se圧（威圧・物理的急かし）
        ...
        options:[
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "論理的におかしい（無駄が多い）のに、誰もそれを疑わずに思考停止しているという『システム（知性）の敗北』だから。", scores: { socio: { Ti: 4, Ne: 3 }, mbti: { Ti: 4, Ne: 2 }, ennea: { 5: 2, 1: 1 } } }, 
    ...
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 3, Ni: 3, Fe: -2 }, mbti: { Ni: 3, Fe: -2 }, ennea: { 5: 3, 4: 1 } },
