    ...
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 3, Te: 2 }, ennea: { 1: 1 } },
                // ★ ここにもトラップを仕掛ける！
                followUp: {
    ...
    },
{
        ...
        options:[
            { text: "『これ使ったら日常がどれだけ楽になるか？』『今のルーティンが崩れないか？』『身体的に疲れないか？』をまず考える。実用的で快適なら即採用。", scores: { socio: { Si: 4, Te: 3 }, mbti: { Si: 3, Te: 2 }, ennea: { 9: 3, 6: 1 } } },
            { text: "『このツールの論理構造は正しいか？』『どんな可能性やバグがあるか？』を分解して検証したくなる。実用性よりシステムの美しさが気になる。", scores: { socio: { Ti: 4, Ne: 2 }, mbti: { Ti: 3, Ne: 2 }, ennea: { 5: 3 } } },
            { text: "『これで将来どう変わるか？』『最悪のシナリオは？』と未来の連鎖を予測して、圧を感じたら回避ルートを探す。", scores: { socio: { Ni: 3, Ti: 1 }, mbti: { Ni: 3 }, ennea: { 5: 2, 6: 2 } } },
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "純粋に新しい刺激や変化が楽しいから！とりあえず触ってみて、飽きたら次の面白いものを探すだけ。", scores: { socio: { Ne: 3, Se: 3 }, mbti: { Ne: 3, Se: 3, P: 2 }, ennea: { 7: 4 } } } // ESTP/ENFPのノリ
                    ]
                }
            },
        ...
        options:[
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "本当に何も思っていない。他人に無関心なだけ。", scores: { socio: { Ni: 3, Te: 2 }, mbti: { Ti: 3 }, ennea: { 5: 2, 9: 2 } } }, 
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ni: 2, Ti: 2, Si: -1 }, mbti: { Ni: 3, Ti: 2 }, ennea: { 5: 2 } } 
            },
            { 
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "家族や本当に大切な親友の心には寄り添うが、それ以外の『どうでもいい他人』の心境までいちいち気にかけるのは労力の無駄だから。", scores: { socio: { Fi: 4, Te: 1 }, mbti: { Fi: 3, Si: 2, Se: 1 }, ennea: { 6: 2, 4: 1 } } } // ★ESIの身内びいきFi！
                    ]
                }
            }, 
