...
// q_inf_j_eii_rescue (悩んでる人を助ける) Fi-Se（ISFP/ESI）の行動を追加！
    {
        ...
        options:[
            ...
            { text: "言葉で慰めるより、美味しいご飯に連れ出したり、悩みの元凶（敵）を物理的に排除して直接守ってあげたい。", scores: { socio: { Fi: 3, Se: 3 }, mbti: { Fi: 3, Si: 2,Se: 2 }, ennea: { 8: 2, 2: 1 } } }
        ]
    },
    {
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "自分の安心できる『平和で快適なパーソナルスペース』に土足で踏み込まれて、自分のペースを乱されるのが死ぬほどストレスだから。", scores: { socio: { Si: 4, Fi: 2, Se: 2 }, mbti: { Si: 2, P: 2 }, ennea: { 9: 3, 8: 1 } } } // ★ SEI/SLIの「9w8的防衛」！！
                    ]
                }
            }
        ]
