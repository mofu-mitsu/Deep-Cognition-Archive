    ...
    },
{
    ...
    },
    {
        ...
        options:[
            { text: "「なぜこの手順なのか？」というルールの背景（Ti）を一切説明されず、ただひたすらに「前任者がそうやってたから」という理由だけで、意味不明な作業を正確に繰り返すこと。", scores: { mbti: { Si: -4 }, socio: { Ti: -4 }, ennea: { 5: -1, 7: -1 } } }, // N型（特にENTP/ENFP/SEE/IEE）の地獄
            
            { text: "自分が今「どれくらい疲れているか（Si）」を完全に無視し、常に変化し続ける目の前のトラブルや刺激に対して、休むことなく即座に反応し続けること。", scores: { mbti: { Se: -4 }, socio: { Si: -4 }, ennea: { 9: -2, 5: -1 } } }, // INxJ / LII / EII 等の地獄
            
            { text: "自分の中の「これは絶対に間違っている（Fi）」という倫理観を押し殺し、その場の空気を良くするためだけに、無理やり笑顔を作って集団のテンションに合わせること。", scores: { mbti: { Fi: -4 }, socio: { Fe: -4 }, ennea: { 4: -2, 5: -1 } } }, // T型（特にINTJ/INTP/ILI/SLI）の地獄
            
            { text: "個人の感情や関係性を一切考慮せず、「相手を威圧してでも（Se）」チームを強引に指揮し、「最短で利益」を叩き出す冷酷なリーダーになること。", scores: { mbti: { Te: -4 }, socio: { Se: -4 }, ennea: { 9: -2, 4: -1 } } } // F型（特にINFP/ISFP/EII/SEI）の地獄
        ]
    },
    {
