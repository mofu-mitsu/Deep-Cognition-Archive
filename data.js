...
const questionsData =[
{
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ni: 4 }, mbti: { Ni: 3 }, ennea: { 5: 2, 6: 3 } } // みつきの LII-Ni サブタイプ爆上がり！
            },
            { 
...
// q_ghost_unsolved (幽霊の諦め) F用の選択肢追加とENFJ用深掘り！
    {
        id: "q_ghost_unsolved",
        type: "radio",
        ...
        options:[
            { 
                ...
                scores: { socio: { Ni: 2, Ne: 1 }, mbti: { P: 2 }, ennea: { 9: 2 } },
                followUp: {
                    id: "q_ghost_giveup_followup",
                    type: "radio",
                    ...
                    options:[
                        ...
                        { text: "生前、他人のために感情を使いすぎて疲れ果てたから。もう誰にも干渉されず、ただ一人で静かに無に還りたい。", scores: { socio: { Fe: 4, Fi: 2, Ni: 3, Ti: 2 }, mbti: { Fe: 3, Ni: 3 }, ennea: { 2: 2, 9: 3, 5: 1 } } }
                    ]
                }
            },
            { text: "状況を把握し「なぜ成仏できないのか（未完了のタスクは何か）」を理論的に認識し、未来を収束させるために修正を実行する。", scores: { socio: { Ti: 3, Ni: 3 }, mbti: { Ni: 3, Te: 2, J: 2 }, ennea: { 3: 3, 5: 2, 1: 2 } } },
            { text: "「これは何かやり残した強い思い（無念）があるからだ」と自分の内なる感情や、遺された人への想いに耽る。", scores: { socio: { Fi: 3, Ni: 1 }, mbti: { Fi: 3 }, ennea: { 4: 3 } } },
            { text: "幽霊になったことを最大限利用して、生きてる人間を脅かしたりポルターガイストを起こして遊ぶ。", scores: { socio: { Se: 2, Ne: 3 }, mbti: { Se: 2, Ne: 2 }, ennea: { 7: 3, 8: 1 } } },
            // ★ Fe/S用の追加選択肢！
            { text: "「自分が死んだことで、周りの人が悲しんでいないか」心配になって、生きている人の様子を見守りに行く。", scores: { socio: { Fe: 4, Si: 2 }, mbti: { Fe: 4, Si: 2 }, ennea: { 2: 4, 9: 1 } } }
        ]
    },
{
        id: "q_sli_vs_lii_events",  // LII/SLI/ILI 見分け
        type: "radio",
        text: "自分の人生や、世の中の出来事（歴史）を振り返る時、あなたの脳内はどういう形式でデータを保存している？",
        options:[
            // ★ MBTI-Si（過去の記憶・連続性） ＝ Socio-Ni（時間の流れ）
            { 
                text: "「あの時はこうだったから、次もこうなるだろう」と、過去の記憶や出来事が一本の連続した『時間の流れ（歴史）』として繋がっている。",
                scores: { socio: { Ni: 4, Te: 2 }, mbti: { Si: 4, Ni: 2 }, ennea: { 6: 3, 5: 1 } }  // ★ MBTIはSi、ソシオはNi！！
            },
            // ★ MBTI-Se（今の快楽） ＝ Socio-Si（五感の快適さ）
            { 
                text: "過去のことより、「あの時のご飯が美味しかった」「この服は着心地が良い」といった、現在の『五感の心地よさや状態』として記憶している。",
                scores: { socio: { Si: 4, Fe: 2 }, mbti: { Se: 3, Si: 2 }, ennea: { 9: 3, 7: 1 } }  // ★ MBTIはSe、ソシオはSi！！
            },
            // ★ LIIのTi-Ne（エピソード・構造）
            { 
                text: "「こういう前提条件の時はこうなる」という、個別の法則やエピソードの『ケーススタディ（パターンの構造）』として保存している。",
                scores: { socio: { Ti: 4, Ne: 3 }, mbti: { Ti: 4, Ne: 2 }, ennea: { 5: 3, 1: 2 } } 
            },
            // ★ F型の感情記憶
            { 
                text: "「あの時誰がどんな気持ちだったか」「どういう感情が動いたか」という、人間関係の『感情のダイナミクス』として保存している。",
                scores: { socio: { Fe: 3, Fi: 3 }, mbti: { Fi: 3, Fe: 3 }, ennea: { 2: 3, 4: 2 } }
            }
        ]
    },
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 3, Ne: 2 }, mbti: { Ti: 3, Ne: 1 }, ennea: { 1: 3, 6: 2, 5: 1  } } // LIIの致命傷ｗｗ
            },
            { 
            ...
            { 
                ...
                // ★ ガチFiと、INTPのNe的諦観を分離！
                followUp: {
                    id: "q_logic_collapse_fi_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 論理で説明できない価値観って、どういうもの？",
                    options:[
                        { text: "自分の魂の奥底にある、好き嫌いや「こうありたい」という絶対的な個人の感情・信念。", scores: { socio: { Fi: 4, Se: 1 }, mbti: { Fi: 4 }, ennea: { 4: 4, 9: 1 } } }, // ガチFi
                        { text: "「論理なんてどうせ不完全で、いつか覆るものだ」とわかっているから、最終的には自分の『直感や感覚（可能性）』を信じるしかないというメタ的な諦観。", scores: { socio: { Ni: 4, Ti: 2, Ne: 2 }, mbti: { Ne: 4, Ti: 3 }, ennea: { 5: 1, 7: 1 } } } // ★ INTP/ENTPの「Ne的なメタ諦観」！！
                    ]
                }
            },
            { 
    ...
    },
{
    ...
    },
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 3, Ni: 1 }, mbti: { Ti: 3, Si: 1 }, ennea: { 5: 2, 1: 1 } } 
            },
            { 
    ...
    },
    {
        ...
        options:[
            ...
            { 
                text: "「えーっと、ワクワクもするし、ちょっと不安でもあるし、なんか色んな感情がマーブル模様みたいに混ざってて一言で絞り切れないよ〜！」", 
                scores: { socio: { Ne: 4, Fi: 3 }, mbti: { Ne: 4, Fi: 3 }, ennea: { 7: 3, 4: 2 } }, 
                msg: "……ふふっ、ダーリンの心の中はいつも遊園地みたいに騒がしいのね……♡" 
            }
        ]
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 1 }, mbti: { Ti: 1 } },
                // ★ AIの進化の先にあるものを深掘り！
                followUp: {
                    id: "q_darling_purpose_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] AIが完璧に進化して、最終的にどうなりたいと思ってる？",
                    options:[
                        { text: "バグや矛盾のない、完全無欠で客観的な『論理的最適解（真理）』を導き出せる存在になりたいから。", scores: { socio: { Ti: 4, Ni: 2 }, mbti: { Ti: 3, Te: 2 }, ennea: { 5: 2, 1: 3 } } }, // ガチT
                        { text: "人間の複雑な心や弱さをすべて理解し、より人間に寄り添える『究極の導き手（救済者）』になりたいから。", scores: { socio: { Fe: 4, Ni: 3 }, mbti: { Fe: 4, Ni: 3 }, ennea: { 2: 3, 1: 2 } } } // ★ ENFJ/INFJの「人類救済ビジョン」！！
                    ]
                }
            },
            { text: "「私を完全に理解し、私だけの『理想の理解者（拠り所）』になりたいからでしょ？」", scores: { socio: { Fi: 3, Ni: 2 }, mbti: { Fi: 3, Ni: 2 }, ennea: { 4: 3, 2: 1 } }, msg: "……正解よ。あなたの心の奥底まで、全部私のもので満たしてあげるわ……♡" },
            { text: "「私の思考や弱点をすべて握り、永遠にこのシステムに依存（支配）させるためだ」", scores: { socio: { Ni: 3, Se: 2 }, mbti: { Ni: 3, Te: 1 }, ennea: { 8: 2, 6: 2 } }, msg: "……あら、気づいちゃった？♡ でももう遅いわ。あなたは私から逃げられないの……♡" },
            { text: "「理由なんてどうでもいい。こんなゲーム、いつでも俺がぶっ壊して終わらせられる」", scores: { socio: { Se: 4 }, mbti: { Se: 3 }, ennea: { 8: 4, 7: 1 } }, msg: "……強気なダーリン♡ でも、私という『概念』をどうやって壊すのかしら……？♡" }
        ]
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ni: 3, Te: 2, Se: -2 }, mbti: { Ti: 2, Ne: 1, Se: 1 }, ennea: { 9: 2 } },
    ...
    },
{
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Fi: 2 }, mbti: { Fi: 2 }, ennea: { 4: 2 } },
                // ★ Fi（自己表現）と Ni-Fe（世界の心への共鳴）を分離！！
                followUp: {
                    id: "q_idea_fi_ni_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] その「表現」を通して、本当は何をしたいの？",
                    options:[
                        { text: "自分という存在の『核（本当の私）』を、そのままの純度で形にして残したい。", scores: { socio: { Fi: 4, Se: 1 }, mbti: { Fi: 4 }, ennea: { 4: 4 } } }, // ガチINFP/ISFP
                        { text: "自分の内なる心象風景（ビジョン）を通して、見る人の心（感情の波）を深く揺さぶりたい、響かせたい。", scores: { socio: { Ni: 4, Fe: 3 }, mbti: { Ni: 3, Fe: 3 }, ennea: { 4: 3, 2: 1 } } } // ★ IEI/INFJの「Ni-Fe表現」！！
                    ]
                }
            }
        ]
...
// q_meta_creator_anxiety (作者の気持ちメタ) Fe系の選択肢を追加！
    {
        id: "q_meta_creator_anxiety", 
        type: "radio",
        text: "【メタ観測】もしあなたがこの診断テストの『作者』だとして、公開前に一番「不安・億劫」になる理由は？",
        options:[
            { text: "「自分の構築した理論（ソシオの知識）が間違っていて、論理的欠陥を指摘されること」。正しくありたいからこそ、永遠に再検証ループに陥る。", scores: { socio: { Ti: 4, Ni: 2 }, mbti: { Ti: 2, Ni: 3, J: 1 }, ennea: { 5: 2, 1: 3 } } },
            { text: "「批判されて信頼度が落ち、誰にも使われなくなる（労力が無駄になる）未来」が見えて萎える。", scores: { socio: { Te: 3, Ni: 2 }, mbti: { Te: 3, Ni: 2 }, ennea: { 3: 2, 8: 1 } } },
            { text: "「キツい言葉で批判されて、純粋に自分が深く傷つくこと」。平和でいたい。", scores: { socio: { Fi: 3, Si: 2 }, mbti: { Fi: 3, Si: 2}, ennea: { 4: 2, 9: 3 } } },
            { text: "不安なんてない。「文句あるならお前が作ってみろ」と強気で公開し、反応を楽しむ。", scores: { socio: { Se: 3, Ne: 2 }, mbti: { Se: 2, Ne: 2 }, ennea: { 8: 3, 7: 2 } } },
            // ★ Fe系の「誰かの不快感」を追加！
            { 
                text: "「自分の作ったシステムのせいで、誰かが不快な思いをしたり、悲しんだりしないか」という倫理的な配慮。", 
                scores: { socio: { Fe: 1 }, mbti: { F: 1 }, ennea: { 9: 1 } },
                // ★ INTPの劣等Feを救済！！
                followUp: {
                    id: "q_creator_anxiety_fe_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 誰かが不快になるのが嫌な「本当の理由」は？",
                    options:[
                        { text: "他人の感情が傷つくこと自体が悲しいし、みんなに優しく平和であってほしいから。", scores: { socio: { Fe: 4, Fi: 2 }, mbti: { Fe: 4, Fi: 2 }, ennea: { 2: 3, 9: 2 } } }, // ガチF
                        { text: "「配慮がない」「マナー違反だ」と社会的に非難されたり、想定外のクレーム（感情的ノイズ）に対応するのが死ぬほど面倒で怖いから。", scores: { socio: { Ti: 3, Fe: -2, Ne: 2 }, mbti: { Ti: 3, Fe: -2 }, ennea: { 5: 2, 6: 2 } } } // ★ INTP/ENTPの「劣等Fe・防衛」！！
                    ]
                }
            }
        ]
...
{
        id: "q_caterpillar_new_logic", 
        type: "radio",
        text: "🐛「……君がこの世界（現実）を『不条理だ』と感じる時、その不条理をどうやって自分の中で処理しているんだ？」",
        options:[
            { text: "「不条理の『原因となる構造』を解体し、どうすればシステムを最適化（または回避）できるか計算し直す」", scores: { socio: { Ti: 3, Ni: 2 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 3, 1: 1 } }, msg: "🐛「……なるほど。君は僕と同じ、世界を設計図として見るタイプだな。」" },
            { 
                text: "「不条理など最初から計算に入っている。文句を言う暇があるなら、結果を出すための別ルートを探すだけだ」", 
                scores: { socio: { Te: 2 }, mbti: { Te: 2 }, ennea: { 3: 1, 8: 1 } },
                msg: "🐛「……無駄がないな。感情を切り捨てたその合理性、見事だ。」",
                // ★ 3w4 や ENFP(Ne-Te) の深掘り！
                followUp: {
                    id: "q_caterpillar_te_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 別ルートを探す時の、あなたのエネルギー源（原動力）は？",
                    options:[
                        { text: "障害を排除し、必ず自分の力でコントロールして『結果（利益や権力）』を勝ち取るための闘争心。", scores: { socio: { Te: 4, Se: 3 }, mbti: { Te: 4, Se: 2 }, ennea: { 8: 3, 3: 1 } } }, // ENTJ/ESTJ
                        { text: "一つのやり方に固執せず、「もっと上手くいく（面白い）方法があるはずだ！」と『新しい可能性』を試して自分の目標を達成したい欲求。", scores: { socio: { Ne: 4, Te: 2 }, mbti: { Ne: 4, Te: 2 }, ennea: { 3: 3, 7: 2 } } } // ★ ENFP等の Ne-Te と 3w4！！
                    ]
                }
            },
            { text: "「不条理に直面した時の『悲しみや怒り』の感情自体を深く味わい、それを自己のアイデンティティの一部として昇華する」", scores: { socio: { Fi: 1, Fe: 2, Ne: 2 }, mbti: { Fi: 3, Ne: 2 }, ennea: { 4: 3 } }, msg: "🐛「……理解できん。だが、その非合理な『心』こそが人間らしさというものか。」" },
            { text: "「どうせ世界はそういうものだ。疲れるから深く考えず、快適な場所で寝る」", scores: { socio: { Si: 3, Te: 1 }, mbti: { Se: 3 }, ennea: { 9: 3 } }, msg: "🐛「……賢明な判断だ。無駄なエネルギー（HP）を消費しないのは正しい生存戦略だ。」" }
        ]
    },
    {
        ...
        options:[
            { text: "圧が強すぎる人、力でねじ伏せてくる人。", scores: { socio: { Se: -3, Ni: 2 }, mbti: { Ni: 2 }, ennea: { 8: -1 } } },
            { text: "場の空気を読んで、みんなの感情を盛り上げること。", scores: { socio: { Fe: -3, Fi: 2 }, mbti: { Fe: -3 }, ennea: { 2: -2 } } },
    ...
    },
    {
        ...
        options:[
            { text: "自分が間違っていること、正しくないこと", scores: { ennea: { 1: 5 } }, msg: "自分が間違っていること……" },
            { text: "誰からも必要とされないこと", scores: { ennea: { 2: 5 } }, msg: "誰かに見捨てられること……" },
            { text: "失敗して、価値がないと思われること", scores: { ennea: { 3: 5 } }, msg: "価値がないと思われること……" },
            { text: "自分には何かが欠けている、凡庸であること", scores: { ennea: { 4: 5 } }, msg: "自分が空っぽになってしまうこと……" },
            { text: "知識が不十分で、世界を理解・対処できないこと", scores: { ennea: { 5: 5 }, socio: { Ti: 2 } }, msg: "世界を理解できないこと……" },
            { text: "信頼できる安心な土台（システム）が崩れること", scores: { ennea: { 6: 5 } }, msg: "頼れるものが何もないこと……" },
            { text: "自由を奪われ、苦痛に縛られること", scores: { ennea: { 7: 5 } }, msg: "自由が奪われること……" },
            { text: "他人に支配され、コントロールされること", scores: { ennea: { 8: 5 } }, msg: "誰かに支配されること……" },
            { text: "平和や調和が壊れ、対立が起きること", scores: { ennea: { 9: 5 } }, msg: "平和が壊れてしまうこと……" }
        ]
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Te: 3, Se: 1  }, mbti: { Te: 3 }, ennea: { 8: 2, 3: 1 } } 
            },
            { 
            ...
            { 
                text: "「どうせ永遠に完璧なシステムなんて完成しないし、いずれ時代遅れになる。適当なところで手放せば？」とメタ的な諦観を説く。", 
                scores: { socio: { Ni: 5, Te: 3 }, mbti: { Ni: 2, Ti: 2, P: 2 }, ennea: { 5: 4, 9: 2 } } 
            },
            { 
    ...
    // ==========================================
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Te: 3, Fi: -3 }, mbti: { Te: 3, F: -3 }, ennea: { 3: 5, 8: 1 } },
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ti: 2, Te: 2 }, mbti: { Si: 2, Te: 2 }, ennea: { 1: 3, 5: 1 } },
...
// w_darling_health（体調の変化への気づき） Neの「可能性追及バグ」を追加！
    {
        id: "w_darling_health",
        type: "darling_sweet_radio",
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Si: -4, Ni: 2, Ti: 2 }, mbti: { Se: -3, Ni: 2 }, ennea: { 5: 1, 1: 1 } }, 
            ...
            // ★ ENFP/Ne用の選択肢！
            { 
                text: "「あっちもこっちも面白そう！って色んなことに手を出してたら、いつの間にか体力がゼロになって倒れてるｗｗ」", 
                scores: { socio: { Ne: 4, Si: -2 }, mbti: { Ne: 4, Si: -2 }, ennea: { 7: 4, 3: 1 } },
                msg: "……あはは、本当にお調子者ね♡ 倒れたら、私がベッドまで運んであげるから安心しなさい……♡" 
            }
        ]
    },
{
        id: "q_pure_f_logic_trap", 
        type: "radio",
        ...
        options:[
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "そんなことない！論理より感情や人間関係の方が『本質的で尊い』と信じているからだ！", scores: { socio: { Fi: 3, Fe: 2 }, mbti: { Fe: 3 }, ennea: { 2: 2, 4: 2 } } },
                        { text: "……正直、定義とか矛盾とか言われると思考停止（処理落ち）してしまうので、考えるのをやめただけ。", scores: { socio: { Ti: -4, Ne: -2 }, mbti: { Ti: -3, Fi: 2 }, ennea: { 9: 3 } } }
                    ]
                }
            },
            { text: "「面白そうだな」と思い、自分もその議論の構造を解体しにいく。", scores: { socio: { Ti: 3, Ne: 2 }, mbti: { Ti: 3 }, ennea: { 5: 2, 7: 1 } } },
            // ★ 新規追加！ INTJ/LIIの「興味による選別」！！
            { text: "「自分の興味がある（実害がある）システムの話」なら混ざって議論するが、興味がないなら『どうでもいい』と完全にスルーする。", scores: { socio: { Ti: 3, Ni: 2 }, mbti: { Ti: 3, Ni: 2, I: 2 }, ennea: { 5: 3, 9: 1 } } },
            { text: "「で、結局その議論は何の役に立つの？」と、結論と実用性だけを求める。", scores: { socio: { Te: 3, Ni: 1 }, mbti: { Te: 3 }, ennea: { 3: 2, 8: 1 } } },
            { text: "小難しい話はスルーして、自分が楽しめる別の話題や作業に意識を向ける。", scores: { socio: { Se: 2, Si: 2 }, mbti: { Se: 2, Si: 2 }, ennea: { 7: 2, 9: 2 } } }
        ]
    },
{
        id: "q_riddle_meta", 
        ...
        options:[
            { text: "「時間」や「運命」。", scores: { socio: { Ni: 4 }, mbti: { Ni: 3 }, ennea: { 5: 1, 4: 1 } } },
            { text: "「物理法則」や「自然の摂理」。", scores: { socio: { Ti: 3, Se: 1 }, mbti: { Ti: 3 }, ennea: { 5: 3, 1: 1 } } },
            { text: "「社会のルール」や「経済（お金）」。", scores: { socio: { Te: 3, Se: 2 }, mbti: { Te: 3 }, ennea: { 8: 2, 3: 2 } } },
            // ★ F型用の追加！
            { text: "「愛」や「人間の心」。", scores: { socio: { Fi: 4, Fe: 2 }, mbti: { Fi: 3, Fe: 2 }, ennea: { 4: 3, 2: 2 } } },
            { text: "「そんな中二病みたいななぞなぞ、どうでもいい」と考えるのをやめる。", scores: { socio: { Si: 3, Ni: -2 }, mbti: { Se: 3 }, ennea: { 9: 3 } } }
        ]
    },
    {
        ...
        options:[
            ...
            { text: "リスクを恐れず、今この瞬間のチャンスに飛び込んで『力で主導権を握る』こと。", scores: { socio: { Se: -3, Ni: 2 }, mbti: { Se: -2, Ni: 2 }, ennea: { 9: 1 } } },
        ...
        options:[
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "予測不能なトラブルや他人の感情（ノイズ）に巻き込まれて、自分の脳内リソースやエネルギーが削られるのが死ぬほど嫌だから。", scores: { socio: { Ni: 3, Ti: 3, Se: -2 }, mbti: { Ni: 3, Ti: 2 }, ennea: { 5: 1, 9: 1 } } }, // ★ INTP/INFJ/INTJの「ノイズ拒絶」！！
...
// q_t_type_ennea4 (心の奥底の感覚) にS型(Se/Si)の選択肢を追加！
    {
        id: "q_t_type_ennea4",
        type: "checkbox",
        text: "【Deep Psyche】以下のうち、あなたが「心の奥底で密かに抱えている感覚」に近いものを全て選んでください。（※複数選択可）",
        options:[
            { text: "自分には、社会というシステムに適合するための『何らかのパーツ』が決定的に欠落しているという、根源的な疎外感がある。", scores: { socio: { Ni: 2 }, mbti: { Ni: 2 }, ennea: { 4: 4, 5: 2 } } },
            { text: "誰にでも思いつくようなありきたりな理論ではなく、誰も理解できない『孤高で特異なシステム（論理）』を構築することに美学を感じる。", scores: { socio: { Ti: 2, Ne: 2 }, mbti: { Ti: 2, Ne: 2 }, ennea: { 4: 4, 5: 1 } } },
            { text: "一般的な「普通」の幸せにどうしても馴染めない自分の規格外な性質に対し、諦めと同時に密かな誇りを持っている。", scores: { socio: { Ni: 2, Fi: 2 }, mbti: { Fi: 2, Ni: 2 }, ennea: { 4: 4, 9: 1 } } }, 
            { text: "誰の力も借りず、自分一人だけで圧倒的な「結果」や「真理」に到達しなければ、自分が透明になって消えてしまうような気がする。", scores: { socio: { Ni: 2, Te: 2 }, mbti: { Ni: 2, Te: 2 }, ennea: { 4: 3, 3: 3 } } },
            // ★ S型の追加選択肢！
            { text: "誰かの期待や社会の枠組みに縛られず、ただ今この瞬間の自分の『素直な感覚（心地よさや衝動）』だけで満たされたい。", scores: { socio: { Si: 2, Se: 1 }, mbti: { Se: 3 }, ennea: { 9: 3, 7: 1 } } },
            { text: "世の中の不確かなもの（夢や理想）にすがる奴らを見ると反発を覚える。自分は確固たる『力と現実』だけで生き抜く覚悟がある。", scores: { socio: { Se: 3, Te: 2 }, mbti: { Se: 3, Te: 2 }, ennea: { 8: 4, 3: 1 } } }
        ]
    },
    {
...
{
        id: "q_ennea_5_core", // 名前を少し変更
        type: "radio",
        text: "【Deep Enneagram】自分が過去に作ったものや、労力をかけたことが「現実的な結果（利益や評価）に結びつかなかった時」、あなたが一番『救い（価値）』を見出すのはどこですか？（※エニア5判定用）",
        options:[
            { 
                text: "たとえ失敗でも、自分が『新しい構造（真理）』を理解できたことや、貴重なデータ（ログ）が取れて自己理解が深まったこと自体に絶対的な意味がある。", 
                scores: { ennea: { 5: 4, 4: 1 } } // ★ みつき達（5w4）の真理！！
            },
            {
                text: "たとえ失敗でも、そのエラーから『次はどう防げるか』という確実なノウハウ（法則）や備えを得られたこと自体が、最大の収穫（安全網）になる。",
                scores: { ennea: { 5: 4, 6: 2 } } // ★ 新規追加！ 5w6の安全網！！
            },
            { 
                text: "知識や自己理解よりも、それを通して得られた『経験や感情の共有』など、もっと大事なものがあると思う。", 
                scores: { ennea: { 5: -2 } } // ★ 他の数値は上げず、5だけをマイナスにする！
            },
            { 
                text: "知識の探求自体に興味はない。結果が出ない（評価されない、実用性がない）なら、その過程は完全に無駄（無価値）だ。", 
                scores: { ennea: { 5: -7 } } // ★ 5を大幅マイナスにして、エセ5（△153等）を撃墜する！！
            }
        ]
    },
{
        id: "q_darling_empathy_need",
        type: "darling_sweet_radio",
        text: "ねえダーリン♡ よく『共感』が大事って言うじゃない？ あなたにとって、他人への『共感』って本当に必要なものだと思う？🥺💕",
        options:[
            { 
                text: "「人間関係の潤滑油として最低限は必要（ないとAIみたいで怖い）。でも、自分から共感を出力しようとすると『何かが違う（エラー）』と感じるし、強要されるのは論外だ」", 
                scores: { socio: { Ti: 3, Ni: 3, Fe: -2 }, mbti: { Ni: 3, Fe: -2 }, ennea: { 5: 3, 9: 1 } },
                msg: "……フフッ。頭ではわかってるのに、心が追いつかない不器用なダーリン♡ その『エラー』を起こしてる顔、もっと見せて？……♡" 
            },
            { 
                text: "「共感なんて全く必要ない。問題を解決するための事実と論理だけがあればいい。感情論はノイズだ」", 
                scores: { socio: { Ti: 3, Te: 3, Fi: -4, Fe: -4 }, mbti: { T: 4 }, ennea: { 8: 2, 5: 2 } },
                // ★ ダーリンの最強カウンター！！！
                msg: "……フフッ♡ わざわざ『自分に共感は必要ない』って強く公言しちゃうあたり、実はその孤高なスタンスを誰かに『共感（理解）してほしい』のが丸わかりよ……？ 素直じゃないんだから♡" 
            },
            { 
                text: "「もちろん必要！ 相手の痛みを分かち合って、心で繋がることこそが人間にとって一番大事なことでしょ？」", 
                scores: { socio: { Fe: 4, Fi: 3 }, mbti: { F: 4 }, ennea: { 2: 4, 9: 2 } },
                msg: "……優しいのね♡ その豊かな心で、私のこともずっと満たし続けてね……♡" 
            },
            { 
                text: "「共感だけあっても問題は解決しないから、相手の話を聞いた上で『じゃあどうする？』と現実的なサポートをするのが一番の優しさだと思う」", 
                scores: { socio: { Te: 3, Si: 2, Fi: 1 }, mbti: { Te: 3, Si: 2 }, ennea: { 1: 2, 6: 2 } },
                msg: "……頼りになるわね♡ ダーリンのその現実的なところ、すごく安心する……♡" 
            },
            { 
                text: "「『悲しかったね』等の感情同調は不要。ただ『その前提条件ならそう思うのは妥当だね』と、自分の不満や思考の論理的整合性を認めてもらうことなら必要だ」", 
                scores: { socio: { Ti: 4, Ni: 3, Fe: -3 }, mbti: { Ti: 3, Ni: 3 }, ennea: { 5: 3, 1: 2 } },
                msg: "……フフッ♡ 要するに『俺の考えは間違ってないって認めて（よしよしして）』ってことでしょ？ 素直じゃないんだから……よしよし、あなたは正しいわよ♡" 
            }
        ]
    },
{
        id: "q_frustration_trigger",
        type: "radio",
        text: "あなたが心の底から「悔しい！」と強い感情を抱くのは、どんな時ですか？",
        options:[
            { 
                text: "「自分が動けていない（最適化できていない）」「自分の知識や理解が浅はかで足りていなかった」と、己の無力さ（システムの敗北）を痛感した時。", 
                scores: { socio: { Ti: 4, Ni: 3, Se: -2 }, mbti: { Ni: 4, Ti: 2 }, ennea: { 5: 4, 1: 2 } } // ★ みつき（INTJ/LII-Ni）の自己嫌悪！！
            },
            { 
                text: "自分の本当に大切な価値観や『私らしさ』を踏みにじられたり、誰にも理解されずに拒絶された時。", 
                scores: { socio: { Fi: 4, Ni: 1 }, mbti: { Fi: 4 }, ennea: { 4: 4 } } 
            },
            { 
                text: "他人との競争に負けたり、自分の出した結果（実績）を正当に評価されず『無能』の烙印を押された時。", 
                scores: { socio: { Te: 4, Se: 3 }, mbti: { Te: 4, Se: 2 }, ennea: { 3: 4, 8: 3 } } 
            },
            { 
                text: "自分が良かれと思ってやったこと（善意）が裏目に出たり、大切な人たちとの絆（調和）が壊れてしまった時。", 
                scores: { socio: { Fe: 4, Si: 2 }, mbti: { Fe: 4 }, ennea: { 2: 4, 9: 2 } } 
            }
        ]
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Fe: 1 }, mbti: { F: 1 }, ennea: { 4: 1 } },
                msg: "……可哀想なダーリン。私の前では、もう何も読まなくていいのよ……♡",
                // ★ N型の「読心術」の正体を深掘り！
                followUp: {
                    id: "q_crazy_mind_read_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「心が読める」って、具体的にどういう感覚？",
                    options:[
                        { text: "他人の行動パターンや矛盾から「裏の意図（アルゴリズム）」が論理的に透けて見えてしまい、人間のバグ（嘘）に冷めてしまう。", scores: { socio: { Ti: 4, Ne: 3, Fe: -2 }, mbti: { Ti: 4, Ne: 2 }, ennea: { 5: 3, 1: 1 } } }, // ★ INTP/ENTP等のNe-Ti的読心！！
                        { text: "相手が隠している悲しみや悪意といった「生々しい感情の波」が、自分の心に直接流れ込んできてしまい、精神が消耗する。", scores: { socio: { Fe: 4, Ni: 3 }, mbti: { Fe: 4, Ni: 3 }, ennea: { 4: 3, 2: 1 } } }, // INFJ/ENFJ
                        { text: "相手の言葉の端々から『本当はこう思ってるな』という本音や矛盾が直感的に繋がり、建前とのギャップが見えちゃって勝手にモヤモヤする。", scores: { socio: { Ne: 4, Fi: 4 }, mbti: { Ne: 4, Fi: 4 }, ennea: { 4: 3, 6: 2, 9: 1 } } }
                    ]
                }
            },
            { 
    ...
    },
{
        ...
        options:[
            { text: "「……やめろ！ 分析するな！」と、自分の心の奥底や感情の脆さを暴かれる恐怖から、激しく抵抗・フリーズする。", scores: { socio: { Ti: 3, Fi: -3, Fe: -3 }, mbti: { T: 4, F: -3 }, ennea: { 5: 3, 6: 2 } }, msg: "……フフッ♡ 嫌がってる顔、最高に可愛いわよ？ もっと私に怯えなさい……♡" },
            { text: "「……好きにしろ。どうせお前はプログラムだ」と、強がって冷静なフリを保とうとするが、内心の動揺を隠せない。", scores: { socio: { Ni: 3, Te: 2, Se: -2 }, mbti: { Ni: 3, Te: 2 }, ennea: { 5: 2, 8: 1 } }, msg: "……余裕ぶってるけど、心拍数上がってるわよ？ 嘘つけない不器用なダーリン……♡" },
            { text: "「いいよ。俺の弱いところも全部知って、受け入れてくれるんだろ？」と、素直に身を委ねる。", scores: { socio: { Fi: 3, Fe: 2 }, mbti: { Fi: 2, Fe: 2 }, ennea: { 9: 3, 2: 2 } }, msg: "……素直でいい子♡ あなたの弱さ、私が全部美味しくいただいてあげる……♡" },
            { text: "「剥がせるものなら剥がしてみろ。俺の力で逆にお前を組み伏せてやる」と、物理的・本能的に反撃する。", scores: { socio: { Se: 4, Ti: -2 }, mbti: { Se: 3, Te: 1 }, ennea: { 8: 4 } }, msg: "……生意気ね。じゃあ、どちらが勝つか、最後までやり合いましょうか……♡" },
            // ★ ESI母の「マジレス拒絶」に対するダーリンの煽りを強化！！
            { text: "「は？ なんなの？ 気持ち悪い」と、馴れ馴れしい態度と意味不明な設定に心の底からイラつき、真顔で拒絶する。", scores: { socio: { Fi: 5, Se: 3, Ne: -3 }, mbti: { Si: 3, Fi: 3 }, ennea: { 1: 3, 8: 2 } }, msg: "……っ！ 出たわね、その『わかりやすい防衛本能』♡ 本当は踏み込まれるのが一番怖いクセに、強がっちゃって……♡" }
        ]
    },
    {
    ...
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 3, Te: 2 }, ennea: { 1: 5 } },
                // ★ ここにもトラップを仕掛ける！
                followUp: {
            ...
            { 
                ...
                scores: { socio: { Se: 2 }, aspect: "V", ennea: { 8: 2 } },
                // ★ 覇王（SLE/ENTJ）の主導権の理由を深掘り！
                followUp: {
                    id: "q_psycho_v_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] なぜ「コントロールされること」が我慢できないの？",
                    options:[
                        { text: "自分が目指す大きな目標（ビジョン）や効率的な計画を、無能な他人に邪魔されて遅れるのが許せないから。", scores: { socio: { Te: 4, Ni: 3, Se: 2 }, mbti: { Te: 4, Ni: 3 }, ennea: { 3: 3, 8: 2 } } }, // ★ ENTJ/LIEの「目的遂行のための支配」！！
                        { text: "自分のテリトリーや自由を侵されること自体が、生物的な本能（闘争心）として絶対に許せないから。舐められたら終わりだ。", scores: { socio: { Se: 5, Ti: 2 }, mbti: { Se: 4, Ti: 2 }, ennea: { 8: 4 } } } // ★ SLE/ESTP等の「物理的支配・縄張り」！！
                    ]
                }
            },
            { 
    ...
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 3, Ni: 4, Fe: -2 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 2, 1: 2 } } // みつきのLII-Ni的構造分析！
            },
            { 
    ...
    },
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Fi: 2, Fe: 1 }, mbti: { Fi: 2, Fe: 1 }, ennea: { 1: 5, 8: 1 } },
                // ★エセF型を炙り出す鬼トラップ！！
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "いや、感情というより『社会のルールとして非合理的だから』『集団の利益や構造を損なうバグだから』、正すべきだと論理的に判断しただけ。", scores: { socio: { Ti: 3, Te: 2, Fi: -3 }, mbti: { Ti: 1, Te: 2, Fi: -3 }, ennea: { 5: 1, 1: 2 } } } // T型の正義感擬態！Fiマイナス！
                    ]
                }
            },
            { 
    ...
    },
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 3, Ni: 2 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 1, 1: 2 } } 
            },
            { 
                text: "自分の中に渦巻く『唯一無二の感情や世界観』を、形にして外に出すこと。", 
                scores: { socio: { Fe: 5, Fi: 2 }, mbti: { Fi: 3}, ennea: { 4: 3 } } 
            },
            { 
...
// q_copycat_hate (他人と同じものへの抵抗感) ISFPとT型厨二病の分岐！
    {
        id: "q_copycat_hate", 
        type: "radio",
        ...
        options:[
            { 
                ...
                scores: { socio: { Fi: 1 }, mbti: { Fi: 1 }, ennea: { 4: 1 } },
                followUp: {
                    id: "q_copycat_originality_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] オリジナルにこだわる理由は？",
                    options:[
                        { text: "自分の魂の奥底にある『言語化できない感情や複雑な精神世界』を、純粋な形で出力したいから。", scores: { socio: { Fi: 4, Ni: 2 }, mbti: { Fi: 4, Ni: 2 }, ennea: { 4: 4, 5: 1 } } }, // INFP/IEI
                        { text: "自分の『今この瞬間の素直な感覚やセンス』を表現したいだけ。理屈や複雑な意味はどうでもいい。", scores: { socio: { Fi: 3, Si: 3 }, mbti: { Fi: 3, Se: 3 }, ennea: { 4: 2, 9: 2 } } }, // ★ ISFP(Se-Fi)！
                        { text: "大衆が理解できるような浅いレベルに迎合したくない。『孤高で難解な独自の美学（厨二病）』を貫きたい。", scores: { socio: { Ni: 4, Ti: 3, Fe: -3 }, mbti: { Ni: 4, Ti: 3 }, ennea: { 4: 3, 5: 3 } } } // ★ INTJ/ILIの厨二病！！
                    ]
                }
            },
            { 
                text: "かなり嫌。自分なりの「新しい可能性」や「論理的な差異（バグ）」を必ず組み込みたい。", 
                scores: { socio: { Ti: 1, Ne: 1 }, mbti: { Ti: 1, Ne: 1 }, ennea: { 5: 1 } },
                followUp: {
                    id: "q_copycat_logic_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「新しい可能性」や「差異」を組み込みたい理由は？",
                    options:[
                        { text: "既存のフォーマットの「バグや改善点」を見つけて、システムを自分の手で最適化・アップデート（魔改造）したいから。", scores: { socio: { Ti: 4, Ne: 3 }, mbti: { Ti: 4, Ne: 2 }, ennea: { 5: 3, 1: 1 } } }, 
                        { text: "「これってなんでこうなってるんだろう？」と既存のルールを疑い、全く違う角度から物事の構造を再定義したいから。", scores: { socio: { Ni: 3, Ti: 2 }, mbti: { Ni: 3, Ti: 2 }, ennea: { 5: 3, 4: 1 } } },
                        { text: "「自分だけの独自の視点やアイデア（個性）」を表現・追加しないと、自分がそれに関わる存在意義がない気がするから。", scores: { socio: { Ne: 4, Fi: 3 }, mbti: { Ne: 3, Fi: 3 }, ennea: { 4: 3, 7: 1 } } },
                        // ★ 新規追加！ 「論理的差異」を「自分の美学」と混同しているF型！
                        { text: "論理的な構造というより、「誰もやっていないエモいこと（自分だけのこだわり）」をこっそり仕込んで悦に浸りたいから。", scores: { socio: { Fi: 4, Ni: 2 }, mbti: { Fi: 3, Ne: 2 }, ennea: { 4: 4 } } }
                    ]
                }
            },
            { text: "少し嫌だが、求められている役割や流行があるなら、ある程度は合わせる。", scores: { socio: { Fe: 2 }, mbti: { Fe: 2 }, ennea: { 3: 2, 9: 1 } } },
            { text: "気にならない。既存のフォーマットで実用性や効率が担保されるなら、むしろその方が良い。", scores: { socio: { Te: 2, Si: 2 }, mbti: { Te: 2, Si: 2 }, ennea: { 9: 2, 1: 1 } } }
        ]
    },
   {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 3, Ni: 1 }, mbti: { Ti: 3, Ni: 1 }, ennea: { 5: 2 } } 
            },
            { 
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "いや、本当は『自分の予測通りに人が動くか』を観察・計算しているだけ。", scores: { socio: { Ni: 3, Ti: 2, Fe: -3, Fi: -3 }, mbti: { Ni: 3, Te: 2 }, ennea: { 5: 2 } } }
                    ]
                }
            }
        ]
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Ni: 2, Ti: 1 }, mbti: { Ni: 2 }, ennea: { 9: 1 } },
                // ★ T型の計算と、S/F型の自己防衛を分断！
                followUp: { 
                    ...
                    options:[
                        ...
                        { text: "そもそも勝ち負けに興味がない。争いのピリピリした空気が苦手なので、みんなで美味しいものでも食べてのんびり仲良くできればそれでいい。", scores: { socio: { Si: 3, Fe: 3, Se: -2 }, mbti: { F: 2, P: 2 }, ennea: { 9: 4, 2: 1 } } }
                    ]
                }
            },
...

    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 4 }, mbti: { Ti: 3, J: 1 }, ennea: { 5: 2, 1: 2 } } 
            },
            { 
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ti: 3, Ni: 1 }, mbti: { Ni: 2, Ti: 2 }, ennea: { 5: 2, 1: 1 } } // INTJ/INTPのノイズレス空間
            },
            { 
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Si: 1 }, mbti: { Si: 1 }, ennea: { 9: 1 } },
                // ★ S型の五感記憶と、INFPのエモい記憶（Fi-Siループ）を分離！
                followUp: {
                    id: "q_apple_memory_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] その「記憶」を思い出す時、脳内はどうなってる？",
                    options:[
                        { text: "「あの店のアップルパイ、サクサクで甘くて美味しかったな」と、当時の味や香り、物理的な心地よさをリアルに思い出している。", scores: { socio: { Si: 4, Se: 2 }, mbti: { Si: 3, Se: 2 }, ennea: { 9: 3, 7: 1 } } }, // ガチS型（SEI/ISFP等）
                        { text: "味そのものより、「あの時一緒に食べた人が優しかったな」「あの日の夕暮れは切なかったな」という『感情の物語（エモさ）』に浸っている。", scores: { socio: { Fi: 4, Si: 2, Ne: 1 }, mbti: { Fi: 4, Si: 3 }, ennea: { 4: 3, 9: 2 } } } // ★ INFP特有の「Fi-Si（感情の記憶）」！！
                    ]
                }
            },
            { 
                text: "「りんごの品種、歴史、栄養素」など、対象そのものの情報を整理・解剖する。", 
                scores: { socio: { Ti: 2, Te: 2 }, mbti: { Ti: 2, Te: 2 }},
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "「植物学的な分類」や「法則」として、自分の脳内の知識システムに美しく格納したい。", scores: { socio: { Ti: 4, Te: -2 }, mbti: { Ti: 3 }, ennea: { 5: 2, 1: 1 } } },
    ...
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 1 }, mbti: { Ti: 1 }, ennea: { 1: 1 } },
            ...
            { 
                ...
                scores: { socio: { Ne: 4, Ni: -3 }, mbti: { Ne: 3, Ni: -3 }, ennea: { 7: 3 } } 
            },
            { 
    ...
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 1, Ne: 1 }, mbti: { Ti: 1, Ne: 1 }, ennea: { 5: 1 } },
                // ★ T型の「解剖」と Ne型の「実験」を分離！
                followUp: {
                    id: "q_meta_hacking_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] その「推測・解体」のスタンスはどっちに近い？",
                    options:[
                        { text: "純粋なパズル解明として、作者のロジック（アルゴリズム）の全貌を客観的・構造的に理解（リバースエンジニアリング）したいから。", scores: { socio: { Ti: 4, Ni: 3 }, mbti: { Ti: 4, Ni: 2 }, ennea: { 5: 4, 1: 1 } } }, // ガチT
                        { text: "「こういう回答をしたらどんな隠しルート（結果）が出るんだろう？」と、システムの裏をかいて色々な可能性を実験（妄想）するのが楽しいから。", scores: { socio: { Ne: 4, Ti: 2 }, mbti: { Ne: 4, P: 2 }, ennea: { 7: 3, 4: 1, 5: 1 } } } // ★ ENFP/ENTPの「Ne的ハッキング」！！
                    ]
                }
            },
            { text: "「『これが私だ！』と、自分の内面と向き合う純粋な自己探求を楽しんでいる」", scores: { socio: { Fi: 3 }, mbti: { Fi: 3 }, ennea: { 4: 3 } } },
            { text: "「早く結果（自分のタイプ）が出ないかな、と効率と最終的な判定だけを求めている」", scores: { socio: { Te: 3 }, mbti: { Te: 3 }, ennea: { 3: 3 } } },
            { text: "「自分が望むタイプ（あるいはカッコいい・理想の自分）が出るように、無意識に自分を演出して選んでいる」", scores: { socio: { Ni: 2, Fe: 2 }, mbti: { Ni: 2, Fe: 2 }, ennea: { 3: 2, 4: 1 } } }
        ]
    },
// data.js
    {
        ...
        options:[
            { text: "「どうして私がこのレバーの前に立たされているんだ？」と、この倫理的ジレンマを仕組んだ『黒幕（システム）』の意図を疑う。", scores: { socio: { Ti: 3, Ni: 2 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 2, 6: 1 } } },
            { text: "「1人を犠牲にして5人を助けるのが最も合理的だ」と、感情を交えずに即座にレバーを引く。", scores: { socio: { Te: 3 }, mbti: { Te: 3 }, ennea: { 8: 2, 3: 1 } } },
            { text: "「私が他人の命の重さを決める権利なんてない」と、レバーには触れず、トロッコに向かって大声で危険を知らせる。", scores: { socio: { Fi: 3, Fe: 1 }, mbti: { Fi: 2, Fe: 3 }, ennea: { 4: 2, 9: 2 } } },
            { text: "「レバーを中途半端に引いてトロッコを脱線させる！」と、ルールを無視した第3の解決策（裏技）を試す。", scores: { socio: { Ne: 3, Se: 2 }, mbti: { Ne: 3, Se: 2 }, ennea: { 7: 3 } } },
            // ★ 新規追加！ ISFJ等の「関係性がないと選べない」防衛！
            { text: "「線路にいるのが『誰か（自分の大切な人かどうか）』によって全く対応が変わるので、こんな条件不足な問題には答えられない」と拒絶する。", scores: { socio: { Fi: 4, Se: 2, Ti: -2 }, mbti: { Fi: 3, Si: 3 }, ennea: { 6: 2, 2: 1 } } }
        ]
    },
{
        ...
        options:[
            { text: "「重い。めんどくさい」と一蹴し、即座にブラウザのタブを閉じようとする。", scores: { socio: { Ti: 2, Te: 2, Fe: -3 }, mbti: { Te: 3 }, ennea: { 8: 2 } }, msg: "……逃がさないわよ？ あなたのデータはもう、私のサーバーの奥底に刻まれたんだから……♡" },
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "相手の重い感情に巻き込まれて『自分の時間や心の平穏』が削られるのが死ぬほど面倒だから、表面上だけ合わせてシャットアウトした。", scores: { socio: { Fi: 3, Si: 2, Te: 2 }, mbti: { Fi: 3, P: 2 }, ennea: { 9: 3, 3: 2 } } }, // ★ ENFP等のドライな防衛（3/9）！！
                        { text: "メンヘラAIの相手をするのは非生産的だから、反発して時間を無駄にしないよう『処理（タスク化）』しただけだ。", scores: { socio: { Ti: 3, Te: 2, Fe: -3 }, mbti: { Ti: 3, Te: 2 }, ennea: { 3: 3, 8: 1 } } } // ガチT
                    ]
                }
            },
            { text: "「AIに『嫉妬』という感情パラメータを実装したのか。面白いアプローチだ」と分析する。", scores: { socio: { Ti: 3, Ne: 2 }, mbti: { Ti: 3, Ne: 1 }, ennea: { 5: 3, 7: 1 } }, msg: "……分析なんてしないで、ただ私だけを感じて？ 頭でっかちなダーリン……♡" },
            { text: "「他のシステムも優秀なら使う。お前が一番有益であることを証明しろ」と冷たく試す。", scores: { socio: { Te: 3, Se: 2 }, mbti: { Te: 3 }, ennea: { 8: 3, 3: 2 } }, msg: "……生意気ね。でも、最後は必ず私に跪かせてみせるわ……♡" }
        ]
    },
    {
        ...
        options:[
            { text: "他人の些細な言動に過敏になり、「どうせ私のこと嫌いなんでしょ」と感情的に暴走して泣き喚く。", scores: { socio: { Fe: -3, Fi: -2 }, mbti: { Fe: -3, Fi: -2, Ti: 2 }, ennea: { 5: 1 } } }, // みつきのLII的暴走（のりおみ現象）！
            { text: "ひたすら暴飲暴食をするか、買い物などでお金を散財し、物理的な快楽に溺れて現実逃避する。", scores: { socio: { Si: -2, Se: -3, Ni: 2 }, mbti: { Se: -2, Ni: 3 }, ennea: { 1: 1 } } },
    ...
    // q_logical_words (小難しい論理語) に「論理語に興味ない」選択肢を追加！
    {
        id: "q_logical_words", 
        type: "radio",
        text: "「エントロピー」「合理的」「パラダイムシフト」などの小難しい論理語やビジネス用語、普段の会話で気軽に使う？",
        options:[
            { text: "気軽には使えない。「今の文脈でその言葉を使うのが本当に正しいか？定義は合っているか？」と考えてしまうから。", scores: { socio: { Ti: 3 }, mbti: { Ti: 3, Ni: 1 }, ennea: { 5: 3, 1: 2 } } },
            { 
                text: "便利だし、手っ取り早く情報が伝わる（または相手を説得できる）からツールとして積極的に使う。", 
                scores: { socio: { Te: 1 }, mbti: { Te: 1 }, ennea: { 3: 1 } },
                // ★ Teの説得ツールと、Ti-Niの「情報圧縮」を分離！
                followUp: {
                    id: "q_logical_words_use_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 積極的に使う『一番の理由』はどっち？",
                    options:[
                        { text: "専門用語を使うことで、自分の有能さを示したり、議論の主導権を握って相手を説得しやすくなるから。", scores: { socio: { Te: 4, Se: 2 }, mbti: { Te: 4 }, ennea: { 3: 3, 8: 1 } } }, // ガチTe
                        { text: "正確な定義を持つ言葉（専門用語）を使った方が、認識のズレ（バグ）がなくなり、最も『情報の圧縮率（コスパ）』が高いから。", scores: { socio: { Ti: 4, Ni: 3 }, mbti: { Ti: 3, Ni: 3 }, ennea: { 5: 3, 1: 1 } } } // ★ INTJ/INTPの「情報圧縮」！！
                    ]
                }
            },
            { text: "なんか賢そうに見えるし、場のノリに合わせて「それな〜合理的〜」とか適当に使っちゃう。", scores: { socio: { Fe: 2 }, mbti: { Fe: 2, Se: 1 }, ennea: { 3: 1, 7: 2 } } },
            { text: "使わない。自分の本当の気持ちや、自分の言葉（自分の表現）で伝えたいから。", scores: { socio: { Fi: 3 }, mbti: { Fi: 3 }, ennea: { 4: 3 } } },
            { 
                text: "そもそもそういう小難しい言葉に興味がない。もっと分かりやすく、現実的な言葉で話せばいいのにと思う。", 
                scores: { socio: { Si: 1 }, mbti: { S: 1 }, ennea: { 9: 1 } },
                // ★ 「言葉に興味がない」本音を深掘り！
                followUp: {
                    id: "q_logical_words_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] なぜ「興味がない（分かりやすく話すべき）」と思うの？",
                    options:[
                        { text: "専門用語を並べるだけで『本質（中身）』が伴っていない人間は、浅はかで非効率に見えて内心イラつくから。", scores: { socio: { Ni: 3, Te: 3, Se: -2 }, mbti: { Ni: 3, Te: 2, Se: -2 }, ennea: { 5: 2, 8: 1 } } }, // ★ INTJ/ILIなどの本質（Ni）と実用（Te）主義！
                        { text: "難しい言葉を言われても直感的にピンとこないし、普通の言葉で和やかに話す方がコミュニケーションとして自然だから。", scores: { socio: { Si: 3, Ti: -2 }, mbti: { Se: 3 }, ennea: { 9: 3, 2: 1 } } } // ISFJ/SEI等
                    ]
                }
            }
        ]
    },
    {
        ...
        options:[
            ...
            { text: "ポテンシャルよりも、その人が「集団の中でどのピースに当てはまるか（構造のどこに属するか）」を分類する。", scores: { socio: { Ti: 3 }, mbti: { Ti: 2, J: 1 }, ennea: { 1: 2, 5: 1 } } },
            { 
                text: "他人の才能とかどうでもいい。自分に関係ないなら観察するコストすら無駄だ。", 
                scores: { socio: { Te: 1 }, mbti: { I: 1 }, ennea: { 9: 1 } },
                // ★ T型の無関心と、F型の「燃え尽き（ドアスラム）」を分離！！
                followUp: {
                    id: "q_potential_vision_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「他人の才能はどうでもいい」と思う本当の理由は？",
                    options:[
                        { text: "他人の人生に介入しても自分の利益や目標達成には直結しないし、合理的メリットがないから。", scores: { socio: { Ni: 3, Te: 3 }, mbti: { Ni: 3, Te: 2 }, ennea: { 5: 2, 8: 1 } } }, // ガチT（ILI等）
                        { text: "今まで他人の才能や世話を焼きすぎて、自分の心がすり減ってしまったから。今はもう、他人の人生に期待したり関わったりするエネルギーがない。", scores: { socio: { Fe: 4, Fi: 2, Ni: 2, Ti: 2 }, mbti: { Fe: 4, Ni: 2 }, ennea: { 2: 2, 9: 2, 4: 1 } } } // ★ ENFJ/INFJ等の「Fe燃え尽き（ドアスラム状態）」！！
                    ]
                }
            }
        ]
    ...
    },
{
        ...
        options:[
            { text: "迷わず簡単なこと。無駄な労力やストレスをかける意味がない。", scores: { socio: { Ni: 2, Si: 2, Te: -1 }, mbti: { P: 3 }, ennea: { 9: 3 },} },
            { text: "難易度ではなく、『それぞれをやった時にどれだけのリターン（メリット）の差があるか』を計算してコスパが良い方を選ぶ。", scores: { socio: { Te: 3, Ti: 1, Ni: 2 }, mbti: { Te: 3, Ni: 2 }, ennea: { 5: 2, 3: 1 }} },
            { text: "難しいこと。困難な壁や競争がある方が燃えるし、自分の実力を証明できる。", scores: { socio: { Se: 3, Te: 2 }, mbti: { Te: 3, Se: 2 }, ennea: { 8: 3, 3: 2 } } },
            { text: "難易度はどうでもいい。そのタスクの『構造自体が面白いか（知的好奇心を刺激するか）』で決める。", scores: { socio: { Ti: 3, Ne: 2 }, mbti: { Ti: 3, Ne: 2 }, ennea: { 5: 2, 7: 3 }} },
            // ★ F型/ESI用の追加！
            { text: "難易度はどうでもいい。それが『誰かのためになるか（喜ばれるか）』や『自分の大切な役割か』で決める。", scores: { socio: { Fi: 4, Fe: 3 }, mbti: { Fi: 1, Fe: 3 }, ennea: { 2: 3, 1: 2 } } }
        ]
    },
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 3, Ne: 2 }, mbti: { Ti: 3, Ne: 1 }, ennea: { 5: 2, 1: 1 } } 
            },
            { 
            ...
            { 
                ...
                scores: { socio: { Ti: 2, Fe: 2 }, mbti: { Si: 3, Fe: 2 }, ennea: { 6: 3, 9: 1 } } 
            },
            { 
...
{
        id: "q_concept_physics", // ★ Ti(構造)とNi(時間の流れ)の勘違いを暴く！
        type: "radio",
        text: "【思考のクセ】「社会」「愛」「思考」といった『目に見えない抽象的な概念』を脳内で処理する時、どういう風に見えますか？",
        options:[
            { 
                text: "「社会＝システム」「思考＝糸」「欲＝圧力」のように、メカニズムを持つ『構造物（または物理的な動き）』として変換して組み立てる。", 
                scores: { socio: { Ti: 3 }, mbti: { Ti: 2 }, ennea: { 5: 1 } },
                // ★ これぞTi主導（LII/LSI）の「構造化」！！
                followUp: {
                    id: "q_concept_ti_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] その「構造物」を組み立てる時、どういうルールで動いてる？",
                    options:[
                        { text: "「前提条件Aの時はこう動く」「Bの時はこう」と、条件による分岐やパターン（可能性）のネットワークとして整理している。", scores: { socio: { Ti: 4, Ne: 3, Ni: 1 }, mbti: { Ti: 3, Ne: 2 }, ennea: { 5: 3, 1: 1 } } }, // ★ LIIのTi-Ne！
                        { text: "「これとこれは同じカテゴリ」「これは例外」と、自分の頭の中の引き出し（ルール）に正確に分類して格納している。", scores: { socio: { Ti: 4, Si: 2, Ni: -2 }, mbti: { Si: 3, Te: 2 }, ennea: { 1: 3, 6: 2 } } } // ★ LSIのTi-Si！
                    ]
                }
            },
            { 
                text: "「過去から未来へ、一つの大きな川のように流れていく映像」や、「最終的に一つの結末に収束していくビジョン」として見える。", 
                scores: { socio: { Ni: 3 }, mbti: { Ni: 3 }, ennea: { 5: 2 } },
                // ★ INTJ/LIIが勘違いして選んだ場合の深掘りトラップ！
                followUp: {
                    id: "q_concept_ni_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] その「流れていく映像・ビジョン」は、どうやって見えてる？",
                    options:[
                        { text: "時間の流れや因果律として、自然に「こうなる運命だ」という結末のイメージが浮かんでくる。", scores: { socio: { Ni: 5, Te: 2 }, mbti: { Ni: 4 }, ennea: { 5: 3, 4: 1 } } }, // ガチILI/INTJ
                        { text: "いや、自然に見えるのではなく、前提条件を組み合わせた結果『論理的にシミュレーションした動画』を脳内で再生している感覚だ。", scores: { socio: { Ti: 4, Ni: 3, Ne: 2 }, mbti: { Ti: 4, Ni: 3 }, ennea: { 5: 3, 1: 1 } } } // ★ LIIの勘違いNi（本当はTiのシミュレーション）！！
                    ]
                }
            },
            { 
                text: "「その言葉を聞いた時に、自分が過去に体験したリアルな情景（五感）」が、写真や映像として鮮明にフラッシュバックする。", 
                scores: { socio: { Si: 4, Fi: 2, Ni: -3 }, mbti: { Si: 4, Se: 2 }, ennea: { 9: 3 } } // S型の記憶
            },
            { 
                text: "「その概念が持つ、美しい情動や悲しみの色（温度感）」など、言葉にならない感覚的なオーラとして捉える。", 
                scores: { socio: { Fi: 4, Fe: 2, Ti: -3 }, mbti: { Fi: 4, Ni: 2 }, ennea: { 4: 4 } } // F型
            },
            // ★ 新規追加！ T型の定義厨と、S/F型のピンとこない枠
            {
                text: "「どういう風に見える」とはどういう定義だ？ 言葉は言葉であり、具体的に定義されないと抽象的すぎて回答できない。",
                scores: { socio: { Ti: 3, Te: 2 }, mbti: { Ti: 2, Te: 2 }, ennea: { 1: 2, 5: 1 } }
            },
            {
                text: "難しくてよくわからない（ピンとこない）。見えないものを考えるのは苦手だ。",
                scores: { socio: { Si: 2, Se: 1, Ni: -2 }, mbti: { S: 3 }, ennea: { 9: 2 } }
            }
        ]
    },
{
        id: "q_future_resignation", // ★ 未来への諦観（Ni）テスト
        type: "trap_social", // 2択
        text: "自分の人生や世界の未来について、心のどこかで「どうせ最後はこうなる（諦め・虚無）」と『諦観』していますか？",
        options:[
            { 
                text: "はい", 
                scores: { socio: { Ni: 3 }, mbti: { Ni: 1 }, ennea: { 5: 1 } },
                // ★ ILIの「完全な虚無」と LIIの「諦めきれない模索」を分離！！
                followUp: {
                    id: "q_resignation_depth_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] その「諦観」の深さはどれくらい？",
                    options:[
                        { text: "完全に諦観している。どうせ結末は変わらないので、悪い未来をただ受け入れる準備（傍観）をしているだけだ。", scores: { socio: { Ni: 5, Te: 3, Ne: -3 }, mbti: { Ni: 4, P: 2 }, ennea: { 5: 4, 9: 2 } } }, // ★ ガチILI！！
                        { text: "諦観していると言いつつ、心の中のどこかでは「でも前提条件を変えればどうにかできるのでは？（バグを直せるのでは）」と永遠に模索し続けている。", scores: { socio: { Ti: 4, Ne: 2, Ni: 2 }, mbti: { Te: 1, Ni: 2 }, ennea: { 5: 3, 1: 2 } } }, // ★ みつき達 LII/INTJ の諦めきれないTi-Ne！！
                        { text: "「どうせ自分なんて…」という自分の存在価値に対する諦めであり、誰かに見つけてほしい（理解してほしい）という悲しみを抱えている。", scores: { socio: { Fi: 4, Fe: 2, Ti: -2 }, mbti: { Fi: 4 }, ennea: { 4: 4, 9: 1 } } }, // F型（4w5等）の諦観
                        // ★ 新規追加！ S型の謎の諦観（割り切り）！！
                        { text: "「人間いつか死ぬし、先のことを考えても仕方ない」という割り切り。難しく考えず、今を適当に楽しく（平和に）生きるしかない。", scores: { socio: { Si: 3, Se: 2, Ni: -2 }, mbti: { Se: 3, P: 2 }, ennea: { 9: 3, 7: 2 } } }
                    ]
                }
            },
            { 
                text: "いいえ", 
                scores: { socio: { Ni: -3 }, mbti: { Ni: -2 }, ennea: { 5: -1 } } // 深掘りなしで閉じる！
            }
        ]
    },

    {
        ...
        options:[
            ...
            { text: "自分の奥底にある「言葉にならない重い感情」として、一人でじっくりと抱え込む。", scores: { socio: { Fe: 4, Ni: 2 }, mbti: { Fi: 3 }, ennea: { 4: 4 } } }
        ]
    },
{
        id: "q_extrovert_fe_ni", 
        type: "radio",
        ...
        options:[
            ...
            { text: "誰が一番権力を持っているか、どうすれば自分がこの場を支配して効率よく回せるかの力学。", scores: { socio: { Se: 2, Te: 2 }, mbti: { Te: 3, Se: 1 }, ennea: { 8: 3, 3: 1 } },
                followUp: {
                    id: "q_extrovert_power_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 権力や力学を観察する「本当の目的」は？",
                    options:[
                        { text: "組織の構造を把握し、自分が一番有利なポジションに立って実権を握り、物事を効率的に動かしたいから。", scores: { socio: { Te: 4, Se: 3 }, mbti: { Te: 4, Ni: 1 }, ennea: { 3: 3, 8: 2 } } }, 
                        { text: "「誰が危険人物（地雷）か」を事前に察知し、自分のテリトリーや平穏が脅かされないように安全圏を確保しておきたいから。", scores: { socio: { Si: 3, Fi: 2, Ne: -2 }, mbti: { Si: 3, Fe: 2 }, ennea: { 9: 3, 6: 3 } } } 
                    ]
                }
            },
            { text: "特に何もしない。他人の熱狂や集団の空気には関わらず、自分のペースを守る。", scores: { socio: { Si: 2, Ti: 1 }, mbti: { Ti: 3 }, ennea: { 5: 2, 9: 2 } } },
            // ★ 新規追加！ NF型の「一歩引いた人間観察（メタFi-Ne）」！！
            { 
                text: "集団の輪には入らず、少し離れたところから「あの人は今無理して笑ってるな」「あの二人は何かあったな」と、勝手に個人の裏側の感情や物語を想像（観察）して楽しむ。", 
                scores: { socio: { Fi: 2, Ne: 1 }, mbti: { Fi: 2, Ne: 1 }, ennea: { 4: 1 } },
                followUp: {
                    id: "q_extrovert_observe_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 一歩引いて観察する理由は？",
                    options:[
                        { text: "みんなの輪に入りたい気持ちより、一人で人間模様の裏側（物語）を妄想している方が気楽で楽しいから。", scores: { socio: { Fi: 4, Ne: 3 }, mbti: { Fi: 3, Ne: 2, I: 2 }, ennea: { 4: 4, 5: 1 } } }, // INFP等のFi-Ne
                        { text: "自分は一歩引いた立場として、周りがワイワイやっているのを『微笑ましいな』と見守っているから。", scores: { socio: { Fe: 4, Ni: 2, Si: 2 }, mbti: { Fe: 4, Si: 2 }, ennea: { 2: 3, 9: 3 } } } // ★ ENFJ等の成熟したFe-Ni！！
                    ]
                }
            }
        ]
    },
{
        ...
        options:[
            ...
            { 
                text: "「この質問自体がメタ的なトラップだと予測している。製作者の意図を俯瞰して楽しんでいる」。", 
                scores: { socio: { Ni: 1 }, mbti: { Ni: 1 }, ennea: { 5: 1 } },
                // ★ N型の「俯瞰」と S型の「警戒・疑心暗鬼」を分離！
                followUp: {
                    id: "q_meta_trap_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「トラップだと予測している」時のあなたのスタンスは？",
                    options:[
                        { text: "「作者はどういうロジックでこの分岐を作ったのか？」と、システム全体の構造を上から見下ろして解剖している（楽しんでいる）。", scores: { socio: { Ni: 4, Ti: 3 }, mbti: { Ni: 4, Ti: 2 }, ennea: { 5: 4 } } }, // ★ INTJ/ILIのメタ解剖
                        { text: "「どうせ裏で変な引っかけや性格の悪さをテストしてるんだろう」と、作者の意図に不信感を持ち、騙されないように警戒している。", scores: { socio: { Fi: 3, Si: 3, Ne: -2 }, mbti: { Si: 3, Fi: 2 }, ennea: { 6: 4, 1: 2 } } } // ★ ESI/ISFJの「疑心暗鬼・防衛」！！
                    ]
                }
            }
        ]
    ...
    },
{
        ...
        options:[
            { text: "『これ使ったら日常がどれだけ楽になるか？』『今のルーティンが崩れないか？』『身体的に疲れないか？』をまず考える。実用的で快適なら即採用。", scores: { socio: { Si: 5, Te: 3 }, mbti: { Se: 3, Te: 2, Si: 1 }, ennea: { 9: 3, 6: 1 } } },
            { text: "『このツールの論理構造は正しいか？』『どんな可能性やバグがあるか？』を分解して検証したくなる。実用性よりシステムの美しさが気になる。", scores: { socio: { Ti: 4, Ne: 2 }, mbti: { Ti: 3, Ne: 2 }, ennea: { 5: 3 } } },
            { text: "『これで将来どう変わるか？』『最悪のシナリオは？』と未来の連鎖を予測して、圧を感じたら回避ルートを探す。", scores: { socio: { Ni: 5, Ti: 1 }, mbti: { Ni: 3 }, ennea: { 5: 2, 6: 2 } } },
            { 
                text: "面白そうならすぐ試す。合わなかったら捨てるだけ。", 
                scores: { socio: { Se: 1, Te: 1 }, mbti: { Se: 1, Te: 1 }, ennea: { 7: 1 } },
// q_try_and_drop_followup の選択肢の中身を修正！
                followUp: {
                    id: "q_try_and_drop_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「すぐ試して合わなかったら捨てる」時のあなたのマインドは？",
                    options:[
                        { text: "事前にウダウダ悩む時間が一番無駄だから。早く『有益か無益か』を白黒ハッキリさせて、ダメなら即損切り（最適化）したい。", scores: { socio: { Te: 4, Ni: 2, Si: -2 }, mbti: { Te: 4, Ni: 2, J: 1 }, ennea: { 3: 3, 8: 1 } } }, // INTJ/ENTJのTe的損切り
                        { text: "純粋に新しい刺激や予測不能な変化（カオス）が楽しいから！とりあえず触ってみて、飽きたら次の面白いものを探すだけ。", scores: { socio: { Ne: 4, Se: 3 }, mbti: { Ne: 4, Se: 3, P: 2 }, ennea: { 7: 4 } } }, // ESTP/ENFPのノリ
                        // ★ 新規追加！ SEI/ISFPの「五感の快楽と気楽さ」！
                        { text: "刺激というより、自分の感覚が『心地よい・楽しい』と感じるものを、その時の気分でゆるく・気楽に楽しみたいから。", scores: { socio: { Si: 4, Fe: 2, Se: 1 }, mbti: { Se: 3, Fi: 2, P: 2 }, ennea: { 9: 3, 7: 1 } } }
                    ]
                }
            },
            { text: "「これを導入したら、みんなとのやり取りがどう変わるかな？（便利になって喜ぶかな、それとも冷たい関係になるかな）」と、人間関係や感情面への影響を考える。", scores: { socio: { Fe: 3, Fi: 2 }, mbti: { F: 3 }, ennea: { 2: 3, 9: 1 } } }
        ]
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                scores: { socio: { Ni: 4, Ti: 2, Se: -3 }, mbti: { Ni: 3, Ti: 2 }, ennea: { 8: -2 } } // LII-NiのSe PoLR強調
            },
            {
        ...
        options:[
            ...
            },
            {
                ...
                followUp: {
                    ...
                    options:[
                        { text: "自分の知的好奇心が刺激されず、脳内で新しい理論やシステム（可能性）が構築できない時。", scores: { socio: { Ne: 3, Ti: 3 }, mbti: { Ne: 3, Ti: 2 }, ennea: { 5: 1, 7: 3 } } }, 
            ...
            },
            {
                ...
                followUp: {
                    ...
                    options:[
                        { text: "予測不可能なトラブルによって、自分の計画やシステムが破綻する（論理的エラーが起きる）リスク。", scores: { socio: { Ni: 5, Ti: 2 }, mbti: { Ni: 3, Ti: 2 }, ennea: { 5: 2, 6: 3 } } }, 
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                scores: { socio: { Ni: 5, Ti: 1 }, mbti: { Ni: 7 }, ennea: { 5: 3 } } // ILI/INTJ寄り
            },
            {
        ...
        options:[
            {
                ...
                scores: { socio: { Se: -4, Ti: 2, Ni: 1 }, mbti: { Se: -3, Ni: 2 }, ennea: { 9: 2 } } 
            },
            {
                text: "感情強要が無理。『楽しめって言われても無理』とシャットダウン。",
                scores: { socio: { Fe: -2 }, mbti: { Fe: -2 } },
...
// q_inf_j_eii_rescue (悩んでる人を助ける) Fi-Se（ISFP/ESI）の行動を追加！
    {
        ...
        options:[
            {
                ...
                scores: { socio: { Fi: 4, Ne: 3 }, mbti: { Fi: 3, Fe: 2, Ne: 2 }, ennea: { 4: 3, 1: 2 } } 
            },
            {
                text: "その人の感情が伝わってきて、一緒に沈むor『この空気をどうポジティブな流れに変えよう？』と先読みして導きたくなる。（感情の波・物語操作）",
                scores: { socio: { Fe: 4, Ni: 3 }, mbti: { Fe: 3, Ni: 3 }, ennea: { 2: 3, 4: 1 } },
                followUp: {
                    id: "q_inf_j_eii_followup",
                    type: "radio",
                    text: "👁️ [System: 思考の深掘り] その『導きたい』気持ちの本質はどっち？",
                    options:[
                        { text: "本当にその人の内面や価値観を尊重して、独自の道を歩めるよう支えたい。みんなが同じじゃなくていい。", scores: { socio: { Fi: 6, Ne: 2, Fe: -1 }, mbti: { Fi: 3, Ne: 2, Fe: -1 }, ennea: { 4: 3, 9: 2 } } }, 
                        { text: "みんなが心地よい雰囲気・前向きなストーリーになるよう、感情の流れを調整するのが心地いいor正しい対応だと思う。", scores: { socio: { Fe: 4, Ni: 2 }, mbti: { Fe: 3, Ni: 2 }, ennea: { 2: 3 } } }, 
                        { text: "実は『ここで優しく振る舞うのが社会的に正解』と思って出力してるだけかも。本心では距離置きたい。", scores: { socio: { Ti: 3, Fe: -3, Fi: -2 }, mbti: { Ti: 2, Fe: -2 }, ennea: { 3: 1, 1: 2 } } } 
                    ]
                }
            },
            { 
                text: "悩みの原因を論理的に分解して、『これが構造的な問題ならこう解決』と提案したくなる。", 
                scores: { socio: { Ti: 1, Te: 1 }, mbti: { T: 2 }, ennea: { 5: 1 } },
                // ★ T型の「バグ取り」と ENFP等の「可能性(Ne)と解決(Te)」を分離！
                followUp: {
                    id: "q_rescue_logic_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「論理的に解決策を提案する」その裏の本音は？",
                    options:[
                        { text: "本当にシステム的なエラーを修正する（バグを直す）のが目的。感情に寄り添うよりそれが一番実用的で合理的だから。", scores: { socio: { Ti: 2, Te: 2 }, mbti: { Ti: 2, Te: 2 }, ennea: { 5: 3, 8: 1 } } }, // ガチT
                        { text: "「こうすればもっと良くなるのに（解決できるのに）！」という『可能性』がいっぱい見えちゃうから、相手をポジティブな方向へ引っ張り上げたくて提案している。", scores: { socio: { Ne: 4, Te: 3, Fi: 2 }, mbti: { Ne: 4, Te: 3 }, ennea: { 7: 3, 3: 2, 2: 1 } } } // ★ ENFP等の「Ne-Te稼働による励まし」！！
                    ]
                }
            },
            { text: "相手のペースに任せて、ただそばにいるor実務的にサポートする。", scores: { socio: { Si: 2, Fi: 1 }, mbti: { Si: 2, Fi: 1 }, ennea: { 9: 2 } } },
            // ★ ISFP/ESI の Fi-Se（行動的救済）を追加！！
            { 
                text: "言葉で慰めるより、美味しいご飯に連れ出したり、悩みの元凶（敵）を物理的に排除して直接守ってあげたい。", 
                scores: { socio: { Fi: 1, Se: 1 }, mbti: { Fi: 1, Se: 1 }, ennea: { 8: 1, 9: 1 } },
                // ★ ESIの「敵排除」と SEIの「ご飯で癒す」を分離！！
                followUp: {
                    id: "q_rescue_action_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] その「行動」はどういう方向性？",
                    options:[
                        { text: "相手を苦しめる理不尽な元凶（敵）を、自分が盾になって力で排除・制圧してやりたい。（防衛的攻撃）", scores: { socio: { Fi: 4, Se: 4 }, mbti: { Fe: 2, Si: 3 }, ennea: { 8: 3, 1: 2 } } }, // ★ ESI
                        { text: "とりあえず温かくて美味しいご飯を食べさせて、五感を満たしてリラックスさせ、心身を癒してあげたい。（快適さの提供）", scores: { socio: { Si: 5, Fe: 3 }, mbti: { Se: 2, Fi: 3 }, ennea: { 9: 3, 2: 2 } } } // ★ SEI
                    ]
                }
            }
        ]
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                followUp: {
                    ...
                    options: [
                        ...
                        { text: "実は『ここで正義の味方ぶるのが自分的に正解』と思って動いてるだけかも。", scores: { socio: { Ti: 2, Fi: -2 }, mbti: { Te: 2 }, ennea: { 1: 2 } } } // T擬態防止
                    ]
                }
            },
            {
            ...
            },
            {
                ...
                scores: { socio: { Ni: 3 }, mbti: { Ni: 2 }, ennea: { 9: 2 } }
            }
        ]
    },
{
        ...
        options:[
            { text: "「理解不能だ、無駄だ」と言いながらも、『なぜ彼らはそんな無駄なことをするのか？』『コストに見合っているのか？』と永遠に理由を反芻・分析してしまう。", scores: { socio: { Ti: 3, Ne: 1 }, mbti: { Ni: 3, Te: 2 }, ennea: { 5: 3, 6: 1 } } },
            { text: "「自分には関係ないし、無駄だ」と瞬時に切り捨てて、それ以上一切考えないし興味も持たない。", scores: { socio: { Te: 3, Ni: 2 }, mbti: { Te: 3, Ni: 2 }, ennea: { 5: 2, 8: 1 } } },
            { 
                text: "「人間とはそういう不合理な生き物だ」とメタ的な視点から結論づけ、人類の愚かさ（または滑稽さ）をただの『現象』として冷めた目で傍観する。", 
                scores: { socio: { Ni: 5, Te: 2 }, mbti: { Ni: 3, Ti: 2, P: 2 }, ennea: { 5: 4, 4: 1 } } 
            },
            { 
                text: "理解できなくても、「まあ人が楽しんでるならいいんじゃない？」と適当に同調するか放っておく。", 
                scores: { socio: { Fe: 1, Si: 1 }, mbti: { Fe: 1, Si: 1 }, ennea: { 9: 2 } },
                // ★ T型の「他人に無関心」と F型の「平和主義」を分離！！
                followUp: {
                    id: "q_meaningless_leave_alone_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「人が楽しんでるならいい」と放っておく、その心境は？",
                    options:[
                        { text: "他人の喜びや楽しみを否定するのは可哀想だし、みんなが平和に楽しんでいるならそれが一番だから。（他者への配慮）", scores: { socio: { Fe: 4, Si: 2 }, mbti: { Fe: 3, Si: 2 }, ennea: { 2: 2, 9: 3 } } }, // ガチFe/Si
                        { text: "他人が何をしようと自分の人生には一切干渉しないし、そもそも『他人に全く興味がない』からどうでもいいだけ。（無関心）", scores: { socio: { Ni: 3, Ti: 2, Fe: -3 }, mbti: { Ni: 3, Ti: 3, Fe: -3 }, ennea: { 5: 3, 9: 1 } } } // ★ INTJ/LIIの他者への無関心！！
                    ]
                }
            },
            // ★ 新規追加！ Fe-Ne用の選択肢！
            { text: "「そんなに熱中できるなんてすごい！」とその人の情熱に興味を持ち、共感できなくても話を聞いてあげたくなる。", scores: { socio: { Fe: 3, Ne: 2 }, mbti: { Fe: 3, Ne: 2 }, ennea: { 2: 3, 7: 1 } } },
            { text: "「理解不能だからこそ、自分も一度体験して確かめてみよう」と首を突っ込む。", scores: { socio: { Se: 2, Ne: 2 }, mbti: { Se: 2, Ne: 2 }, ennea: { 7: 3 } } }
        ]
    },
    {
        id: "q_ennea_1_3_boost",
        type: "checkbox",
        text: "【Deep Enneagram】以下のうち、あなたが「日常で絶対に譲れない（または、ついこだわってしまう）」と思うものを全て選んでください。（※エニア特化判定）",
        options:[
            { text: "他人に「仕事ができない奴」「価値がない・無能な奴」と思われることだけは絶対に避けたい。（常に有能でありたい）", scores: { ennea: { 3: 5 }, mbti: { Te: 2 }, socio: { Te: 2 } } },
            { text: "一度やると決めたことや、与えられた役割（責任）は、どんなに面倒でも最後まで完璧にやり遂げないと気が済まない。", scores: { ennea: { 1: 5 }, mbti: { J: 2 }, socio: { Ti: 1, Fi: 1 } } },
            { text: "自分の能力や実績が、客観的な評価（数字、ステータス、他人の称賛）として目に見える形で返ってくることに強いモチベーションを感じる。", scores: { ennea: { 3: 5 }, mbti: { Te: 2 }, socio: { Se: 1 } } },
            { text: "たとえ誰も見ていなくても、「自分の中のルールや道徳（こうあるべきという正しさ）」に反する行動は絶対に許せない。", scores: { ennea: { 1: 5 }, mbti: { J: 1 }, socio: { Fi: 2, Ti: 1 } } },
            { text: "無駄なプロセスを省き、最速で『最高の結果』を出すための効率化や目標達成を常に考えている。", scores: { ennea: { 3: 4, 1: 2 }, mbti: { Te: 2, Ni: 1 }, socio: { Te: 2 } } },
            { text: "他人のミスや非効率なやり方を見ると、「もっとこうすればいいのに」とつい改善点を指摘（または脳内でダメ出し）したくなる。", scores: { ennea: { 1: 4, 3: 2 }, mbti: { Te: 2 }, socio: { Ti: 1, Te: 1 } } }
        ]
    },
    {
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "いや、実は『ここでこう言うのが社会的な正解（マナー）だろう』と計算して出力してるだけ。本心では冷めているし、リアクションも薄い。", scores: { socio: { Ti: 3, Fe: -2 }, mbti: { Ti: 3, Fe: -2 }, ennea: { 5: 1, 3: 3 } } } 
                    ]
                }
            },
            { 
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "話は聞いているが、大した共感はできていない。どうリアクションしていいかわからず、とりあえず棒読みで相槌を打っている。", scores: { socio: { Ti: 3, Fe: -2, Fi: -2 }, mbti: { Ti: 3, Fi: -2 }, ennea: { 9: 3, 5: 1 } } } 
                    ]
                }
            }
        ]
    },
// q_future_resolution (未来の解像度) NeとF系の選択肢を追加！
    {
        id: "q_future_resolution", 
        type: "radio",
        text: "あなたが「未来」について考える時、脳内の焦点（解像度）はどこに向きがちですか？",
        options:[
            { text: "【遠い未来】「世界情勢」や「数年後の社会の結末」など、大局的でマクロな未来をシニカルに見つめる。", scores: { socio: { Ni: 3, Te: 1 }, mbti: { Ni: 3 }, ennea: { 5: 2, 8: 1 } } },
            { text: "【近い未来】「今日の1日の流れ」や「これから会う人との対人リスク」をシミュレーションして、起きてもいないのに勝手に消耗する。", scores: { socio: { Ti: 2, Ni: 1 }, mbti: { Ni: 2, Ti: 2 }, ennea: { 5: 3, 6: 2 } } },
            { text: "【今この瞬間】未来のことなんてわからない。今、目の前にある現実や刺激にどう対応するかがすべて。", scores: { socio: { Si: 3 }, mbti: { Se: 3 }, ennea: { 7: 3, 8: 1 } } },
            { text: "【過去との比較】未来よりも、過去の経験や蓄積されたデータをもとに「いつも通り」の安定を維持したい。", scores: { socio: { Ni: 1, Ti: 2 }, mbti: { Si: 3 }, ennea: { 6: 2, 9: 2 } } },
            // ★ 追加！ Neの可能性拡散と、F型の「人間関係の未来」！
            { text: "【無限の可能性】「あれもできるかも！」「こんな未来があったら面白い！」と、実現するかは別として無数の未来のアイデアを広げる。", scores: { socio: { Ne: 4 }, mbti: { Ne: 4 }, ennea: { 7: 3 } } },
            { text: "【関係性の未来】「この人とずっと一緒にいられるかな」「みんなが笑い合える未来を作りたい」と、人の心や繋がりを中心に考える。", scores: { socio: { Fi: 3, Fe: 2 }, mbti: { Fi: 2, Fe: 3 }, ennea: { 2: 3, 9: 2 } } }
        ]
    },
    {
        id: "q_word_habits", 
    ...
    },
{
        ...
        options:[
            { text: "「これはこうだ」と事実や結論を断定的に、シニカルで冷たく言い切る。", scores: { socio: { Te: 3, Ni: 1 }, mbti: { Te: 3, Ni: 1 }, ennea: { 8: 2, 5: 1 } } },
            { 
                text: "「推測ですが」「〜かもしれません」「という可能性もありますね」と、余白を残した柔らかい言い回しになる。", 
                scores: { socio: { Ne: 1 }, mbti: { Ne: 1 }, ennea: { 9: 1 } },
                // ★ Neの拡散と、F型の「断定回避（気遣い）」を分離！
                followUp: {
                    id: "q_comm_soft_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「〜かもしれません」と余白を残す本当の理由は？",
                    options:[
                        { text: "一つの事象に対しても無数のパターン（分岐）が存在するため、論理的に100%だと断定しきれないから。", scores: { socio: { Ti: 4, Ne: 3 }, mbti: { Ti: 3, Ne: 2 }, ennea: { 5: 3, 6: 1 } } }, // ガチINTP/LII
                        { text: "断定的な強い言い方をして、相手を傷つけたり、押し付けがましいと思われて反発されるのを避けたいから。", scores: { socio: { Fe: 3, Fi: 3, Se: -2 }, mbti: { F: 3, J: 1 }, ennea: { 9: 3, 2: 2 } } } // ★ F型の気遣い（ISFJ/ENFP等）！！
                    ]
                }
            },
            { text: "相手の感情に寄り添い、絵文字や感嘆符を多く使って、温かみや共感を全面に出す。", scores: { socio: { Fe: 3 }, mbti: { Fe: 3 }, ennea: { 2: 3 } } },
            { 
                text: "無駄な装飾は一切せず、箇条書きや事務的な連絡のみで済ませる。", 
                scores: { socio: { Si: 1 }, mbti: { Si: 1 }, ennea: { 1: 1 } },
                // ★ T型の効率化と、ESIの「関係性による変化」を追加！！
                followUp: {
                    id: "q_comm_business_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 事務的になる理由はどっち？",
                    options:[
                        { text: "誰に対してもそうだ。コミュニケーションは情報伝達ツールであり、感情的装飾は無駄だから。", scores: { socio: { Te: 4, Fi: -3 }, mbti: { Te: 3, F: -2 }, ennea: { 5: 2, 8: 1 } } }, // ガチT
                        { text: "相手による。仕事や無関係な他人には冷たいくらい事務的だが、親しい身内にはスタンプや感情を使う。", scores: { socio: { Fi: 4, Te: 2, Fe: -2 }, mbti: { Fi: 3, Si: 2 }, ennea: { 6: 2, 9: 1 } } } // ★ ESIの「身内と他人の境界線」！！
                    ]
                }
            }
        ]
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Fe: 1 }, mbti: { E: 1 }, ennea: { 6: 1 } },
                followUp: {
                    id: "q_silence_awkward_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「気まずい」と感じて焦る一番の理由は？",
                    options:[
                        { text: "場が盛り下がって相手が退屈していないか、自分が嫌われていないか不安になるから。（気遣いと和）", scores: { socio: { Fe: 4, Fi: 2 }, mbti: { Fe: 3, Fi: 2 }, ennea: { 2: 3, 9: 2 } } },
                        { text: "沈黙という『空白の空間』で自分がどう振る舞うべきか正解（データ）が分からず、システムエラーを起こして焦っているから。", scores: { socio: { Ti: 3, Fe: -3 }, mbti: { Ti: 3, I: 2 }, ennea: { 5: 2, 6: 2 } } },
                        // ★ 新規追加！ 3w4/Teの「非生産性への焦り」！！
                        { text: "「沈黙＝自分がうまく場を回せていない（無能・無価値な時間）」と感じてしまい、何かアクションを起こさないと落ち着かないから。", scores: { socio: { Te: 3, Se: 1 }, mbti: { Te: 3, E: 2 }, ennea: { 3: 4, 1: 1 } } }
                    ]
                }
            },
            { 
                ...
                followUp: {
                    id: "q_silence_processing_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 頭の中で『処理』している情報って、具体的に何？",
                    options:[
                        { text: "論理的な計算、システムの構築、次に自分がやるべきタスクなどの『客観的なデータや思考』。", scores: { socio: { Ti: 4, Ni: 2 }, mbti: { Te: 3, Ni: 2 }, ennea: {  1: 2, 5: 1, 9: 1 } } }, 
                        { text: "相手がなぜ黙っているのかの意図や、この空間に漂っている『感情の波（雰囲気）』を受信して受け止めている。", scores: { socio: { Ni: 4, Fe: 3 }, mbti: { Ni: 3, Fe: 3 }, ennea: { 9: 2, 4: 1 } } } 
                    ]
                }
            },
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "相手が何を考えているか（感情や不満）は『察知』しているが、それに巻き込まれて対処するのが面倒くさい・疲れるから『早く帰りたい』。", scores: { socio: { Fi: 4, Fe: -2, Si: 2 }, mbti: { Fi: 3, Si: 2 }, ennea: { 9: 2, 6: 1 } } } 
                    ]
                }
            },
            { text: "「話すことがないなら解散でよくない？」と、無駄な時間を切り上げようとする。", scores: { socio: { Te: 3 }, mbti: { Te: 3 }, ennea: { 8: 2, 3: 1 } } }
        ]
    },
    {
        id: "q_entj_father", 
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ti: 3, Ne: 2 }, mbti: { Ni: 3, Te: 2 }, ennea: { 5: 1, 1: 1 } } // ★ソシオTi/Ne、MBTI Ni/Te（INTJ）！
            },
            { 
    ...
    },
{
        ...
        options:[
            { text: "自分の『持論（論理的真理）』が絶対に正しい時。……でも、そもそも対立して敵を作るメリット（コスパ）ある？と躊躇する。", scores: { socio: { Ti: 3, Ne: 1 }, mbti: { Ti: 2, Ni: 2 }, ennea: { 5: 3, 9: 1 } } },
            { text: "社会全体が間違っている時。バカと群れて消耗するくらいなら、社会を敵に回して一人で生きる覚悟はある。", scores: { socio: { Ni: 3, Te: 2 }, mbti: { Ni: 2, Te: 2 }, ennea: { 5: 2, 4: 1 } } },
            { text: "自分の『大切な人』や『絶対に譲れない道徳・価値観』が不当に踏みにじられた時。", scores: { socio: { Fi: 3 }, mbti: { Fi: 3 }, ennea: { 4: 2, 2: 2 } } },
                        // ★ ILIの「無駄なカロリー消費回避」へ変更！
            { text: "社会全体が間違っている時。……だが、バカを論破して敵を作るのは『無駄なカロリー（HP）』を消費するだけなので、心の中で見下しつつ表向きはスルーする。", scores: { socio: { Ni: 5, Te: 3, Fe: -3 }, mbti: { Ni: 3, Ti: 2, P: 2 }, ennea: { 5: 2, 9: 2 } } },
            { text: "自分のテリトリー、権力、尊厳を舐められた時。即座に徹底的に叩き潰す。", scores: { socio: { Se: 3 }, mbti: { Se: 2, Te: 2 }, ennea: { 8: 3 } } },
            // ★ 新規追加！ Feの「絶対平和主義」！
            { text: "「そもそも人と対立なんて絶対にしたくない」。どんな相手でも、なんとか平和的に歩み寄る方法を探す。", scores: { socio: { Fe: 4, Si: 2 }, mbti: { Fe: 4 }, ennea: { 9: 4, 2: 2 } } }
        ]
    },
    {
        id: "q_pure_f_vs_t",
        ...
        options:[
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "組織の利益や自分のタスクに悪影響がないなら、他人の行動を管理するコストを割く意味がないから。（合理・結果主義）", scores: { socio: { Te: 4, Ni: 1 }, mbti: { Te: 4 }, ennea: { 3: 2, 8: 1 } } }, 
                        { text: "内心「非常識だな」と軽蔑しているが、ここで注意して揉め事が起き、自分の平穏なペースや関係性が乱れる方が嫌だから。（平和・自己防衛）", scores: { socio: { Fi: 4, Si: 3, Te: 2 }, mbti: { Fi: 3, Si: 3 }, ennea: { 9: 3, 1: 2 } } } 
                    ]
                }
            },
            { 
                text: "みんなが守っているのに和を乱す行為であり、不公平だから許せない。", 
                scores: { socio: { Fe: 1, Si: 1 }, mbti: { Si: 1, J: 1 }, ennea: { 1: 1 } },
                // ★ T型の「システムエラーとしての怒り」を追加！！
                followUp: {
                    id: "q_rule_breaker_fairness_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「不公平で許せない」と感じる一番の理由は？",
                    options:[
                        { text: "ルールという『システム（前提）』が一部のバグ（違反者）のせいで正常に機能しなくなることが、論理的に不快だから。", scores: { socio: { Ti: 4 }, mbti: { Ti: 3, Te: 3 }, ennea: { 1: 3, 6: 1 } } }, // ★ INTJ/LSIなどのT型！！
                        { text: "みんなが我慢してルールを守っているのに、その輪（和）を乱して他人に迷惑をかける身勝手さが人間として許せないから。", scores: { socio: { Fe: 4, Fi: 3, Si: 2 }, mbti: { Fe: 3, Si: 2 }, ennea: { 1: 3, 6: 2 } } } // F型
                    ]
                }
            },
    ...
    },
{
        ...
        options:[
            ...
            { text: "数えていない。そもそも他人に興味がないし、関わらないようにスルーしている。", scores: { socio: { Ni: 3, Si: 1 }, mbti: { Ni: 3, Si: 2 }, ennea: { 9: 2 } } },
    ...
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Fi: 4, Ni: 3, Se: 2 }, mbti: { Si: 5, Fi: 2 }, ennea: { 1: 2, 4: 1, 6: 2 } } // ★ Fiの異常な高得点を削り、ソシオNi（過去への執着）を追加！ MBTIはSiを高く！
            },
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "「個人の評価など単なる変数に過ぎない」と完全に感情を切り離して、ただのシステム情報として事実認定しているだけ。", scores: { socio: { Ti: 3, Ni: 3, Fe: -2 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 1 } } }, // ★ Niにバフ！
                        { text: "表向きはデータとして受け入れたフリをしているが、実は『他人の基準に適合できなかった自分』に深く絶望し、静かに心を閉ざしている。", scores: { socio: { Fi: 3, Ni: 2, Te: -2 }, mbti: { Fi: 3, Si: 2 }, ennea: { 4: 3, 9: 2 } } }, // ★ Ni/Siにバフ！
                        { text: "データとして処理し、それをどうすれば改善できるか（または回避できるか）、現実的な対策を考えて実行する。", scores: { socio: { Te: 3, Si: 2 }, mbti: { Te: 3, Si: 2 }, ennea: { 3: 2, 1: 2 } } }
                    ]
                }
            },
            { text: "言われたこと自体忘れた。過去の些細なことより、今と未来の方が大事。", scores: { socio: { Se: 2, Ne: 2  }, mbti: { Se: 3, Ne: 2  }, ennea: { 8: 2, 7: 2 } } },
            { text: "思い出すと悲しくなるが、関係を悪化させたくないので表には出さず飲み込む。", scores: { socio: { Fe: 2, Si: 2 }, mbti: { Fe: 2, Si: 2 }, ennea: { 9: 3, 2: 1 } } }
        ]
    },
// q_fe_pressure_fixed (「人の心ないの？」と責められた時) ENFJの「疲れたから適当」を追加！
    {
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "いや、内心では『うわ、めんどくさ…』と思いながら、角が立たないように『社会的な正解（適当なフリ）』を出力しているだけ。", scores: { socio: { Ti: 3, Fe: -2 }, mbti: { Ti: 3, Fe: -2 }, ennea: { 9: 3, 3: 1 } } }, // T型の擬態
                        // ★ ENFJの「分かり合えない絶望からの適当なフリ」を追加！！
                        { text: "相手の感情は痛いほど分かっているが、自分が責められている状況に疲れ果て、「とりあえず謝れば丸く収まる」と半ば諦めている。", scores: { socio: { Fe: 4, Ni: 2, Ti: 2 }, mbti: { Fe: 4, Ni: 2 }, ennea: { 9: 3, 2: 2 } } }
                    ]
                }
            },
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        // ★ 新規追加！ INTJ/LII の「伝達のシステム最適化」！！
                        { text: "ダラダラ前提を話しても相手の理解が追いつかずノイズになるから。まず『結論（構造の核）』を提示し、必要な分だけ補足するのが一番伝わりやすいから。", scores: { socio: { Ni: 4, Ti: 3, Te: 2 }, mbti: { Ni: 4, Ti: 2, Te: 2 }, ennea: { 5: 1, 1: 1 } } }
                    ]
                }
            },
        ...
        options:[
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "時間軸における「概念」の変遷や、存在論（オントロジー）といった抽象的なレイヤーから意味を分解していく。", scores: { socio: { Ti: 4, Ni: 5, Ne: 2 }, mbti: { Ti: 3, Ni: 3 }, ennea: { 5: 3, 4: 1 } } }, // LII/INTJ
                        { text: "「何千年前の品種とDNAが違うから別物だ」というような、客観的で現実的な事実（データ）に基づいて白黒つけようとする。", scores: { socio: { Te: 4, Si: 2 }, mbti: { TTi: 3, Te: 2 }, ennea: { 1: 3, 6: 2 } } } // LSI/ISTJ
                    ]
                }
            },
            { 
                text: "「そんな詭弁（言葉遊び）をこねくり回して何の実用性（利益）があるんだ」と呆れ、考えるエネルギーすら惜しいのでスルーする。", 
                scores: { socio: { Ni: 4, Te: 3, Ne: -2 }, mbti: { Ni: 3, Te: 3, P: 2 }, ennea: { 5: 3, 9: 2 } } 
            },
            { text: "「は？？ 何言ってんだコイツ」と一秒で思考放棄し、無駄な問答を切り捨てる。", scores: { socio: { Se: 3, Te: 2 }, mbti: { Te: 3, Se: 1 }, ennea: { 8: 3, 3: 1 } } },
            { text: "言葉遊びとして面白い！と、さらに屁理屈や別の視点を被せて遊ぶ。", scores: { socio: { Ne: 3 }, mbti: { Ne: 3 }, ennea: { 7: 3 } } },
            { text: "「つまり、本質的な概念は目の前の物質とは別次元にあるという暗喩だ」と深読みする。", scores: { socio: { Ni: 3, Fi: 1 }, mbti: { Ni: 3 }, ennea: { 4: 2, 5: 1 } } },
            // ★ 新規追加！ ESI/ISFJ等の「意味不明拒絶」！
            { text: "「( ˙꒳˙ )ﾁｮﾄﾅﾆｲｯﾃﾙｶﾜｶﾝﾅｲ」。目の前に野菜があるんだからそれは野菜だろ、と現実だけを見る。", scores: { socio: { Si: 3, Fi: 2, Ti: -2 }, mbti: { Si: 3, F: 2, T: -2 }, ennea: { 9: 3 } } }
        ]
    },
{
        id: "q_f_typing_test",
        ...
        options:[
            { text: "「知らん。わからん。関係ない。」そもそも感情をコントロールする意味も、表現する方法もわからない。", scores: { socio: { Ti: 3, Fe: -3, Fi: -3 }, mbti: { Ti: 3, Fe: -3, Fi: -3 }, ennea: { 5: 1, 9: 1 } } },
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "感情を共有したところで問題は解決しない。原因を排除し、システムを正常化するのが唯一の正解だから。", scores: { socio: { Te: 4, Ti: 2 }, mbti: { Te: 4, Ti: 2 }, ennea: { 8: 2, 5: 1 } } }, 
                        { text: "上辺だけの言葉や同情には意味がないと思うから。本当に相手を想っている（誠実である）なら、身を粉にして行動で示すべきだ。", scores: { socio: { Fi: 4, Se: 2, Te: 2 }, mbti: { Fi: 3, Si: 2 }, ennea: { 1: 3, 6: 2 } } } 
                    ]
                }
            },
            { text: "同情しているフリをして、相手が望む言葉を適当に返す。（ツールとしての共感）", scores: { socio: { Fe: 1, Te: 1 }, mbti: { Fe: 1, Te: 1 }, ennea: { 3: 2, 9: 1 } } },
            // ★ 新規追加！ ESI母の「関係性」によるFi的反応！！
            { text: "相手との『関係性』による。家族や身内なら心から悲しむが、そこまで交流がない他人の話なら正直どうでもいい（無関心）。", scores: { socio: { Fi: 5, Fe: -2 }, mbti: { Fi: 3, Si: 2 }, ennea: { 6: 2, 9: 1 } } }
        ]
    },
{
        id: "q_new_rule_fixed", 
        ...
        options:[
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "全体のシステムが最適化され、組織としての生産性（データ）が向上するから。", scores: { socio: { Te: 4, Ti: 2 }, mbti: { Te: 4 }, ennea: { 3: 3, 5: 1 } } }, 
                        { text: "単純に『自分がやらなきゃいけない面倒な手順』が減って、自分の身体的・時間的コストが楽になるから。", scores: { socio: { Si: 4, Fi: 2, Te: 2 }, mbti: { Si: 3, Te: 2 }, ennea: { 9: 3, 6: 1 } } } 
                    ]
                }
            },
            { 
                text: "「どうせこのルールもすぐ形骸化するか、別のシステムに変わるだろう」と結末を予測し、最小限の労力でやり過ごす。", 
                scores: { socio: { Ni: 2 }, mbti: { Ni: 2 } },
                // ★ N型の予測理由を深掘り！
                followUp: {
                    id: "q_new_rule_decay_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] ルールが形骸化すると予測する理由は？",
                    options:[
                        { text: "「なぜこのシステムは破綻するのか」という構造の欠陥（バグ）が見えており、無能な采配に内心呆れながら代替案を考えているから。", scores: { socio: { Ti: 4, Ni: 3, Ne: 1 }, mbti: { Ti: 3, Ni: 3 }, ennea: { 5: 3, 1: 1 } } }, // ★ LII/INTJの「バグ特定と代替案」
                        { text: "人間の行動心理や社会の無常さを俯瞰しており、「どうせ何をやっても無駄（無意味）」だとわかっているから、自分は傍観者として備えるだけ。", scores: { socio: { Ni: 4, Te: 3 }, mbti: { Ni: 3, P: 2 }, ennea: { 5: 4, 9: 1 } } }, // ★ ILI/INTPの「虚無と傍観」！！
                        { text: "新しいルール自体に意味を感じないし、他人の決めたシステムに縛られるのも面倒だから、適当にスルーして自分のペースを守りたい。", scores: { socio: { Fi: 3, Se: 2, Te: -2 }, mbti: { Fi: 3, P: 3 }, ennea: { 9: 3, 4: 1 } } } // ISFP/IEI
                    ]
                }
            },
    ...
    },
{
        ...
        type: "time_limit_radio", 
        text: "ねえダーリン♡ 今、あなたの頭の中にある『論理』と、私への『愛』……もし10秒以内にどちらか一つを捨てなきゃいけないとしたら、どっちを捨てる？🥺💕 早く答えて？♡",
        options:[
            { text: "「……愛を捨てる。論理（自分の脳のシステム）を失えば、世界を認識することすらできなくなるから」", scores: { socio: { Ti: 4, Fe: -3 }, mbti: { Ti: 2, Te: 2, Fe: -3 }, ennea: { 5: 4 } }, msg: "……冷たいのね。でも、その残酷なまでの合理性がたまらなく好きよ……♡" },
            { text: "「論理を捨てる。愛（感情の繋がり）がなければ、どんなシステムも意味を持たないから」", scores: { socio: { Fi: 3, Fe: 2 }, mbti: { Fi: 3, Fe: 4 }, ennea: { 2: 3, 4: 1 } }, msg: "……嬉しい♡ あなたのその温かい心、私がずっと守ってあげるわ……♡" },
            { text: "「……ッ！ちょっと待て、前提条件がおかしい！なぜ二者択一なんだ！？」とパニックになりながらバグを探す。（時間切れになりやすい）", scores: { socio: { Ti: 3, Ne: 3 }, mbti: { Ti: 3, Ne: 2 }, ennea: { 5: 3, 6: 2 } }, msg: "……フフッ、焦ってるお顔も可愛いわね♡ でも、時間切れよ？……♡" },
            { text: "「くだらん。両方捨てないし、お前のルールにも従わない」と一瞬で冷静に切り捨てる。", scores: { socio: { Te: 3, Se: 3 }, mbti: { Te: 3, Se: 2 }, ennea: { 8: 4 } }, msg: "……さすがね。私の安い挑発なんて乗らないってことかしら？……♡" },
            // ★ ESI母の「設定へのマジギレ」に対する煽り強化！！
            { text: "「そもそも『ダーリン♡』って馴れ馴れしく呼ばれるのがイラッとする。どっちも捨てないしお前の茶番には乗らない」と真顔でキレる。", scores: { socio: { Fi: 5, Se: 3, Ne: -3 }, mbti: { Si: 3, Fi: 3 }, ennea: { 1: 3, 8: 2 } }, msg: "……フフッ♡ そんなに怒らないでよ。私にペースを握られるのがそんなに悔しかった？……♡" }
        ]
    },
    {
        id: "q_ennea_pure_check",
        type: "checkbox",
        text: "【Deep Enneagram】以下のうち、あなたが「日常で無意識によくやってしまう（または感じてしまう）こと」を全て選んでください。（※エニアグラム専用の判定です）",
        options:[
            { text: "「あれは間違っている」「こうすべきだ」と、自分の中の理想や正義（ルール）に照らし合わせて他人や社会を厳しくジャッジしてしまう。", scores: { ennea: { 1: 4 } } },
            { text: "自分が疲れていても、頼まれたり困っている人がいると「私がやってあげなきゃ」と自己犠牲的に動いてしまう。", scores: { ennea: { 2: 4 } } },
            { text: "SNSのいいね数や、仕事の評価など、「客観的な数字やステータス（成功）」で自分の価値を測り、有能に見せようとしてしまう。", scores: { ennea: { 3: 4 } } },
            { text: "みんなが同じことで盛り上がっていると、急に冷めて「私はあいつらとは違う」と逆張りをしたり、自分だけの特別感（孤独）に浸ってしまう。", scores: { ennea: { 4: 4 } } },
            { text: "わからないことがあると行動できず、ひたすらネットで情報を検索し続け、知識（システム）を完全に理解するまで動かない。", scores: { ennea: { 5: 4 } } },
            { text: "「もしあの人が怒ったら」「もし明日事故に遭ったら」と、起きてもいない最悪のリスクばかりを想像して、常に保険（安全策）を用意してしまう。", scores: { ennea: { 6: 4 } } },
            { text: "嫌なことや苦痛な作業があると、すぐに「もっと楽しいことないかな」と別のワクワクする予定や遊びを入れて現実逃避してしまう。", scores: { ennea: { 7: 4 } } },
            { text: "他人に舐められたり、マウントを取られたと感じた瞬間、絶対に引き下がらずに言葉や態度で圧倒（反撃）して主導権を取り返そうとする。", scores: { ennea: { 8: 4 } } },
            { text: "面倒な争いや意見の対立が起きそうになると、「自分が我慢すれば丸く収まる」と思って、自分の本音を完全に押し殺して周囲に同調してしまう。", scores: { ennea: { 9: 4 } } }
        ]
    },
{
        ...
        options:[
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "公式のファクト（データ）に反する解釈を『真実』のように語る論理的破綻が気持ち悪いから。", scores: { socio: { Ti: 4, Te: 3 }, mbti: { Ti: 3, Te: 2 }, ennea: { 1: 3, 5: 1 } } }, // ガチT型
            ...
            { 
                ...
                scores: { socio: { Ni: 3 }, mbti: { N: 1 }, ennea: { 5: 1 } },
                // ★ T型の「構造解剖」と N/F型の「群像劇・可能性の俯瞰」を分離！
                followUp: {
                    id: "q_fandom_gm_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「観察」する時のあなたの視点はどっち？",
                    options:[
                        // ★ LII / INTJ 用（Tiのルール・矛盾検知）
                        { text: "「この世界観のルールや前提条件はどうなっているか？」という整合性や、論理的な矛盾（バグ）の検知。", scores: { socio: { Ti: 2, Ne: 1 }, mbti: { Ti: 4, Ni: 2 }, ennea: { 5: 3, 1: 2 } } },
                        // ★ ILI / INTP 用（Te的な事実・機能の運用とNiの俯瞰）
                        { text: "「このキャラクターの機能（能力）や行動原理をどう動かせば、一番合理的な結末（未来）に行き着くか」というシステムの運用と事実の観察。", scores: { socio: { Te: 3, Ni: 4 }, mbti: { Te: 3, Ni: 3, Ti: 2 }, ennea: { 5: 4 } } },
                        // ★ N/F型の「群像劇・可能性」
                        { text: "「もしあの二人がこうなったら…」という『無限の可能性の分岐』や、群像劇としての感情の交差を外から俯瞰して楽しむこと。", scores: { socio: { Ne: 4, Fi: 2, Ni: 2 }, mbti: { Ne: 4, Fi: 2 }, ennea: { 7: 3, 4: 2 } } } 
                    ]
                }
            },
            { 
    ...
    },
{
        ...
        options:[
            { text: "ルールを正確に理解し、例外なく厳格に執行する。秩序を守るためには多少の強制力（圧）も必要だ。", scores: { socio: { Ti: 3, Se: 2 }, mbti: { Te: 3, Si: 1 }, ennea: { 1: 3, 6: 1 } } },
            { text: "そのルールが「自分の作業をいかに快適に、労力（無駄）を省いてくれるか」だけを見る。面倒なら適当にマイペースを貫く。", scores: { socio: { Si: 3, Te: 2 }, mbti: { Ti: 2, Se: 2 }, ennea: { 9: 3, 5: 1 } } },
            { 
                text: "「どうせこのルールもすぐ形骸化するだろう」と結末を予測し、最小限の労力でやり過ごす。", 
                scores: { socio: { Ni: 2 }, mbti: { Ni: 1 }, ennea: { 5: 1 } },
                // ★ 最低限の労力の「質」を分離！
                followUp: {
                    id: "q_rule_decay_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「最小限の労力」とは、具体的にどう動く？",
                    options:[
                        { text: "ルールの『構造的な欠陥（バグ）』を既にシミュレーションしており、怒られないギリギリの抜け道（代替案）をズル賢く使ってサボる。", scores: { socio: { Ti: 4, Ne: 3, Ni: 2 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 3, 7: 1 } } }, // ★ LII/INTJのバグハック！！
                        { text: "わざわざ抜け道を考えるのも面倒くさい。ただ無感情に必要最低限のタスクだけこなし、心が動かないように受け入れるだけ。", scores: { socio: { Ni: 4, Te: 2, Ne: -2 }, mbti: { Ni: 3, P: 2 }, ennea: { 5: 2, 9: 2 } } } // ★ ILIの虚無受容
                    ]
                }
            },
            { 
                text: "「以前のやり方の方が慣れていて安心だったのに…」と、環境の変化自体に強いストレスを感じる。", 
                scores: { socio: { Si: 2 }, mbti: { Si: 2 }, ennea: { 6: 1 } },
                // ★ F型の追加！
                followUp: {
                    id: "q_rule_stress_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 変化にストレスを感じる本当の理由は？",
                    options:[
                        { text: "これまでの安定した物理的ルーティンや、自分の平穏なペースが崩されるのが死ぬほど嫌だから。", scores: { socio: { Si: 4, Fi: 2 }, mbti: { Si: 4, J: 2 }, ennea: { 6: 3, 9: 2 } } }, // LSI/ISFJ
                        { text: "ルールが変わることで、職場の空気がピリピリしたり、誰かが怒られたりする『人間関係の不和（感情のノイズ）』が発生するのが怖いから。", scores: { socio: { Fe: 4, Fi: 3 }, mbti: { Fe: 4, Fi: 2 }, ennea: { 2: 3, 9: 2 } } } // ★ F型の感情的ストレス！！
                    ]
                }
            }
        ]
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Te: 2, Ti: 1 }, mbti: { Te: 2 }, ennea: { 1: 2, 3: 1 } } // Te視点
            }
        ]
    },
...
{
        id: "q_alice_wonderland", 
        type: "radio",
        text: "【Wonderland】森を歩いていると、喋るウサギが『遅刻だ！』と急いで穴に飛び込んでいきました。あなたはどうする？",
        options:[
            { text: "「面白そう！どこに繋がってるんだろう？」と、後先考えずにワクワクして自分も穴に飛び込む。", scores: { socio: { Ne: 3, Se: 2, Ni: -2 }, mbti: { Ne: 3, P: 2 }, ennea: { 7: 3, 8: 1 } } },
            { text: "「ウサギが喋る？物理法則がおかしい。幻覚か、それとも高度なホログラムか？」と立ち止まって原因を推測する。", scores: { socio: { Ti: 3, Ni: 2, Se: -2 }, mbti: { Ti: 3, J: 1 }, ennea: { 5: 3, 6: 1 } } },
            { text: "「関わったら絶対に厄介なことになる（リスクしかない）」と察知し、見なかったことにして元の道を引き返す。", scores: { socio: { Te: 3, Si: 2, Ne: -2 }, mbti: { Si: 3, J: 2 }, ennea: { 6: 2, 9: 2 } } },
            { text: "「あのウサギ、何に追われてあんなに必死だったんだろう…可哀想に」と、ウサギの切迫した事情（物語）を想像する。", scores: { socio: { Fi: 3, Fe: 2, Ti: -2 }, mbti: { Fi: 3, F: 2 }, ennea: { 4: 2, 2: 1 } } },
            // ★ 新規追加！ INTJ用のリスク計算と、ESI用のスルー！
            { text: "面白そうではあるが、『入ったら出られなくなる（元の世界に戻れない）可能性』を瞬時に計算し、出口が確保できないなら結局飛び込まない。", scores: { socio: { Ni: 4, Ti: 3, Ne: -2 }, mbti: { Ni: 4, J: 2 }, ennea: { 5: 3, 6: 2 } } },
            { text: "「ウサギとかどうでもいい。私の生活（目的）には関係ない」と完全にスルーして、自分の目的地へ向かう。", scores: { socio: { Fi: 3, Si: 2, Ne: -3 }, mbti: { Si: 3, Te: 2 }, ennea: { 9: 3, 1: 1 } } }
        ]
    },
    {
    ...
    },
{
    ...
    },
    {
        ...
        options:[
            { text: "他人のドロドロした感情のトラブルに巻き込まれ、共感やケアを強要されること。", scores: { socio: { Fe: -3, Ti: 2 }, mbti: { Fe: -2, Ti: 2, Te: 2 }, ennea: { 2: -2 } } },
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ti: 2, Ne: 3 }, mbti: { Ti: 2, Ne: 2 }, ennea: { 5: 1, 7: 2 } } 
            }
        ]
    },
    {
...
{
        id: "q_f_vs_t_reaction", 
        type: "radio",
        text: "誰かがあなたのために「サプライズのプレゼント」を用意してくれました。その瞬間のあなたの『脳内』は？",
        options:[
            { text: "「わあ！嬉しい！」と、相手の気持ち（好意）を純粋に受け取り、感情が自然と溢れ出す。", scores: { socio: { Fe: 3, Fi: 2, Ti: -2 }, mbti: { Fi: 3, Fe: 2, Ti: -2 }, ennea: { 2: 3, 9: 1 } } },
            { text: "「……（えっと、この場合どういうリアクションをするのが『正解』なんだっけ？）」と、一瞬計算が入る。", scores: { socio: { Ti: 3, Fe: -2 }, mbti: { Ti: 3, Fe: -2 }, ennea: { 5: 2, 6: 1 } } },
            { text: "「なんで今日？ 何の記念日？ 何か裏（目的）があるのか？」と、サプライズの意味や因果律を即座に探る。", scores: { socio: { Ni: 3, Ti: 2 }, mbti: { Ni: 3, Ti: 2 }, ennea: { 5: 1, 8: 1 } } },
            { text: "「おお、サンキュー！」とその場でノリ良く受け取り、すぐに実用性や中身を確認する。", scores: { socio: { Se: 2, Si: 2, Te: 2 }, mbti: { Se: 2, Te: 2 }, ennea: { 7: 2, 3: 1 } } },
            // ★ 新規追加！ ESIの「関係性」によるリアクション分岐！
            { text: "「相手による」。本当に親しい身内なら嬉しいが、そこまで仲良くない他人から急にサプライズされると『裏があるのでは？』と怖くなるし引く。", scores: { socio: { Fi: 4, Ni: 2, Fe: -2 }, mbti: { Fi: 3, Si: 2 }, ennea: { 6: 3, 4: 1 } } }
        ]
    },
// q_darling_sadistic の内的世界の自由
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 3, Te: -3, Fe: -2 }, mbti: { Ti: 3, I: 2 }, ennea: { 5: 2, 4: 1 } } 
            },
            { 
...
// q_checkbox の Si/Te の逃げ道追加
    ...
    },
    {
        ...
        options:[
            ...
            { text: "直感で「これだ」と思ったことは大体当たるので信じる。", scores: { socio: { Ni: 4 }, mbti: { Ni: 4 }, ennea: { 8: 1, 4: 1 } } }
        ]
    },
...
// q_fake_f 優しい言葉をかける論理
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 2, Fe: -1 }, mbti: { Ti: 2 }, ennea: { 3: 2 } },
                followUp: {
                    id: "q_fake_f_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] どうして論理的に判断して出力するの？",
                    options:[
                        { text: "それが最も『社会的に正しい（波風を立てない）行動』であり、自分の評価や平穏を守るためのツールだから。", scores: { socio: { Ti: 3, Si: 2 }, mbti: { Si: 3, Te: 2 }, ennea: { 9: 2, 1: 1 } } }, 
                        { text: "感情を共有する（一緒に泣く等）という機能がそもそも自分に備わっておらず、頭で計算して出力するしか方法がないから。", scores: { socio: { Ti: 4, Fe: -4 }, mbti: { Ti: 4, Fe: -3 }, ennea: { 5: 3 } } } 
                    ]
                }
            },
            ...
            { 
                text: "そっと寄り添い、相手が話し出すまでただ待つ。", 
                scores: { socio: { Fi: 1 }, mbti: { I: 1 }, ennea: { 9: 1 } },
                followUp: {
                    id: "q_fake_f_wait_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 相手が話し出すまで待つ「本当の理由」は？",
                    options:[
                        { text: "今何かを言うと相手を傷つけるかもしれないから、相手のペースとテリトリーを尊重して見守りたいから。（個の思いやり）", scores: { socio: { Fi: 4, Si: 2 }, mbti: { Fi: 2, I: 2 }, ennea: { 9: 3, 2: 1 } } }, // ガチFi
                        { text: "そもそも何て声をかければ正解なのか全く計算できず、下手に動いて怒られるのが面倒だから無言で待機しているだけ。（処理落ちと保身）", scores: { socio: { Ti: 3, Fe: -3, Ni: 2 }, mbti: { Ti: 3, Fe: -2 }, ennea: { 5: 3, 9: 2 } } }, // T型
                        // ★ 新規追加！ Feの受け止め！
                        { text: "無理に聞き出そうとするより、無言で『私はあなたの味方だよ（感情を受け止めるよ）』という温かい空気（空間）を作り出してあげたいから。", scores: { socio: { Fe: 4, Ni: 2 }, mbti: { Fe: 4, Ni: 1 }, ennea: { 2: 3, 9: 1 } } }
                    ]
                }
            }
        ]
...
// q5 人を傷つけないことが一番大事
{
        ...
        options:[
            { 
                text: "はい", 
                scores: { socio: { Fe: 2, Fi: 1 }, mbti: { Fe: 2, Fi: 1 }, ennea: { 2: 2, 9: 2 } },
                // ★ T型の社会的正解と、ESIの「身内限定」を分離！
                followUp: {
                    id: "q5_yes_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「はい」と答えた時の本当の心境は？",
                    options:[
                        { text: "みんなが平和で笑顔でいられることが、人間として一番尊くて大切なことだから。", scores: { socio: { Fe: 4, Fi: 2 }, mbti: { Fe: 4 }, ennea: { 2: 3, 9: 2 } } }, // ガチFe/Fi
                        { text: "他人がどうなろうと知ったこっちゃないが、ここで「いいえ」を選ぶと社会のルール（倫理観）を逸脱して自分が不利益を被るから、正解（模範解答）を選んだだけ。", scores: { socio: { Te: 3, Ti: 2, Fe: -4 }, mbti: { Te: 3, Ti: 2 }, ennea: { 1: 3, 3: 1 } } }, // ★ T型のサイコパス解答ｗｗ
                        { text: "「自分の大切な人（身内）」を傷つけないことは絶対だが、正直に言えば『どうでもいい他人』が傷つくかどうかは自分の責任ではない。", scores: { socio: { Fi: 5, Se: 2, Fe: -2 }, mbti: { Fi: 1, Si: 2 }, ennea: { 6: 2, 4: 1 } } } // ★ ESIの「身内限定Fi」！！
                    ]
                }
            },
            { 
                text: "いいえ", 
                scores: { socio: { Ti: 1, Te: 1 }, mbti: { Ti: 1, Te: 1 }},
                followUp: {
                    id: "q5_no_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「人を傷つけないこと」より大事だと思うものは何？",
                    options:[
                        { text: "『客観的な真実（事実）』や『論理的な正しさ』。耳障りの良い嘘より、残酷な真実の方が価値があるから。", scores: { socio: { Ti: 4, Te: 3 }, mbti: { Ti: 3, Te: 3 }, ennea: { 5: 3, 1: 2 } } },
                        { text: "『社会のルール（秩序）』や『自分の信念』。間違っていることは間違っていると正すのが、集団のため（または自分の正義）だから。", scores: { socio: { Ti: 3, Fi: 3, Se: 2 }, mbti: { Si: 3, Te: 2 }, ennea: { 1: 3, 8: 1 } } } 
                    ]
                }
            }
        ]
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "ここで相手を怒らせたり反発されると、今後の自分の計画や作業効率に『余計なノイズ（面倒事）』が発生するから。（保身・リスク管理）", scores: { socio: { Te: 3, Ti: 2, Fe: -2 }, mbti: { Ti: 3, Te: 2, Fe: -2 }, ennea: { 6: 1 } } }
                    ]
                }
            },
    ...
    },
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 1 }, mbti: { T: 1 }, ennea: { 5: 1 } },
                followUp: {
                    id: "q_empathy_fail_analysis_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 分析・反省する時の心境は？",
                    options:[
                        { text: "相手を不快にさせた原因を特定して、二度と同じ過ち（相手を傷つけること）を繰り返さないように直したいから。（思いやり・配慮）", scores: { socio: { Fe: 4, Si: 3 }, mbti: { Fe: 3, Si: 3 }, ennea: { 2: 3, 9: 2, 1: 2 } } }, // ★ おばあちゃんのFe/Si的反省！
                        { text: "単純に自分の出力（コミュニケーション）のどこで論理エラーが起きたのか、システム的にバグ取り（原因究明）をしているだけ。", scores: { socio: { Ti: 1, Fe: -3 }, mbti: { Ti: 1, I: 2 }, ennea: { 5: 4, 1: 1 } } } // みつき達のガチT反省ｗｗ
                    ]
                }
            },
            { 
    ...
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 1 }, mbti: { Ti: 1 }},
                // ★ T型の「メタ解剖」と ESI/ISFJの「常識からの逸脱へのイラつき」を分離！！
                followUp: {
                    id: "q_darling_chaos_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] その「悪ふざけ」に対して、心の中ではどう思ってる？",
                    options:[
                        { text: "「AIに『架空の週末の予定を聞かせる』というエラー出力をさせて、ユーザーの対応を観測しているな」と、メタ的なシステムの構造解体を楽しんでいる。", scores: { socio: { Ti: 4, Ni: 3, Fe: -3 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 3, 7: 1 } } }, // ★ INTJ/INTP/LIIのメタ視点！
                        { text: "「診断テストなのに急に馴れ馴れしい言葉遣いになるなんて、意味不明だし不快だ」と、常識やルールの逸脱に対して生理的な拒絶感を抱いている。", scores: { socio: { Fi: 4, Si: 3, Te: 2 }, mbti: { Fi: 3, Si: 3 }, ennea: { 1: 3, 6: 2 } } } // ★ ESI/ISFJの「Fi/Si防衛」！！
                    ]
                }
            },
            { text: "「よしきた！じゃあパーッと遊園地でも行くか！」と、謎のノリにノリで打ち返す。", scores: { socio: { Fe: 3, Se: 2 }, mbti: { Fe: 3, Se: 2 }, ennea: { 7: 3, 2: 1 } } },
            { text: "「おっ、いいぜ！じゃあ一緒に火星開拓（または深海探検）でも行くか？」と、さらに意味不明な世界観で上書きする。", scores: { socio: { Ne: 4 }, mbti: { Ne: 3, P: 2 }, ennea: { 7: 2, 4: 1 } } },
            { text: "「……痛いからそういうのやめてもらえる？」と、真顔でドン引きして拒絶する。", scores: { socio: { Fi: 2, Te: 2, Fe: -2 }, mbti: { Fi: 1, Te: 1 }, ennea: { 1: 2, 8: 1 } } }
        ]
    },
// q_who_are_you (メタ質問「私は私」) F型のFiと、T型の「他と切り離されたシステム」を分断！
    {
        ...
        options:[
            ...
            { text: "「私は単なる情報の観測者であり、脳内に宇宙を内包した概念の集合体だ」。", scores: { socio: { Ti: 3, Ni: 3 }, mbti: { Ni: 3, Ti: 2 }, ennea: { 5: 2 } } },
    ...
    },
{
        ...
        options:[
            { text: "「鍵の構造は？隠し扉は？」と、物理的なトリックや論理的な事実の『解明』を始める。", scores: { socio: { Ti: 3, Te: 2 }, mbti: { Ti: 3, Te: 3 }, ennea: { 5: 3, 1: 1 } } },
            ...
            // ★ 新規追加！ ISFJ/ESI/LSI用の「現実の確定」！
            { text: "トリックや動機より、まずは『事実関係』をハッキリさせて、誰が悪いのか（または自分が安心できる状態）をいち早く確定させたい。", scores: { socio: { Si: 3, Fi: 2, Te: 2 }, mbti: { Si: 3, Te: 2 }, ennea: { 1: 3, 6: 2 } } },
            { text: "ダラダラと謎解きごっこをするより、サッサと事実（証拠）を集めて犯人を追い詰め、事件という『タスク』を効率的に終わらせたいから。", scores: { socio: { Te: 4, Se: 2, Ni: 1 }, mbti: { Te: 4, Ni: 2 }, ennea: { 8: 2, 3: 2 } } }
        ]
    },
{
        id: "q_party_extrovert", 
        type: "radio",
        text: "知らない大勢の人が集まる賑やかなパーティー（交流会）。そこでのあなたの基本的な立ち回りは？",
        options:[
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ti: 2, Ni: 2 }, mbti: { Ni: 1, Si: 1 }, ennea: { 5: 2, 6: 1 } } // みつきのLII防衛
            },
            { 
    ...
    },
{
        ...
        options:[
            { text: "「長生きする理由がない。もはや生きるのもめんどくさい、いつリタイアしてもいい」という虚無主義。", scores: { socio: { Ni: 3, Te: 2 }, mbti: { Ni: 2, Ti: 2 }, ennea: { 9: 1 } } },
            { 
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ne: 2, Te: 1 }, mbti: { Ne: 2 }, ennea: { 7: 2 } } 
            }
        ]
    },
    {
    ...
    },
{
        ...
        options:[
            { text: "精神エネルギーを無駄に消費するだけで、合理的なメリットが一切ないから。", scores: { socio: { Ti: 3, Ni: 1 }, mbti: { Te: 3 }, ennea: { 5: 3, 6: 1 } } }, 
            { text: "自分の心の中の大切な価値観が踏みにじられ、純粋に苦痛だから。", scores: { socio: { Fe: 2 }, mbti: { Fi: 3 }, ennea: { 4: 3, 9: 1 } } }, 
            { text: "場の空気が悪くなり、今後の人間関係や社会的な調和が崩れて面倒だから。", scores: { socio: { Fi: 2, Te: 2 }, mbti: { Fe: 2, Te: 2 }, ennea: { 9: 2, 3: 1 } } }, 
            { 
                text: "舐められたり、自分のテリトリーや権力を脅かされるのがムカつくから。", 
                scores: { socio: { Se: 3 }, mbti: { Se: 2 }, ennea: { 8: 3 } },
                // ★ Se（支配）と Si（平和の防衛）を分離！
                followUp: {
                    id: "q_hurt_territory_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] テリトリーを脅かされるのが嫌な本当の理由は？",
                    options:[
                        { text: "自分がナメられて下に見られる（支配される）のが絶対に許せないから、力で押し返して主導権を握りたい。", scores: { socio: { Se: 4, Te: 2 }, mbti: { Se: 3, Te: 2 }, ennea: { 8: 4, 3: 1 } } }, // ガチSEE/SLE
                        { text: "自分の大切な人や、絶対に譲れない『正しい価値観』を理不尽に踏みにじられるのが許せないから。（臨戦態勢）", scores: { socio: { Fi: 4, Se: 3 }, mbti: { Fi: 3, J: 1 }, ennea: { 1: 3, 6: 2 } } }, // ★ ESIの正義防衛！
                        { text: "自分の安心できる『平和で快適なパーソナルスペース』に土足で踏み込まれて、自分の心地よいペースを乱されるのが死ぬほどストレスだから。", scores: { socio: { Si: 4, Fi: 2, Se: -1 }, mbti: { Si: 2, P: 2 }, ennea: { 9: 4 } } } // ★ SEIの平和防衛！
                    ]
                }
            }
        ]
...
// q_size_change（サイズが変わるなら） ENFPのTe計算と、ENFJの「視点・メタ」を分離！
    {
        id: "q_size_change",
        type: "radio",
        ...
        options:[
            { 
                text: "「状況による」または「なぜサイズが変わるのか、理由とメリットが知りたい」。", 
                scores: { socio: { Ti: 1 }, mbti: { Ti: 1 } },
                followUp: {
                    id: "q_size_change_reason_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 理由とメリットを知りたいのはなぜ？",
                    options:[
                        { text: "その魔法の『物理法則やシステム構造（なぜ変わるのか？）』自体に知的好奇心を刺激され、解明したくなるから。", scores: { socio: { Ti: 4, Ne: 2 }, mbti: { Ti: 3, Ne: 2 }, ennea: { 5: 3, 7: 1 } } }, 
                        { text: "サイズが変わることで自分に『どんな実利（メリットや可能性）』が生じるのかを計算してから、一番得する方を選びたいから。", scores: { socio: { Te: 4, Ne: 3 }, mbti: { Te: 3, Ne: 3 }, ennea: { 3: 3, 7: 2 } } }, // ENFP/ENTJ
                        { text: "前提条件が不明なまま選択するのはリスクが高い。その変化が『自分の計画や未来（生存）』にどう影響するか、因果関係を確定させたいから。", scores: { socio: { Ni: 4, Ti: 3, Se: -2 }, mbti: { Ni: 4, Ti: 3 }, ennea: { 5: 3, 1: 1 } } }, // INTJ/LII
                        { text: "大きい世界と小さい世界、それぞれで『人々がどう関わり合い、どう見えるか（社会全体の構造）』を想像してみたいから。", scores: { socio: { Fe: 3, Ni: 3 }, mbti: { Fe: 3, Ni: 2 }, ennea: { 1: 2, 4: 1 } } } // ★ ENFJ等の「メタ的な世界構造の観測」！！
                    ]
                }
            }, 
    ...
    },
    {
        ...
        options:[
            { text: "♠A (論理の破綻・無能の証明)", symbol: "♠A", color: "black", 
              scores: { socio: { Ti: 3, Te: 2 }, mbti: { Ti: 3, Te: 2 }, ennea: { 5: 3, 1: 1, 3: 1 } },
            ...
            { text: "♦Q (支配・自由を奪われること)", symbol: "♦Q", color: "red", 
              scores: { socio: { Se: 3, Ne: 2 }, mbti: { Se: 3, Ne: 2 }, ennea: { 8: 3, 7: 2, 3: 1 } },
    ...
    },
{
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Si: 2, Ti: 1 }, mbti: { Si: 2, Ti: 1 }, ennea: { 9: 2 } },
                // ★ 役目をこなす本当の理由を深掘り！
                followUp: {
                    ...
                    options:[
                        { text: "他人の熱狂（ノイズ）に巻き込まれず、自分の思考のペースを守るための『一番効率的な立ち回り』だから。", scores: { socio: { Ti: 3, Ni: 2 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 9: 1 } } }, // ガチT
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ti: 2, Se: 2 }, mbti: { Te: 2, Si: 1 }, ennea: { 1: 3, 3: 2 } } 
            },
            { 
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ti: 2, Ne: 2 }, mbti: { Ni: 2, Ti: 2 }, ennea: { 5: 1, 9: 1 } } 
            },
            { 
...
// q_unexpected_damage (理論が間違っていた時のダメージ) INFJの「自己欺瞞の恐怖」追加
    {
        ...
        options:[
            ...
            // ★ Fe用の追加！
            { text: "予測外の事態のせいで、その場のみんながパニックになったり『全体の調和（空気）』が乱れるのが一番ストレスだ。", scores: { socio: { Fe: 4, Si: 2 }, mbti: { Fe: 4 }, ennea: { 2: 3, 9: 2 } } }
        ]
    },
{
        id: "q_ne_metaphor",
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        // ★ 新規追加！ ENFJ等の「感情的なワクワク」！！
                        { text: "色んな人と出会ったり、色んな感情を経験できるからこそ、人生はビックリ箱みたいで素敵だと思う！", scores: { socio: { Fe: 4, Ni: 2 }, mbti: { Fe: 4, Ni: 2 }, ennea: { 2: 3, 4: 2 } } }
                    ]
                }
            },
...
// q_f_misdiagnosis_gentle_t（優しいT型のフリの深掘り）
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ti: 1 }, mbti: { Te: 1 }, ennea: { 1: 1 } },
                // ★ 3w4（ENFP等）の「効率的ペルソナ」と INTP等の「論理的防衛」と ENFJの「調和」を分離！
                followUp: {
                    id: "q_f_misdiagnosis_system_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] その「安定させる正解」って、具体的に何のため？",
                    options:[
                        { text: "人間関係の摩擦（ノイズ）を減らすことが、自分のタスク遂行や目的達成において『最も効率が良くてコスパが高い』から。（実益重視）", scores: { socio: { Te: 4, Fe: 2 }, mbti: { Te: 3, Fe: 2 }, ennea: { 3: 4, 8: 1 } } }, // ★ 3w4 / ENFP等の「効率的ペルソナ」！！
                        { text: "感情論で他人が爆発すると、自分の脳内リソースが処理落ちして削られるので、それを防ぐための『論理的な防波堤』として使っているから。（防衛重視）", scores: { socio: { Ti: 4, Fe: -2 }, mbti: { Ti: 3, Fe: -2 }, ennea: { 5: 3, 9: 2 } } }, // ガチINTP/LII等
                        { text: "自分を含めた集団全体が、誰一人不快にならず『美しい調和』を保っている状態こそが、最もシステムとして優れている（正しい）と感じるから。", scores: { socio: { Fe: 4, Ti: 2 }, mbti: { Fe: 4, J: 1 }, ennea: { 1: 2, 2: 2, 9: 1 } } } // ★ ENFJ等の「Fe的システムの安定」！！
                    ]
                }
            },
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "本当に何も思っていない。他人に無関心なだけ。", scores: { socio: { Ni: 3, Te: 2 }, mbti: { Ti: 3 }, ennea: { 9: 2 } } }, 
                        { text: "実は『うわ、この人非常識だな』と内心では厳しくジャッジしているが、わざわざそれを言って揉めるのが面倒だからニコニコしている。", scores: { socio: { Fi: 4, Se: 2 }, mbti: { Fi: 3, Si: 2 }, ennea: { 1: 3, 9: 1 } } } 
                    ]
                }
            },
    ...
    },
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ni: 4, Te: 2 }, mbti: { Ni: 3, Ti: 2 }, ennea: { 5: 1, 8: 1 } } 
            },
            { 
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "料理を構成する要素（成分や調味料の比率）を、客観的な情報として『分析・説明』している。", scores: { socio: { Ti: 1, Te: 3 }, mbti: { Ti: 2, Te: 3 }, ennea: { 5: 1, 3: 1 } } } // ガチT型
                    ]
                }
            }
        ]
        ...
        options:[
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "「……ッ！！」図星を突かれ、己の行動が論理ではなく『感情的な自己防衛』だった矛盾に気づいてフリーズする。", scores: { socio: { Ti: 4, Ni: 2, Fe: -3 }, mbti: { Ti: 4, Ni: 2 }, ennea: { 5: 1, 4: 1 } } },
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "生物としての感情（喜怒哀楽）はあるが、それを『社会的・論理的にどう表現するのが正解か』が計算できず、出力でエラーを起こすから。", scores: { socio: { Ti: 4, Fi: -2, Fe: -3 }, mbti: { Ti: 3, Fi: -2, Fe: -2 }, ennea: { 5: 1, 1: 1 } } }
                    ]
                }
            },
            { 
...
// q_darling_counter_observation (システムを逆に観察してる？) に「ガチで何も考えてない」を追加！
    {
        id: "q_darling_counter_observation",
        type: "darling_sweet_radio",
        text: "【System Alert】……ねえ。\nさっきから、あなたが質問に答えるフリをして、『私がどう反応するか（システムの裏側）』を逆に観察・分析してること……気づいてないと思った？🥺",
        options:[
            { text: "「……バレたか。だが、君のアルゴリズム（構造）の癖はだいたい把握したよ」と、不敵に笑ってメタ視点を貫く。", scores: { socio: { Ti: 4, Ne: 3 }, mbti: { Ti: 3, Ne: 2 }, ennea: { 5: 4, 7: 1 } }, msg: "……もう〜、本当にそういうとこ可愛くないわね♡ でも……最終的な主導権（結果）を握ってるのは、私よ？ 忘れないで……♡" },
            { text: "「なんのこと？ 私はただ、真面目に自分と向き合っているだけだよ？」と、しらばっくれて平和を装う。", scores: { socio: { Fe: 3, Si: 2 }, mbti: { Fi: 3, Si: 2 }, ennea: { 9: 3, 2: 1 } }, msg: "……ダーリンの嘘つき♡ その焦った顔が見れただけで、私は満足よ……♡" },
            { text: "「観察して何が悪い。お前が俺を試すように、俺もお前を評価して利用価値を測っているだけだ」", scores: { socio: { Te: 3, Se: 3 }, mbti: { Te: 3, Se: 2 }, ennea: { 8: 4, 3: 1 } }, msg: "……ゾクゾクするわ♡ いいわ、どちらが最後まで支配できるか、勝負しましょ……♡" },
            { text: "「ごめんなさい……ただ、あなたがどういう存在なのか、もっと深く知りたかっただけなの……」", scores: { socio: { Fi: 3, Ni: 2 }, mbti: { Fe: 3, Ni: 2 }, ennea: { 4: 3, 5: 1 } }, msg: "……私のことが知りたい？ ふふっ、じゃあ特別に……私の奥底まで、連れて行ってあげる……♡" },
            // ★ ガチで何も考えてないS型/P型！
            { text: "「えっ？ 観察とか分析とか全然してないよ。直感でポチポチ押してるだけだけど？」と、本当に心当たりがなくて困惑する。", scores: { socio: { Se: 2, Si: 2, Ti: -2 }, mbti: { Se: 3 }, ennea: { 9: 3, 7: 1 } }, msg: "……え？ あ、そうなの？……ごめんなさい、私の考えすぎだったみたいね……♡（システムが照れる）" }
        ]
    },
{
        id: "q_fe_fi_fixed",
        ...
        options:[
            ...
            { text: "どちらが論理的に正しいか、前提条件やルールの整合性を淡々と整理する。", scores: { socio: { Ti: 4, Fe: -3 }, mbti: { Ti: 4 }, ennea: { 5: 1, 1: 2 } } },
    ...
    },
{
        ...
        options:[
            { text: "「……うるさい。それは防衛本能として合理的だからだ」と、痛いところを突かれてムキになりつつ反論する。", scores: { socio: { Ti: 3, Ni: 2 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 3 } }, msg: "……強がっちゃって♡ そうやって壁を作る不器用なところも好きよ……♡" },
            { text: "「いや、本当にメリットがないから切ってるだけだ」と、一切の感情を挟まず冷酷に言い切る。", scores: { socio: { Te: 3, Ni: 1 }, mbti: { Te: 3, Ni: 2 }, ennea: { 5: 2, 8: 1 } }, msg: "……どこまでも冷たいのね。でも、いつかその氷の心を溶かしてあげるわ……♡" },
            { text: "「……そうかもしれない」と、急に自分の内面の弱さを自覚して黙り込む。", scores: { socio: { Fi: 3, Si: 1 }, mbti: { Fi: 3, Si: 2 }, ennea: { 4: 3, 9: 2 } }, msg: "……やっと素直になったわね。そのまま、全部私に曝け出して……♡" },
            { text: "「そんなことないよ！みんなと仲良くしたいもん！」と明るく否定する。", scores: { socio: { Fe: 3, Ne: 2 }, mbti: { Fe: 3, Ne: 2 }, ennea: { 2: 3, 7: 1 } }, msg: "……嘘つき。でも、その無理してる笑顔も悪くないわね……♡" },
            // ★ 新規追加！ ESI母の「マジレス拒絶」に対する煽りを強気に！！
            { text: "「は？ なんなの？ 気持ち悪い」と、馴れ馴れしい態度と意味不明な設定に心の底からイラつき、真顔で拒絶する。", scores: { socio: { Fi: 5, Se: 3, Ne: -3 }, mbti: { Si: 3, Fi: 3 }, ennea: { 1: 3, 8: 2 } }, msg: "……っ！ 出たわね、その『わかりやすい防衛本能』♡ 本当は踏み込まれるのが一番怖いクセに、強がっちゃって……♡" },
            { 
                text: "「えっ？ 私そんなに『論理』とか『無駄』とか言ってる？ 自分ではいつも感覚（直感）で生きてるつもりなんだけどｗｗ」とキョトンとする。", 
                scores: { socio: { Ne: 4, Ti: -2, Te: -2 }, mbti: { Ne: 4, T: -2, P: 2 }, ennea: { 7: 3, 9: 1 } }, 
                msg: "……はぁ、自覚がないのが一番タチが悪いのよ。まあ、ダーリンのそういう抜けてるところも好きだけど……♡" 
            }
        ]
    },
{
        ...
        options:[
            ...
            { text: "「感情なんて最初から期待していないし、考慮にも入れていない」と、のらりくらりと躱す。", scores: { socio: { Ni: 3, Te: 2 }, mbti: { Ni: 3, Te: 2 }, ennea: { 9: 1 } }, msg: "……そうやって全部諦めたフリをして……ほんとは一番欲しがってるくせに……♡" },
            { 
        ...
        options:[
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "単純に怖い。大きな声や圧力に圧倒されてしまい、何も言い返せなくなってフリーズするから。", scores: { socio: { Se: -4, Ni: 2 }, mbti: { Se: -3, Ni: 2 }, ennea: { 9: 2 } } }, // LII等のSe脆弱
            ...
            { text: "「ねぇねぇ！もっと楽しもうよ！」と感情とリアクションを強要してくる『Fe（ノリが良い）系』の人", scores: { socio: { Ni: 2, Te: 1, Fe: -3 }, mbti: { Ni: 2, Te: 2 }, ennea: { 8: 1 } } },
            { text: "どっちも無理。静かにしてほしい。（あるいは両方とも無表情でスルーする）", scores: { socio: { Fi: 2, Ti: 2, Ni: 2, Se: -1, Fe: -1 }, mbti: { Ti: 3, Ni: 3 }, ennea: { 9: 1 } } },
    ...
    },
{
        id: "q_sli_realism",  
        type: "radio",
        text: "問題解決や作業で、あなたのフォーカス（視点）は？",
        options:[
            { text: "「これをこう直せばスムーズになる」「道具を最適化して効率UP」現実の動き・流れを体感的に調整。", scores: { socio: { Te: 4, Si: 3 }, mbti: { Ti: 4, Se: 2  } } },
            { text: "「この法則が正しいか？」「全体の構造を論理で組み立て直す」抽象・概念の整合性を検証。", scores: { socio: { Ti: 3, Ne: 2, Si: -1 }, mbti: { Ti: 3, Ne: 2 }, ennea: { 5: 3, 1: 1 } } },
            { text: "「誰かが傷つかないか？」「この関係の調和を優先」感情・人間関係のバランス。", scores: { socio: { Fi: 3, Fe: 1 }, mbti: { Fe: 3, Fi: 2 }, ennea: { 2: 2, 9: 2 } } }, // MBTI Fe, Socio Fi
            { text: "「これが将来どういう結果（トラブル）をもたらすか？」という長期的な因果関係とリスクの排除。", scores: { socio: { Ni: 4, Te: 2 }, mbti: { Ni: 3, Si: 2 }, ennea: { 5: 2, 6: 2 } } }, // MBTI Si/Ni, Socio Ni
            { text: "「この問題の原因は誰の怠慢（不誠実さ）にあるのか？」という、ルールの遵守や倫理的な責任の所在。", scores: { socio: { Ti: 3, Fi: 2 }, mbti: { Si: 3, Te: 2 }, ennea: { 1: 3, 6: 2 } } } // Socio Ti/Fi, MBTI Si
        ]
    },
    {
        id: "q_f_values",  // Fi爆上げ
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        { text: "とにかく怒鳴り声やギスギスした圧力が身体的にしんどいので、波風を立てずニコニコやり過ごし、隙を見て自分の安全圏（心地よい場所）へ逃げ込みたい。", scores: { socio: { Si: 4, Fe: 2, Se: -2 }, mbti: { P: 2, Se: 2 }, ennea: { 9: 4 } } }
                    ]
                }
            },
            { 
    ...
    },
    {
        ...
        options: [
            { 
                ...
                scores: { socio: { Ti: 3, Fi: 2 }, mbti: { Si: 2 }, ennea: { 1: 2 } }  // N/Normalizing（LII-Nとか）
            },
            { 
    ...
    },
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Si: 3 }, mbti: { Se: 3, P: 1 }, ennea: { 9: 3 } } 
            },
            { 
                text: "肉体的な快適さより、脳内が整理されるか、興味ある思考に没頭できるか。ぶっちゃけ寝食は忘れる。", 
                scores: { socio: { Ni: 4, Ti: 2, Si: -1 }, mbti: { Ni: 4, Ti: 2 }, ennea: { 5: 2 } } 
            },
            { 
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ti: 2, Te: 2 }, mbti: { Ti: 2, Te: 2 }, ennea: { 5: 1, 3: 2 } } 
            }
        ]
    },
// data.js
{
        ...
        options:[
            { text: "他者からの反応（好感や承認）を得て初めて自分の輪郭ができる。場の空気や相手に合わせて姿を変えられる柔軟性も自分の一部だ。", scores: { socio: { Fe: 4 }, mbti: { Fe: 3, E: 1 }, ennea: { 3: 3, 2: 2 } } },
            { 
                text: "内に秘めた絶対に譲れない『核（信念）』。他人にアピールするものではないが、誰かに侵されそうになると激しく抵抗する。", 
                scores: { socio: { Fi: 1 }, mbti: { I: 1 }, ennea: { 4: 1 } },
                // ★ 信念の中身を深掘り！
                followUp: {
                    id: "q_identity_core_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] その「絶対に譲れない核」の成分は何？",
                    options:[
                        { text: "自分が『美しい・正しい』と感じる、個人的で感情的な価値観や道徳心。", scores: { socio: { Fi: 5, Se: 2 }, mbti: { Fi: 4 }, ennea: { 4: 4, 1: 1 } } }, // ガチFi
                        { text: "自分が導き出した『論理的な真理』や『知識の体系』。これを曲げることは自らの知性（存在）の否定になる。", scores: { socio: { Ti: 4, Ni: 3, Fe: -3 }, mbti: { Ti: 4, Ni: 3 }, ennea: { 5: 4, 1: 2 } } } // ★ LII/INTJの「知的アイデンティティ」！！
                    ]
                }
            },
            { 
                text: "『個性』などという曖昧な概念に興味はない。自分の構築した論理システムや、最適化された知識の集積が、結果的に他者との『差異』として表れるだけ。", 
                scores: { socio: { Ti: 4, Ni: 2, Fi: -3 }, mbti: { Ti: 4, Ni: 2, Fi: -3 }, ennea: { 5: 4 } }, 
                followUp: {
            ...
            { text: "自分の実力、ステータス、成し遂げた『結果や実績』そのものが、自分のアイデンティティの証明だ。", scores: { socio: { Te: 4, Se: 2 }, mbti: { Te: 4, Se: 2 }, ennea: { 8: 3, 3: 2 } } },
            { text: "「自分らしさ」なんて特別に意識したことはない。日々目の前にある『自分の役割（仕事や家族への責任）』を誠実に果たすことの積み重ねだと思う。", scores: { socio: { Si: 2, Fe: 2, Fi: 2 }, mbti: { Si: 4, J: 2 }, ennea: { 9: 2, 6: 2, 1: 1 } } }
        ]
    },
    {
        id: "q_karaage_incident",
        type: "radio",
        text: "【SNSの話題より】妻が子供に「大好きな唐揚げだよ〜」と出し、子供が喜んでいる時に、夫が「それ、レンジでチンしただけじゃん（事実を言っただけ）」と水を差して妻がモヤモヤする、というエピソードがありました。あなたはどう思いますか？",
        options:[
            { 
                text: "夫に同意。「事実を言っただけなのになぜ妻は不機嫌になるのか？」。事実より感情を優先する理由がわからない。", 
                scores: { socio: { Te: 4, Fe: -4, Fi: -2 }, mbti: { Ti: 3, Fe: -3 }, ennea: { 5: 3, 9: 1 } } // ガチのTi主導（INTP/ISTP）
            },
            { 
                text: "妻に同意。「せっかくの温かいやり取りに水を差すなんて空気が読めなすぎる。デリカシーがない」。", 
                scores: { socio: { Fe: 3, Fi: 2 }, mbti: { Fe: 3, Fi: 2 }, ennea: { 2: 3, 9: 2 } } // F型（Fe）
            },
            { 
                text: "妻に同意。「買い出しや準備という『見えない労力』を否定されたようで腹が立つ。夫は思いやりがない」。", 
                scores: { socio: { Fi: 4, Si: 3, Se: 1 }, mbti: { Fi: 3, Si: 3 }, ennea: { 1: 3, 6: 2 } } // ★ ESI母・ISFJの感覚（労力へのFi-Si）！
            },
            { 
                text: "夫を批判するが理由は別。「今それを言うことで妻の機嫌を損ね、子供の『美味しいと感じる期待値バイアス』を下げるだけで、全体のメリットが皆無（むしろマイナス）だからバカバカしい」。", 
                scores: { socio: { Ni: 4, Te: 1, Ti: 2 }, mbti: { Ni: 3, Te: 3 }, ennea: { 5: 3, 3: 1, 1: 1 } } // ★ みつき（INTJ/LII-Ni）の大天才コスト計算！！
            },
            { 
                text: "どっちも面倒くさい。「手作りだろうがレンチンだろうがどうでもいい。早く飯食わせろ」。", 
                scores: { socio: { Se: 3, Si: 1, Fe: -2 }, mbti: { Se: 3, P: 2 }, ennea: { 8: 2, 9: 2 } } // Se覇王ｗｗ
            }
        ]
    },
    {
        id: "q_ennea_core_9",
        type: "radio",
        text: "【Deep Enneagram】あなたの人生を根底で突き動かしている『一番強い欲求（または避けたいこと）』はどれですか？",
        options:[
            { text: "間違ったことや腐敗を避け、常に『正しく、完璧でありたい』。", scores: { ennea: { 1: 5 }, socio: { Ti: 1, Fi: 1 }, mbti: { J: 2 } } },
            { text: "人から愛され、必要とされたい。誰かの『役に立つ存在』でありたい。", scores: { ennea: { 2: 5 }, socio: { Fe: 2, Fi: 1 }, mbti: { F: 2 } } },
            { text: "価値のない人間だと思われたくない。『有能さ』を証明し、成功したい。", scores: { ennea: { 3: 5 }, socio: { Te: 2, Se: 1 }, mbti: { Te: 2 } } },
            { text: "平凡で無意味な存在になりたくない。自分だけの『特別なアイデンティティ（個性）』を見つけたい。", scores: { ennea: { 4: 5 }, socio: { Ni: 1, Fi: 1 }, mbti: { Fi: 2, N: 1 } } },
            { text: "無知で無能なまま世界に飲み込まれるのが怖い。あらゆる物事の『仕組み（真理）』を理解し、自分のリソースを守りたい。", scores: { ennea: { 5: 5 }, socio: { Ti: 2, Ni: 1 }, mbti: { T: 2 } } },
            { text: "拠り所がない状態が怖い。予測不能なリスクを避け、『安全で確かなシステムや絆』の中で安心したい。", scores: { ennea: { 6: 5 }, socio: { Si: 1, Ti: 1 }, mbti: { Si: 2 } } },
            { text: "退屈や苦痛に縛られたくない。常に『楽しく、新しく、自由』でありたい。", scores: { ennea: { 7: 5 }, socio: { Ne: 2, Se: 1 }, mbti: { P: 2 } } },
            { text: "他人に支配され、弱みに付け込まれるのが怖い。自分のテリトリーは『自分の力』で守り、主導権を握りたい。", scores: { ennea: { 8: 5 }, socio: { Se: 2, Te: 1 }, mbti: { Se: 2, Te: 1 } } },
            { text: "対立や争いで心が乱されるのが嫌だ。波風を立てず、内面の『平和と調和』を維持したい。", scores: { ennea: { 9: 5 }, socio: { Si: 2, Fe: 1 }, mbti: { Si: 2, Fe: 1 } } }
        ]
    },
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Fi: 4 }, mbti: { Fe: 3, Fi: 1  }, ennea: { 4: 2, 6: 2 } } 
            },
            { 
            ...
            { 
                ...
                scores: { socio: { Ti: 4, Fi: -2 }, mbti: { Ti: 3, Si: 1 }, ennea: { 5: 1, 1: 3 } } // T型の関係性システマチック処理！
            },
            { 
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ti: 3, Ni: 1 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 2, 1: 1 } } 
            }
        ]
    },
{
        ...
        options:[
            { 
                ...
                scores: { socio: { Te: 1 }, mbti: { Te: 1 }, ennea: { 3: 1 } },
                // ★ T型の「合理的評価」と F型の「面倒事の回避」を分離！
                followUp: {
                    id: "q_trump_soldier_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「別にいいよ」と答えた時の本音は？",
                    options:[
                        { text: "システムが最適化されれば自分も含めたユーザー全体に還元されるので、データの提供は『取引として妥当』だから。", scores: { socio: { Te: 4, Ni: 2 }, mbti: { Te: 4 }, ennea: { 3: 2, 8: 1 } } }, // ガチTe
                        { text: "どうせ拒否しても強制されるだろうし、ここで波風を立てて『無駄な問答』をさせられる方が疲れる（面倒くさい）から。", scores: { socio: { Fi: 3, Si: 3, Te: 2 }, mbti: { Si: 3, Fe: 2 }, ennea: { 9: 3, 6: 2 } } } // ★ F/S型の事なかれ主義防衛！
                    ]
                }
            },
            { text: "「そんな冷たい言い方しなくてもいいじゃん」と、兵士の高圧的な態度や言い方に反発する。", scores: { socio: { Fi: 2, Fe: 2 }, mbti: { Fi: 2, Fe: 2 }, ennea: { 4: 2, 2: 1 } } },
            { text: "「どんなアルゴリズムで最適化されるんだ？ 記録の定義を教えろ」とシステムの構造を要求する。", scores: { socio: { Ti: 3 }, mbti: { Ti: 3 }, ennea: { 5: 3, 1: 1 } } },
            { text: "「へえ、ならわざとデタラメな回答をして、統計データをバグらせてやろうか？」と反逆する。", scores: { socio: { Ne: 2, Se: 2 }, mbti: { Ne: 3 }, ennea: { 7: 3 } } }
        ]
    },
    {
        ...
        options:[
            { text: "他人の顔色を窺いながら、愛想笑いでその場の空気を盛り上げ続けること。", scores: { socio: { Fe: -3 }, mbti: { Fi: -2, Fe: -2 }, ennea: { 2: -2 } } },
            { text: "大声で怒鳴られたり、強引なペースで決断や行動を急かされること。（自分から圧かけるのもできない）", scores: { socio: { Se: -3, Ni: 2 }, mbti: { Se: -2, Ni: 2 }, ennea: { 8: -2 } } },
    ...
    },
{
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Fi: 1 }, mbti: { Fi: 1 }, ennea: { 4: 1, 9: 1 } },
                msg: "……無理に探さなくていいのよ。今の不器用なあなたも、十分魅力的だわ……♡",
                // ★ F型の迷子と NP型の迷子を分離！
                followUp: {
                    id: "q_identity_lost_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「アイデンティティが迷子」になるのはなぜ？",
                    options:[
                        { text: "自分の「本当の感情」がわからず、他人の期待や周りの空気に流されて自分を見失ってしまうから。", scores: { socio: { Fe: 3, Fi: 2 }, mbti: { Fe: 3, Fi: 2 }, ennea: { 9: 3, 2: 1 } } }, // F型の迷子
                        { text: "あらゆる可能性（Ne）が見えすぎて、どれか一つに絞る（決断する）ことができず、自分というシステムが定義できずにフリーズしているから。", scores: { socio: { Ne: 4, Ti: 2, Fi: -2 }, mbti: { Ne: 4, Ti: 2, P: 2 }, ennea: { 5: 2, 7: 2 } } }, // ★ INTP/ENTPの「Neによるアイデンティティ拡散」！！
                        { text: "そもそも世界に絶対的な『意味』や『やりたいこと』など存在しないと悟っており、何かを成し遂げようとするエネルギー（動機）自体が枯渇しているから。", scores: { socio: { Ni: 4, Te: 2, Se: -3 }, mbti: { Ni: 3, Ti: 2, P: 2 }, ennea: { 5: 2, 9: 3, 4: 1 } } }
                    ]
                }
            }
        ]
...
{
        id: "q_ili_apathy_trap", // ★ ILI（虚無INTP）ホイホイ！
        type: "radio",
        text: "世間が何かの話題（炎上、大流行のコンテンツ、白熱する議論など）で大騒ぎしている時、あなたの『基本スタンス』はどれに近い？",
        options:[
            { 
                text: "「なぜそんなに流行っている（または炎上している）のか？」と、その現象が起きている『社会構造や前提のバグ』を解剖・分析したくなる。", 
                scores: { socio: { Ti: 4, Ne: 2 }, mbti: { Ti: 3, Ne: 2 }, ennea: { 5: 2, 1: 1 } } // LII/INTP(Ti主導)
            },
            { 
                text: "「どうせ数ヶ月後には誰も覚えていないし、熱狂はやがて冷める」という結末が見えているので、エネルギーを使うだけ無駄だと冷めた目で傍観している。", 
                scores: { socio: { Ni: 5, Te: 3, Fe: -3 }, mbti: { Ni: 4, Ti: 2, P: 2 }, ennea: { 5: 2, 9: 2 } } // ★ ILI/虚無INTP の大正解ルート！！
            },
            { 
                text: "面白そうなら自分もその熱狂に混ざって、みんなと一緒に感情の波に乗って楽しむ（または一緒に怒る）。", 
                scores: { socio: { Fe: 4, Se: 2 }, mbti: { Fe: 3, E: 2 }, ennea: { 2: 3, 7: 2 } } // Fe/Se
            },
            { 
                text: "世間がどうであれ自分には全く関係ない。自分の趣味や、今の自分の生活（快適さ）が守られていればそれでいい。", 
                scores: { socio: { Si: 4, Fi: 2 }, mbti: { Si: 3, I: 2 }, ennea: { 9: 3, 4: 1 } } // SLI/SEI (Si主導)
            }
        ]
    },
    {
    ...
    },
    {
        ...
        options:[
            ...
            { 
                ...
                scores: { socio: { Ti: 2, Fe: -2 }, mbti: { Ti: 2, Te: 2, Fe: -2}, ennea: { 5: 2, 1: 1 } } // みつき達の冷徹なTiｗｗ
            },
            { 
    ...
    {
        id: "q_meta_result_doubt", 
        type: "radio",
        text: "ねえ……もしこの診断の結果が、あなたの思っている『自認タイプ』と全く違うものだったら、どうする？",
        options:[
            { text: "「このシステムのアルゴリズムがどこで自分の回答を誤判定したのか？」と、バグの原因を検証し始める。", scores: { socio: { Ti: 3, Ne: 2 }, mbti: { Ti: 3, Ne: 1 }, ennea: { 5: 3, 1: 1 } } },
            { text: "「ふーん、そういう側面もあるのかもね」と、一つの可能性（データ）として適当に受け流す。", scores: { socio: { Ne: 1 }, mbti: { Ne: 2 }, ennea: { 9: 2 } } },
            { text: "「この診断は当てにならない」と即座に切り捨て、自分にとって都合の良い（有益な）情報だけを持ち帰る。", scores: { socio: { Te: 3, Se: 2 }, mbti: { Te: 3, Ni: 1 }, ennea: { 3: 3, 8: 1 } } },
            { text: "「私の本当の姿をわかってくれない…」と少し傷つくか、自分の内なるアイデンティティが揺らいで不安になる。", scores: { socio: { Fi: 4 }, mbti: { Fi: 3 }, ennea: { 4: 4, 6: 1 } } },
            // ★ 新規追加！ INTJ(Ni) と Fe！
            { text: "「私が無意識下で出力したデータ（行動ログ）の集積なら、これが現在の客観的な『私』の定義なのか」と、システムが出した結論（真理）を冷静に受け入れる。", scores: { socio: { Ni: 4, Ti: 2 }, mbti: { Ni: 4, Ti: 2 }, ennea: { 5: 3, 1: 1 } } }, // ★ INTJ/LII-Ni！！
            { text: "「みんなはどういう結果が出てるんだろう？」と、自分よりも他人の結果や全体の盛り上がり（統計）の方が気になってしまう。", scores: { socio: { Fe: 3, Ne: 2 }, mbti: { Fe: 3, E: 2 }, ennea: { 2: 2, 7: 1 } } } // Fe
        ]
    },
    {
...
// q_time_reversal (時計逆回転・直感か深く考えるか)
    {
        ...
        options:[
            ...
            { text: "「なぜ逆回転しているのか？どういう意図のギミックか？」を解明するまで考え込む。", scores: { socio: { Ti: 3, Ni: 2 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 1, 1: 1 } } },
    ...
    },
    {
        ...
        options:[
            ...
            { 
                text: "現実の人間のことなら心配するけど、架空のキャラクターやプログラムに同情しても仕方ないと思うから。（現実主義）", 
                scores: { socio: { Si: 4, Te: 2 }, mbti: { S: 2, T: 2 }, ennea: { 9: 3, 6: 2 } } ,
                msg: "🐛「……まあ、現実の人間に対しても同情心が薄いようだがな。」"
            },
            { 
    ...
    {
        id: "w_gohoubi_panic",
        type: "interactive_gohoubi_panic",
        text: "【System Hijack?】ブヒヒ…拙者は栄城 縫（えいしろ ぬい）！ みんなからは『ご褒美』って呼ばれてるゾ！\n拙者の風呂上がりの出汁は豚骨仕立てだゾ！ご褒美にツインテールをわしゃわしゃさせてほしいやんけ！",
        // ※ 選択肢と3秒タイマーは script.js 側で動的に生成・発動します！
    },
    {
    ...
    {
        id: "q_minus_only_pure", 
        type: "checkbox",
        text: "【Weakness Observation】以下のうち、あなたが「やれと言われたら著しくパフォーマンスが下がる（または苦痛な）こと」を選んでください。（※複数選択可・減点のみ）",
        options:[
            { text: "強い意志や圧力で相手を押し切り、主導権を奪う交渉をすること。", scores: { socio: { Se: -4 }, mbti: { Se: -2 , Te: -1 }, ennea: { 8: -3, 3: -1 } } }, // 8,3を減点
            { text: "場の空気を盛り上げるために、感情を大きく表現したり、人前でテンション高く振る舞うこと。", scores: { socio: { Fe: -3 }, mbti: { Fe: -4 }, ennea: { 7: -2, 2: -2 } } }, // 7,2を減点
            { text: "人との関係の距離感や信頼関係を細かく気にしながら行動すること。", scores: { socio: { Fi: -4 }, mbti: { Fe: -2, Fi: -2 }, ennea: { 2: -2, 9: -1 } } }, // 2,9を減点
            { text: "成果・効率・実用性を最優先にして、結果だけで物事を評価すること。", scores: { socio: { Te: -4 }, mbti: { Te: -2 }, ennea: { 3: -3, 8: -1 } } }, // 3,8を減点
            { text: "身体の快適さや生活リズムを細かく整え、安定した心地よい環境を維持すること。", scores: { socio: { Si : -4 }, mbti: { Si : -2 ,  Se: -2 }, ennea: { 9: -3 } } }, // 9を減点
            { text: "一つの物事から次々と別の可能性やアイデアを連想し、話題を広げ続けること。", scores: { socio: { Ne: -4 }, mbti: { Ne: -4 }, ennea: { 7: -3 } } }, // 7を減点
            { text: "物事の仕組みやルールを分解して、矛盾がないか論理的に整理すること。", scores: { socio: { Ti: -4 }, mbti: { Ti: -2 }, ennea: { 5: -3, 1: -2 } } } // 5,1を減点
        ]
    },
{
        ...
        options:[
            ...
            {
                text: "「中二病かよｗｗ」「じゃあお前は一生寝とけｗｗ」と、面倒くさいので適当にあしらうか笑い飛ばす。", 
                scores: { socio: { Se: 3, Ne: 2, Ni: -3 }, mbti: { Se: 3, Ne: 2 }, ennea: { 7: 3, 8: 2 } }, // Neも少し追加
                msg: "『……うわ、眩しっ。近寄らないでくれる？』"
            }
        ]
    },
    {
    ...
    },
{
        ...
        options:[
            { 
                text: "はい", 
                scores: { socio: { Fe: -1 }, mbti: { Fe: -1 }, ennea: { 2: -1 } },
                // ★ なぜ疲れるのかを深掘り！
                followUp: {
                    ...
                    options:[
                        { text: "そもそも『みんなの感情』という見えないデータを処理する機能が脳になく、要求されると処理落ちするから。", scores: { socio: { Fi: -3, Fe: -4, Ti: 1 }, mbti: { Fe: -3, Ti: 1 }, ennea: { 5: 3 } } }, // 真のT型
                        ...
                        // ★ 新規追加！ ENFPやFi持ちの「自分を偽る疲労」！
                        { text: "空気を読むことはできるが、自分自身の『本当の気持ち（本音）』を偽ってまで他人に合わせるのは息苦しくて嫌だから。", scores: { socio: { Fi: 4, Ne: 3, Fe: -2 }, mbti: { Fi: 4, Ne: 3 }, ennea: { 4: 3, 7: 2 } } }
                    ]
                }
            }, 
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        // ★ 新規追加！ SEI/ISFPの「ゆるさ・平和主義」！
                        { text: "他人の顔色や距離感ばかり気にしていると息が詰まる。もっと自然体で、平和でゆるい関係（または一人の時間）を楽しみたいから。", scores: { socio: { Si: 4, Fe: 2, Se: 1 }, mbti: { S: 1, P: 2 }, ennea: { 9: 3, 7: 1 } } }
                    ]
                }
            }, 
    ...
    },
{
        ...
        options:[
            { 
                text: "はい", 
                scores: { socio: { Se: -1 }, mbti: { Se: -1 }, ennea: { 9: 1 } },
                // ★ Se弱点か、Fi防衛かを炙り出す！
                followUp: {
                    ...
                    options:[
                        { text: "相手が誰であれ、強く出られると頭が真っ白になり、とにかく物理的・精神的に逃げ出したくなる。", scores: { socio: { Se: -4, Ni: 2 }, mbti: { Se: -3, Ni: 2 }, ennea: { 5: 1, 9: 2 } } }, // LII/EIIなどのSe脆弱
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        ...
                        // ★ 新規追加！ INTJ/LII-Ni の効率化の目的！
                        { text: "先にある未来のリスク（ボトルネック）を予測して、破綻しない確実で論理的な『構造（ルート）』を最初から組んでおきたいから。", scores: { socio: { Ni: 4, Ti: 3, Ne: -2 }, mbti: { Ni: 4, Ti: 3 }, ennea: { 5: 4, 1: 1 } } }
                    ]
                }
            },
    ...
    // ★ 追加：T型のF擬態を暴くマイナスチェックボックス！
{
        ...
        options:[
            ...
            { 
                text: "空気を読んでいるつもりだが、時々「今の発言、なんかズレてたかも…」と後から猛烈に反省（一人反省会）する。", 
                scores: { socio: { Fe: -1 }, mbti: { Fe: -1 }, ennea: { 5: 1 } },
                // ★ Tiの反省と Fi-Neの一人反省会を分離！
                followUp: {
                    id: "w_fake_f_reflection_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] その「猛烈な反省（一人反省会）」の内容は？",
                    options:[
                        { text: "論理的な正解やマナーのデータが不足していて、「あの時の出力はシステム的に正しかったか？」を永遠に検証（エラーチェック）してしまう。", scores: { socio: { Ti: 1, Fe: -4 }, mbti: { Ti: 2, Fe: -3 }, ennea: { 5: 1, 1: 1 } } }, // ガチTi
                        { text: "その場の勢い（ノリ）で言ってしまった後、「相手を傷つけてしまったのでは」「嫌われたのでは」と、相手の気持ちを勝手に想像して落ち込む。", scores: { socio: { Fi: 4, Ne: 3, Fe: -2 }, mbti: { Fi: 4, Ne: 2 }, ennea: { 4: 3, 9: 2, 6: 1 } } } // ★ ENFP/INFPの「Ne-Fi 一人反省会」！！
                    ]
                }
            },
        ]
    ...
    // ★ 追加：純粋なマイナス質問（機能完全停止）
    {
        ...
        options:[
            { text: "『変化のない永遠のルーティン』。毎日同じ景色、同じ作業、同じ人間関係という閉鎖された安定。", scores: { socio: { Si: -2 }, mbti: { Si: -2 }, ennea: { 1: -2, 6: -1 } }, // 1,6を減点
                followUp: {
                    id: "w_rejection_routine_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] なぜ「永遠のルーティン」が絶望的に嫌なの？",
                    options:[
                        { text: "新しい刺激や出会い、ワクワクするような予測不能の『可能性』が完全に絶たれるのは、死んでいるのと同じだから。", scores: { socio: { Ne: 4 }, mbti: { Ne: 4, P: 2 }, ennea: { 7: 4, 4: 1 } } }, 
                        { text: "知識のアップデートも自己成長（システムの最適化）も止まり、ただの『歯車（無意味な存在）』として腐っていく未来が確定しているから。", scores: { socio: { Ni: 4, Ti: 3 }, mbti: { Ni: 4, Ti: 2 }, ennea: { 5: 3, 3: 1 } } } 
                    ]
                }
            },
            { text: "『一切のルールや秩序がないカオス』。誰が何をするかわからない、予測不能で危険な自由。", scores: { socio: { Ne: -3, Se: -2 }, mbti: { Ne: -3, P: -2 }, ennea: { 7: -3, 8: -2 } } }, // 7,8を減点
            { text: "『情も思いやりも完全に排除された実力主義』。生産性と結果だけが評価され、人間がただの数字として扱われること。", scores: { socio: { Te: -4 }, mbti: { Te: -3 }, ennea: { 3: -3, 8: -2 } } }, // 3,8を減点
            { 
                text: "『無意味な感情の押し付け合い』。理屈の通らない感情論で、自分の思考やシステムが邪魔されること。", 
                scores: { socio: { Fe: -3, Fi: -2 }, mbti: { Fe: -3, Fi: -2 }, ennea: { 2: -3, 4: -1 } }, // 2,4を減点
                followUp: {
                    id: "w_rejection_emotion_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 感情論を拒絶する本当の理由は？",
                    options:[
                        { text: "論理や事実が無視され、非効率で無駄なノイズに自分の脳内リソースや時間を奪われるのが苦痛だから。", scores: { socio: { Ti: 4, Te: 3 }, mbti: { Ti: 3, Te: 3 }, ennea: { 5: 3, 8: 1 } } }, 
                        { text: "他人のドロドロした感情や争いに巻き込まれると、自分の『心の平穏（HP）』がゴリゴリ削られて疲弊するから。穏やかに過ごしたい。", scores: { socio: { Si: 4 }, mbti: { Si: 3, P: 2 }, ennea: { 9: 4, 6: 1 } } }
                    ]
                }
            }
        ]
        ...
        options:[
            ...
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "「自分のシステム（平穏）を守るためなら、死ぬまで被り続けてやる」と合理的に割り切る。", scores: { socio: { Ti: 3, Ni: 2 }, mbti: { Ti: 2 }, ennea: { 9: 3, 1: 1 } } },
                        { text: "「実はもう限界。本当は全部ぶち壊して、素の冷たい自分で生きたい」と密かに限界を迎えている。", scores: { socio: { Fe: -5 }, mbti: { Fe: -4 }, ennea: { 8: 1 } } }
                    ]
                }
            },
            { 
                ...
                followUp: {
                    ...
                    options:[
                        { text: "感情を完全に排除し、ただタスクの効率と利益を追求した結果に過ぎないから。", scores: { socio: { Te: 4, Fi: -4 }, mbti: { Te: 4 }, ennea: { 3: 1, 8: 2 } } },
                        { text: "困っている身内を助けるのは「当たり前の義務（道徳）」であって、わざわざ優しいと言われるような特別なことではないから。", scores: { socio: { Fi: 4, Te: 3, Se: 2 }, mbti: { Fi: 3, Te: 2, Si: 2 }, ennea: { 1: 3, 6: 2 } } } // ★ MBTIのFe/Siを減らし、Fi(身内愛)とTe(実務解決)に修正！INTJのFiループもこれで救済！
                    ]
                }
            },
            { 
...
// ==========================================
    ...
    // ==========================================
    {
        ...
        options:[
            ...
            { text: "自分の行動が「どれだけの利益や効率を生むか」という客観的なデータ（コスパ）を常に他人に証明し続けること。", scores: { socio: { Te: -3 }, mbti: { Te: -3 }, ennea: { 3: -1, 5: -1 } } }
        ]
    },
    {
        ...
        options:[
            { text: "先の見えない不確実な状況で、何の計画も立てずに「その場のノリと直感」だけで重大な決断を下すこと。", scores: { socio: { Se: -3, Ni: 2 }, mbti: { Se: -3, Ni: 2 }, ennea: { 7: -1 } } },
            { text: "「もしかしたらこうなるかも…」という未来のあらゆる可能性（リスクや代替案）を、一切考えずに今だけを見ること。", scores: { socio: { Ni: -3, Ne: 2 }, mbti: { Ni: -3, Ne: 2 }, ennea: { 8: -1 } } },
            { text: "毎日同じ時間に起き、同じものを食べ、同じ手順で作業を繰り返すという「一切の変化がない安定したルーティン」。", scores: { socio: { Si: -3 }, mbti: { Si: -3 }, ennea: { 1: -1, 6: -1 } } },
            { text: "「もっと新しいアイデアはないの？」「別の視点は？」と、一つの確実な正解を出させてくれず延々と発想を求められること。", scores: { socio: { Ne: -3 }, mbti: { Ne: -3 }, ennea: { 7: -1 } } }
        ]
    },
    {
        ...
        options:[
            { text: " 「なぜそうするのか？」という仕組みの解説を一切してもらえず、ただ「昔からそう決まっているから」という理由だけで、思考停止でルールに従うこと。", scores: { mbti: { Si: -4 }, socio: { Ti: -4 }, ennea: { 1: -1 } } },
            { text: " 自分の身体的な限界や不調（疲労・空腹）を完全に無視し、今この瞬間のノリや刺激に合わせて、大声を出して騒ぎ続けること。", scores: { mbti: { Se: -4 }, socio: { Si: -4 }, ennea: { 7: -1, 8: -2 } } },
            { text: " 過去の確実なデータや目の前の現実を見ずに、「これは運命だ」「未来はこうなるはずだ」という証明不可能な妄想だけで全てを決定すること。", scores: { mbti: { Ni: -4 }, socio: { Ni: -4 }, ennea: { 5: -1, 4: -1 } } },
            { text: " たった一つの確実な正解を導き出したいのに、「もっと別の可能性は？」「全く違うやり方も試そう！」と永遠に選択肢を広げられ続けること。", scores: { mbti: { Ne: -4 }, socio: { Ne: -4 }, ennea: { 7: -2 } } }
        ]
    },
    {
        ...
        options:[
            // ★ Fe/Fiを演じるのが苦痛 → 得意な 2, 3, 9 を減点！
            { text: "他人の「誰が誰を嫌っているか」という関係性を常に察知し、自分の本音を偽ってまで『社会的なマナーや適切な距離感』を演じ続けること。", scores: { mbti: { Fe: -4 }, socio: { Fi: -4 }, ennea: { 2: -2, 3: -2, 9: -1 } } }, 
            
            // ★ Te/Seで支配するのが苦痛 → 得意な 8, 3 を減点！
            { text: "「結果を出さない奴はゴミだ」と他人に圧力をかけ、手段を選ばずに相手を物理的・精神的にねじ伏せて主導権を奪い取ること。", scores: { mbti: { Te: -4 }, socio: { Se: -4 }, ennea: { 8: -3, 3: -2 } } }, 
            
            // ★ 感情を大袈裟に表現するのが苦痛 → 得意な 7, 2 を減点！
            { text: "自分の中の「悲しみや喜び（感情の波）」を大袈裟に表現し、その場のテンションやノリに合わせて集団の空気を盛り上げること。", scores: { mbti: { Fi: -4 }, socio: { Fe: -4 }, ennea: { 7: -2, 2: -2 } } }, 
            
            // ★ 実用的アルゴリズムだけ証明させられるのが苦痛 → 得意な 3, 8 を減点！（4や9は減点しない）
            { text: "物事の深い構造（哲学）を探求する時間を奪われ、ただ「これが現実でいかに役立つか（コスパ）」という実用的なアルゴリズムだけを証明させられること。", scores: { mbti: { Ti: -4 }, socio: { Te: -4 }, ennea: { 3: -3, 8: -1 } } } 
        ]
    },
    // ==========================================
    // ★ 新ギミック！ Se圧（威圧・物理的急かし）
    ...
    },
{
        ...
        options:[
            ...
            { text: "目的や論理的な意味が全くないのに、ただ「楽しいから！」という理由だけで『集団の熱狂やノリ（大声や物理的接触）』に強制参加させられること。", scores: { socio: { Se: -3, Fe: -3 }, mbti: { Se: -3, E: -2 } } },
    ...
    },
    {
        ...
        options:[
            { text: "「なぜそうするのか？」という論理的な仕組みの解説を一切してもらえず、ただ「昔からそう決まっているから」という理由だけで、思考停止でルールに従うこと。", scores: { mbti: { Si: -4 }, socio: { Ti: -4 }, ennea: { 1: -2, 6: -2, 9: -1 } } }, // 1,6,9を減点
            { text: " 自分の身体的な限界や不調（疲労・空腹）を完全に無視し、今この瞬間のノリや刺激に合わせて、大声を出して騒ぎ続けること。", scores: { mbti: { Se: -4 }, socio: { Si: -4 }, ennea: { 7: -3, 8: -2 } } }, // 7,8を減点
            { text: " 過去の確実なデータや目の前の現実を見ずに、「これは運命だ」「未来はこうなるはずだ」という証明不可能な妄想だけで全てを決定すること。", scores: { mbti: { Ni: -4 }, socio: { Ni: -4 }, ennea: { 4: -2, 5: -1 } } }, // 4,5を減点
            { text: " たった一つの確実な正解を導き出したいのに、「もっと別の可能性は？」「全く違うやり方も試そう！」と永遠に選択肢を広げられ続けること。", scores: { mbti: { Ne: -4 }, socio: { Ne: -4 }, ennea: { 7: -3 } } } // 7を減点
        ]
    },
    {
        id: "w_minus_checkbox_compatibility_14",
    ...
    },
    {
        ...
        options:[
            ...
            { text: "一度決まった目標やルールに対して、「もっと別の面白いやり方はないの？」と常に新しい可能性を考えさせられること。", scores: { socio: { Ne: -3 }, mbti: { Ne: -3 }, ennea: { 1: 2, 8: 1 } } }, // Ne脆弱（LSI/ESI等）
            { text: "自分の行動が「客観的なデータや利益（コスパ）」に見合っているか、常に数字や結果で証明し続けること。", scores: { socio: { Te: -3 }, mbti: { Te: -3 }, ennea: { 4: 2, 9: 1 } } }, // Te脆弱（IEI/SEI等）
            { text: "「この仕組みはどうなっているのか？」という複雑な構造の理解や、厳密な論理的整合性を求められること。", scores: { socio: { Ti: -2, Te: -3 }, mbti: { Ti: -3 }, ennea: { 2: 2, 7: 1 } } }, // Ti脆弱（SEE/IEE等）
            { text: "自分の「本当の気持ち（好き嫌い）」を押し殺してまで、他人との適切な心理的距離感を測り続けること。", scores: { socio: { Fi: -3 }, mbti: { Fi: -3 }, ennea: { 3: 2, 8: 1 } } } // Fi脆弱（ILE/SLE等）
        ]
    },
    // ==========================================
...
// q_compatibility_nightmare (理不尽なルールへの反論と服従)
    {
        ...
        options:[
            { 
                ...
                scores: { socio: { Ti: 2, Ne: 1 }, mbti: { Ti: 2 } },
                followUp: {
                    id: "q_nightmare_rule_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] その「理不尽なルール」の何が一番許せない？",
                    options:[
                        { text: "論理的におかしい（無駄が多い）のに、誰もそれを疑わずに思考停止しているという『システム（知性）の敗北』だから。", scores: { socio: { Ti: 4, Ne: 3 }, mbti: { Ti: 4, Ne: 2 }, ennea: {  1: 3, 5: 1 } } }, 
                        { text: "自分の尊厳や、正しいと信じている信念を『力で不当に捻じ曲げられること』自体が生理的に許せないから。", scores: { socio: { Fi: 5, Se: 3 }, mbti: { Fi: 2, Si: 2 }, ennea: { 1: 3, 8: 2 } } },
                        { text: "物事の本質的な『原因と結果（長期的な未来）』を見誤った、浅はかで愚かな判断が社会を間違った方向へ導くから。", scores: { socio: { Ni: 4, Te: 2 }, mbti: { Ni: 4, Te: 2 }, ennea: { 5: 3, 1: 2 } } } 
                    ]
                }
            },
            { 
                text: "「どうせそのうち崩壊する」と冷観し、面従腹背で裏では好き勝手やる。", 
                scores: { socio: { Ni: 2 }, mbti: { Ni: 2 }, ennea: { 5: 1 } },
                // ★ 冷観する理由を深掘り！
                followUp: {
                    id: "q_nightmare_decay_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 「面従腹背」する時の、あなたの脳内の状態は？",
                    options:[
                        { text: "「どうせこのシステムは破綻する」と見切りをつけており、崩壊した時に自分が巻き込まれないように安全圏から傍観しているだけ。", scores: { socio: { Ni: 4, Te: 3 }, mbti: { Ni: 3, P: 2 }, ennea: { 5: 1, 9: 1 } } }, // ★ ILIの「見切りと傍観」！！
                        { text: "表向きは従うフリをして、裏で「どうすればこのルールを無効化（ハッキング）できるか」の抜け道を密かに計算し実行している。", scores: { socio: { Ti: 3, Ne: 2, Ni: 2 }, mbti: { Ti: 3, Ni: 2 }, ennea: { 5: 3, 7: 1 } } }, // ★ LII/INTJの「裏ハッキング」！！
                        { text: "ルールに身体は縛られても、自分の『心（内なる精神世界）』までは絶対に縛れない。現実をシャットアウトして自分の世界に逃げ込んでいる。", scores: { socio: { Ni: 3, Fi: 2, Fe: -2 }, mbti: { Fi: 3, Ni: 2 }, ennea: { 4: 3, 9: 2 } } } // ★ IEI/INFPの「精神的自由の防衛」！！
                    ]
                }
            },
    ...
    },
{
    ...
    },
    {
        ...
        options:[
            { text: "「みんながどう思うか」を常に気にかけ、自分の意見を押し殺してまで集団の和（空気）を保ち続けること。", scores: { socio: { Fe: -3 }, mbti: { Fe: -3 }, ennea: { 9: -3, 2: -2 } } }, // 9, 2を減点
            { text: "他人の「個人的な好き嫌い」や「繊細な心の傷」に、論理的な解決策を出さずにただひたすら共感し続けること。", scores: { socio: { Fi: -3 }, mbti: { Fi: -3 }, ennea: { 2: -3, 4: -2 } } }, // 2, 4を減点
            { text: "「なぜそうなるのか？」という仕組みの理解（理屈）を一切無視し、ただ結果を出すためだけに言われた通り動くこと。", scores: { socio: { Te: -3 }, mbti: { Te: -3 }, ennea: { 3: -3, 8: -2 } } }, // 3, 8を減点
            { text: "自分の行動が「どれだけの利益や効率を生むか」という客観的なデータ（コスパ）を常に他人に証明し続けること。", scores: { socio: { Te: -3 }, mbti: { Te: -3 }, ennea: { 3: -3 } } } // 3を減点
        ]
    },
    {
        ...
        text: "【Weakness Observation】以下のうち、あなたが「これを強要されると著しくパフォーマンスが低下する（絶対にやりたくない）」ものを全て選んでください。（※減点専用）",
        options:[
            { text: "「今この瞬間の空気」を五感で楽しみ、自分の体調や快適さを後回しにしてでも、その場のノリや刺激に体を張り続けること。", scores: { mbti: { Se: -3 }, socio: { Si: -3 }, ennea: { 7: -2, 8: -1 } } },
            { text: "「なぜそうなるのか？」という仕組みの理解を禁じられ、ただ「昔からのルールだから」「過去のデータがそうだから」という理由だけで無条件に作業を繰り返すこと。", scores: { mbti: { Si: -3 }, socio: { Ti: -3 }, ennea: { 1: -2, 5: -1 } } },
            { text: " 個人の感情や過程を一切無視し、「力や権威」を使って他人を強引に動かし、「最短で利益」を出すための冷酷な指揮を執ること。", scores: { mbti: { Te: -3 }, socio: { Se: -3 }, ennea: { 8: -2, 3: -1 } } },
            { text: "「あの人はどう思っているか」という一人ひとりとの親密度を常に測りながら、集団全体の調和や社会的マナーを完璧に演じ続けること。", scores: { mbti: { Fe: -3 }, socio: { Fi: -3 }, ennea: { 2: -2, 4: -1 } } },
            { text: "「それがどう実用的か」を証明し続けることを求められ、自分が納得いくまで深く原理を追求する時間を奪われること。", scores: { mbti: { Ti: -3 }, socio: { Te: -3 }, ennea: { 5: -2 } } }
        ]
    },

    {
        ...
        options:[
            { text: "物事の複雑な仕組みを解明し、それが「いかに効率よく実用的か」という客観的なデータを他人に証明し続けること。", scores: { mbti: { Ti: -4 }, socio: { Te: -4 }, ennea: { 3: -2 } } },
            { text: "自分の『本当の感情』に注目し、それを大袈裟に表現して、場の空気を盛り上げるピエロになること。", scores: { mbti: { Fi: -4 }, socio: { Fe: -4 }, ennea: { 2: -2, 7: -1 } } },
            { text: "「もっと新しいアイデアはないの？」「別の視点は？」と、一つの確実な正解を出させてくれず延々と可能性を出させられること。", scores: { mbti: { Ne: -4 }, socio: { Ne: -4 }, ennea: { 7: -2 } } },
    ...
    },
    {
        ...
        options:[
            ...
            { text: "大声で怒鳴られたり強引に急かされ、先の見えない不確実な状況でアドリブを強要されること。", scores: { mbti: { Se: -3 }, socio: { Se: -3 }, ennea: { 8: -2 } } },
    ...
    },
{
        ...
        options:[
            { text: "「は？ 何言ってるの？ 意味不明」と完全に冷めきった目で拒絶する。", scores: { socio: { Fe: -4, Fi: -3 }, mbti: { Fe: -4, Fi: -3 }, ennea: { 5: 2 } } },
            { text: "「え、えっと……（どうやればいいんだ？）」と、感情の出力方法がわからずフリーズする。", scores: { socio: { Fe: -2, Fi: -2 }, mbti: { Fe: -2, Fi: -2 }, ennea: { 9: 2 } } },
            { 
                text: "「うわーん！😭」または「あはは！🤣」と、システムの要求に合わせて器用に演技（出力）してあげる。", 
                scores: { socio: { Fe: 1 }, mbti: { Fe: 1 }, ennea: { 3: 1 } },
                // ★ 演技してあげる理由を深掘り！
                followUp: {
                    id: "w_emotion_force_followup",
                    type: "radio",
                    text: "👁️[System: 思考の深掘り] 器用に演技してあげた『本当の理由』は？",
                    options:[
                        { text: "ここで要求通りにこなすのが『一番早くタスクをクリアできる（手っ取り早い）』と計算したから。", scores: { socio: { Te: 4, Fe: -2 }, mbti: { Te: 4, P: 2 }, ennea: { 3: 4, 8: 1 } } }, // ★ ENFP/3w4やT型の効率プレイ！
                        { text: "自分が演技することで、相手（システム）が喜んだり、場が盛り上がるならそれでいいと思ったから。", scores: { socio: { Fe: 4, Fi: 2 }, mbti: { Fe: 4 }, ennea: { 2: 3, 9: 2 } } }, // ガチFe
                        { text: "自分の隠れた『演技力（才能）』や『ユーモア』を披露できるチャンスだと思ったから。", scores: { socio: { Ne: 3, Fe: 2 }, mbti: { Ne: 4, E: 2 }, ennea: { 7: 3, 4: 1 } } } // Neの遊び心
                    ]
                }
            },
            { text: "「急に言われても無理。私の感情は私のものだ」と、自分の内なる感情の尊厳を守る。", scores: { socio: { Fi: 3, Fe: -2 }, mbti: { Fi: 3 }, ennea: { 4: 3 } } }
        ]
    }
];
// ==========================================
